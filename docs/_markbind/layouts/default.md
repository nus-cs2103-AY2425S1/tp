...
<header sticky>
  <navbar type="dark">
    <a slot="brand" href="{{baseUrl}}/index.html" title="Home" class="navbar-brand">Talentcy</a>
...
* [User Guide]({{ baseUrl }}/UserGuide.html) :expanded:
  ...
  * [Features]({{ baseUrl }}/UserGuide.html#fields)
  * [Fields]({{ baseUrl }}/UserGuide.html#features)
