...
<header sticky>
  <navbar type="dark">
    ...
    <li><a href="https://github.com/AY2425S1-CS2103T-T12-4/tp" target="_blank" class="nav-link"><md>:fab-github:</md></a>
    </li>
    <li slot="right">
...
* [Developer Guide]({{ baseUrl }}/DeveloperGuide.html) :expanded:
  ...
  * [Appendix: Efforts]({{ baseUrl }}/DeveloperGuide.html#appendix-efforts)
