...
<header sticky>
  <navbar type="dark">
    <a slot="brand" href="{{baseUrl}}/index.html" title="Home" class="navbar-brand">WardWatch</a>
...
* [User Guide]({{ baseUrl }}/UserGuide.html) :expanded:
  ...
  * [General Guidelines]({{ baseUrl }}/UserGuide.html#general-guidelines)
  * [Input Parameters]({{ baseUrl }}/UserGuide.html#input-parameters)
