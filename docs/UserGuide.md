...
|--------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|-------------------------------|-------------------------------------|
| n/     | name    | Names should only contain alphanumeric characters and spaces, and it should not be blank.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | -                                                                                                 | n/wen xuan, n/muhammad, sean2 | n/!@#, n/                           |
...
| e/     | email   | Emails should be of the format `local-part@domain` and adhere to the following constraints:<br/>1. The local-part should only contain alphanumeric characters and these special characters, excluding the parentheses: `(+_.-)`. The local-part may not start or end with any special characters.<br/>2. This is followed by a `@` and then a domain name. The domain name must:<br/>   - End with a domain label at least 2 characters long.<br/>   - Have each domain label start and end with alphanumeric characters.<br/>   - Have each domain label consist of alphanumeric characters, separated only by hyphens, if any. | -                                                                                                 | e/bobby@gmail.com, e/123@123  | e/bobby, e/123@.com, e/@example.com |
| t/     | tag     | Tag names should be alphanumeric.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | -                                                                                                 | t/friend1, t/colleague, t/    | t/friend@1, t/123@abc               |
| d/     | date    | Dates should be in the format `dd-MM-yy` or `ddMMyy` (e.g., 25-12-24 or 251224).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Unique to `apt` command.                                                                          | d/08-12-24, d/081224          | d/32-13-24, d/123456, d/            |
| fr/    | from    | Times should be in the format `HH:mm` or `HHmm` (e.g., 0900 or 09:00).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Unique to `apt` command.                                                                          | fr/0800, fr/08:00             | fr/2500, fr/100, fr/8am             |
| to/    | to      | Times should be in the format `HH:mm` or `HHmm` (e.g., 0900 or 09:00).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Unique to `apt` command.                                                                          | to/1000, to/10:00             | to/2500, to/110, to/                |
| pr/    | price   | Price should only contain positive numbers and cannot start with zeroes, and it should be at least 6 digits long.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Unique to `listing` command.                                                                      | pr/100000, pr/45000000        | pr/000123, pr/-1000, pr/12          |
| ar/    | area    | Area should only contain positive numbers and cannot start with zeroes, and it should be at least 2 digits long.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Unique to `listing` command.                                                                      | ar/1                          | ar/01, ar/-5, ar/                   |
| add/   | address | Addresses can take any values, and it should not be blank.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Unique to `listing` command.                                                                      | add/123 PASIR RIS (S)123456   | add/                                |
| reg/   | region  | Only the following 9 regions are allowed: EAST, WEST, NORTHEAST, SOUTH, NORTH, NORTHWEST, SOUTHEAST, SOUTHWEST, CENTRAL.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Unique to `listing` command.                                                                      | reg/east                      | reg/xyz, reg/invalidregion          |
| sel/   | seller  | Can only take non-zero unsigned integer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | In `listing`, sel is used instead of seller to refer to the seller of the listing.                | sel/2                         | sel/0, sel/-1, sel/abc              |
| buy/   | buyer   | Can only take non-zero unsigned integer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | In `addlistingbuyers` and `removelistingbuyers`, buy is used instead of buyer to refer to buyers. | addlistingbuyers 1 buy/1      | buy/0, buy/-2, buy/abc              |
