...
* Recommended practice: Always have a copy of current data (refer to the export feature). You can use import feature if you have lost your data after clearing it unintentionally.
