...
|:-----:|:---------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------:|
|   1   |               [`Add`](#311-adding-a-student-add)                |         `add n/NAME p/PHONE_NUMBER e/EMERGENCY_CONTACT a/ADDRESS [l/LEVEL] [s/SUBJECT]…​ [lt/LESSON_TIME]…​`         | `add n/James Ho p/98765432 e/93838420 a/311, Clementi Ave 2, #02-25 l/S1 NT s/MATH lt/SUN-11:00-13:00` |
|   2   |           [`Delete`](#312-deleting-a-student-delete)            |                                                    `delete INDEX`                                                    |                                               `delete 2`                                               |
|   3   |           [`Update`](#313-updating-a-student-update)            | `update NAME [n/NAME] [p/PHONE_NUMBER] [e/EMERGENCY_CONTACT] [a/ADDRESS] [l/LEVEL] [s/SUBJECT]…​ [lt/LESSON_TIME]…​` |                               `update Alex Yeoh n/James Lee e/99999999`                                |
|   4   |              [`Find`](#314-finding-students-find)               |                       `find n/NAME [NAME]…​` or `find l/LEVEL` or `find s/SUBJECT [SUBJECT]…​`                       |                         `find n/Alex David` or `find l/S2 NA` or `find s/MATH`                         |
|   5   |            [`List`](#315-listing-all-students-list)             |                                                        `list`                                                        |                                                 `list`                                                 |
|   6   |               [`Tag`](#316-tagging-a-student-tag)               |                                         `tag n/NAME [l/LEVEL] [s/SUBJECT]…​`                                         |                                    `tag n/John Doe l/S1 NT s/MATH`                                     |
|   7   |           [`Record Note`](#317-recording-notes-note)            |                                                `note n/NAME nt/NOTE`                                                 |                            `note n/John Doe nt/Doing well in all subjects`                             |
|   8   | [`View Specific Student`](#318-viewing-a-specific-student-view) |                                                    `view n/NAME`                                                     |                                           `view n/John Doe`                                            |
|   9   |            [`Add Task`](#321-adding-a-task-addtask)             |                                 `addtask n/NAME t/TASK_DESCRIPTION d/TASK_DEADLINE`                                  |                          `addtask n/John Doe t/Mark assignment d/2024-12-25`                           |
|  10   |        [`Delete Task`](#322-deleting-a-task-deletetask)         |                                          `deletetask n/NAME ti/TASK_INDEX`                                           |                                      `deletetask n/John Doe ti/1`                                      |
|  11   |        [`Update Task`](#323-updating-a-task-updatetask)         |                       `updatetask n/NAME ti/TASK_INDEX [t/TASK_DESCRIPTION] [d/TASK_DEADLINE]`                       |                              `updatetask n/John Doe ti/2 t/Mark homework`                              |
