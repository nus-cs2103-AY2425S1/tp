...
**Caution:**
If the input to the `DATE` parameter is in the valid format but is a logically incorrect date,
the input will be automatically corrected to the nearest valid date.
