...
| Prefix | Meaning | Constraints                                                                                                                                                          | Remarks                                                                                           | Valid                               |
|--------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|-------------------------------------|
| n/     | name    | Names should only contain `alphanumeric characters` and `spaces`, <br/> and it should not be `blank`                                                                 | -                                                                                                 | n/wen xuan<br/>n/muhammad<br/>sean2 |
| p/     | phone   | Phone numbers should only contain numbers, <br/>and it should be at least 3 digits long                                                                              | -                                                                                                 | p/123<br/>p/91230000                |
| e/     | email   |                                                                                                                                                                      | -                                                                                                 | e/bobby@gmail.com<br/>e/123@123     |
| t/     | tag     | Tags names should be `alphanumeric`                                                                                                                                  | -                                                                                                 | t/friend1<br/>t/colleague           |
| d/     | date    | Dates should be in the format `dd-MM-yy` or `ddMMyy` <br/>(e.g., 25-12-24 or 251224)                                                                                 | Unique to `apt` command.                                                                          | d/08-12-24<br/>d/081224             |
| fr/    | from    | Times should be in the format `HH:mm` or `HHmm` <br/>(e.g., 0900 or 09:00)                                                                                           | Unique to `apt` command.                                                                          | fr/0800<br/>fr/08:00                |
| to/    | to      | Times should be in the format `HH:mm` or `HHmm` <br/>(e.g., 0900 or 09:00)                                                                                           | Unique to `apt` command.                                                                          | to/1000<br/>to/10:00                |
| pr/    | price   | Price should only contain `positive numbers` and cannot start with `zeroes`, <br/>and it should be at least `6` digits long                                          | Unique to `listing` command.                                                                      | pr/100000<br/>pr/45000000           |
| ar/    | area    | Area should only contain `positive numbers` and cannot start with `zeroes`, <br/>and it should be at least `2` digits long                                           | Unique to `listing` command.                                                                      | ar/1                                |
| add/   | address | Addresses can take any values, <br/>and it should not be `blank`                                                                                                     | Unique to `listing` command.                                                                      | add/123 PASIR RIS (S)123456         |
| reg/   | region  | Only the following 9 regions are allowed:<br/>EAST<br/>`WEST`<br/>`NORTHEAST`<br/>`SOUTH`<br/>`NORTH`<br/>``NORTHWEST`<br/>`SOUTHEAST`<br/>`SOUTHWEST`<br/>`CENTRAL` | Unique to `listing` command.                                                                      | reg/east                            |
| sel/   | seller  | Can only take `non-zero unsigned integer`                                                                                                                            | In `listing`, sel is used instead of seller to refer to the seller of the listing.                | sel/2                               |
| buy/   | buyer   | Can only take `non-zero unsigned integer`                                                                                                                            | In `addlistingbuyers` and `removelistingbuyers`, buy is used instead of buyer to refer to buyers. | addlistingbuyers 1 buy/1            |
