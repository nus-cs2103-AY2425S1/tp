...
<br>
**This command deletes all clients from the main client list only. This cannot be undone.** If you are using this command, be very sure that you know what you are doing! This command does not delete clients from the archived list.
