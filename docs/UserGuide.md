...
4. Once a person is selected in either the pinned window or the contact list on the left, clicking on the empty area would not cause the currently selected person to change.
---
