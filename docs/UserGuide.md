...
|--------|---------|--------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|-------------------------------|
| n/     | name    | Names should only contain alphanumeric characters and spaces, and it should not be blank.                                | -                                                                                                 | n/wen xuan, n/muhammad, sean2 |
| p/     | phone   | Phone numbers should only contain numbers, and it should be at least 3 digits long.                                      | -                                                                                                 | p/123, p/91230000             |
| e/     | email   | -                                                                                                                        | -                                                                                                 | e/bobby@gmail.com, e/123@123  |
| t/     | tag     | Tag names should be alphanumeric.                                                                                        | -                                                                                                 | t/friend1, t/colleague        |
| d/     | date    | Dates should be in the format `dd-MM-yy` or `ddMMyy` (e.g., 25-12-24 or 251224).                                         | Unique to `apt` command.                                                                          | d/08-12-24, d/081224          |
| fr/    | from    | Times should be in the format `HH:mm` or `HHmm` (e.g., 0900 or 09:00).                                                   | Unique to `apt` command.                                                                          | fr/0800, fr/08:00             |
| to/    | to      | Times should be in the format `HH:mm` or `HHmm` (e.g., 0900 or 09:00).                                                   | Unique to `apt` command.                                                                          | to/1000, to/10:00             |
| pr/    | price   | Price should only contain positive numbers and cannot start with zeroes, and it should be at least 6 digits long.        | Unique to `listing` command.                                                                      | pr/100000, pr/45000000        |
...
| reg/   | region  | Only the following 9 regions are allowed: EAST, WEST, NORTHEAST, SOUTH, NORTH, NORTHWEST, SOUTHEAST, SOUTHWEST, CENTRAL. | Unique to `listing` command.                                                                      | reg/east                      |
