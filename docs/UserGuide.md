...
| **Keyword** <br> (as described in `find`)                               | `b/`                        | N/A                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | [`find`](#locating-persons-by-name--find)                                                                            |
| **Start DateTime** <br> **End DateTime**                                | `en/`                       | Must be in the format `yyyy-MM-dd hh:mm`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | [`search`]((#search-persons-by-schedule-range--search)                                                               |