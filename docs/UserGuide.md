...
| `DOB/DATE`        | Date of birth (DOB) of the patient.                                                                        | - Should be in the format `YYYY-MM-DD`. <br> - Should not be blank. <br> - Cannot be a date in the future (Only applies for DOB).                                                                                                                                                    | :white_check_mark: `2002-12-12` <br> :x: `2002/11/32`                                                                              |
