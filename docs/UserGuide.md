...
6. **When closing the View Window**, you will not be able to scroll if the mouse hovers over the area previously occupied by the View Window. The remedy is to move the mouse to the left side of the widow when scrolling.
7. **If you are using a small window** and have a person with a long tag, the attendance for the person will not wrap around and the last few weeks will not be able to be seen. The remedy is to increase the width of the window to see the remaining attendance. 
--------------------------------------------------------------------------------------------------------------------
