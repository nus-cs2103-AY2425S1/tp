...
1. Copy the file to the folder you want to use as the _home folder_ for your GOATS.

1. Open a command terminal, `cd` into the folder you put the jar file in, and use the `java -jar GOATS.jar` command to run the application.<br>
...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS edu/EDUCATION [t/TAG]…​`
...
Examples:
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 edu/Primary`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 t/criminal edu/Secondary`
