...
| Prefix | Meaning | Constraints                                                                                                                                                          | Valid                               |
|--------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|
...
| d/     | date    | Dates should be in the format `dd-MM-yy` or `ddMMyy` <br/>(e.g., 25-12-24 or 251224)                                                                                 | d/08-12-24<br/>d/081224             |
| fr/    | from    | Times should be in the format `HH:mm` or `HHmm` <br/>(e.g., 0900 or 09:00)                                                                                           | fr/0800<br/>fr/08:00                |
| to/    | to      | Times should be in the format `HH:mm` or `HHmm` <br/>(e.g., 0900 or 09:00)                                                                                           | to/1000<br/>to/10:00                |
| pr/    | price   | Price should only contain `positive numbers` and cannot start with `zeroes`, <br/>and it should be at least `6` digits long                                          | pr/100000<br/>pr/45000000           |
| ar/    | area    | Area should only contain `positive numbers` and cannot start with `zeroes`, <br/>and it should be at least `2` digits long                                           | ar/1                                |
| add/   | address | Addresses can take any values, <br/>and it should not be `blank`                                                                                                     | add/123 PASIR RIS (S)123456         |
| reg/   | region  | Only the following 9 regions are allowed:<br/>EAST<br/>`WEST`<br/>`NORTHEAST`<br/>`SOUTH`<br/>`NORTH`<br/>``NORTHWEST`<br/>`SOUTHEAST`<br/>`SOUTHWEST`<br/>`CENTRAL` | reg/east                            |
| sel/   | seller  | Can only take `non-zero unsigned integer`                                                                                                                            | sel/2                               |
| buy/   | buyer   | Can only take `non-zero unsigned integer`                                                                                                                            | addlistingbuyers 1 buy/1            |
