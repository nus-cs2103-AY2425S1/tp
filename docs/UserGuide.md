...
| **Clear**         | `clear`                                                                                             | `clear`                                                                                                             |
| **Delete**        | `delete INDEX [MORE_INDEX]…​`                                                                         | `delete 3` or `delete 2 4` or `delete all`                                                                           |
...
| **Add tag**       | `tag INDEX t/TAG [t/MORE_TAG]…​`                                                                      | `tag 1 t/year2 t/computerScience` or `tag all t/year2 t/computerScience`                                            |
