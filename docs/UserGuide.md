...
<div style="display: flex; align-items: flex-start; justify-content: space-around;">
  ...
  <!-- Output Section -->
  <div style="width: 45%; vertical-align: top;">
    <p><b>Output:</b> The UI updates to show students matching the search keyword.</p>
...
<a id="index"></a>
- **Index**: A unique number assigned to each student entry in EduTuTu, used to identify and select entries for actions like editing or deleting.

<a id="tag"></a>
- **Tag**: A label or keyword associated with a student, which helps categorise or organise entries (e.g., `student`, `alumni`, `parent`).

<a id="MONTH_PAID"></a>
- **Month Paid**: A month and year combination, used for representing a month when a student has paid. (e.g., `2024-01`, `2024-12`).
