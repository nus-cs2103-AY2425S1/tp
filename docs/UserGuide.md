...
|--------|---------|--------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|-------------------------------|-------------------------------------|
| n/     | name    | Names should only contain alphanumeric characters and spaces, and it should not be blank.                                | -                                                                                                 | n/wen xuan, n/muhammad, sean2 | n/!@#, n/1234, n/                   |
...
| e/     | email   | -                                                                                                                        | -                                                                                                 | e/bobby@gmail.com, e/123@123  | e/bobby, e/123@.com, e/@example.com |
| t/     | tag     | Tag names should be alphanumeric.                                                                                        | -                                                                                                 | t/friend1, t/colleague        | t/friend@1, t/123@abc, t/           |
...
| add/   | address | Addresses can take any values, and it should not be blank.                                                               | Unique to `listing` command.                                                                      | add/123 PASIR RIS (S)123456   | add/, add/                          |
