...
| ar/    | area    | Area should only contain positive numbers and cannot start with zeroes, and it should be at least 2 digits long.                                                                                                                                                                                                                                                    | ar/1                          | ar/01, ar/-5, ar/                   |
| add/   | address | Addresses can take any values, and it should not be blank.                                                                                                                                                                                                                                                                                                          | add/123 PASIR RIS (S)123456   | add/                                |
| reg/   | region  | Only the following 9 regions are allowed: EAST, WEST, NORTHEAST, SOUTH, NORTH, NORTHWEST, SOUTHEAST, SOUTHWEST, CENTRAL.                                                                                                                                                                                                                                            | reg/east                      | reg/xyz, reg/invalidregion          |
| sel/   | seller  | Can only take non-zero unsigned integer.                                                                                                                                                                                                                                                                                                                            | sel/2                         | sel/0, sel/-1, sel/abc              |
| buy/   | buyer   | Can only take non-zero unsigned integer.                                                                                                                                                                                                                                                                                                                            | addlistingbuyers 1 buy/1      | buy/0, buy/-2, buy/abc              |
