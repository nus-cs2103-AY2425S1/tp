...
*  `edit John Doe n/Betsy Crower t/` Edits the name of John Doe to be `Betsy Crower` and clears all existing tags.
...
**Edit**   | `edit NAME [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]…​`<br> e.g.,`edit 2 n/James Lee e/jameslee@example.com`
