...
| `DATETIME`             | <br> - Cannot be empty <br> - Format: `yyyy-MM-dd HH:mm` in 24-hour format                                                                                                                                                                                              | **Valid**: `2022-10-10 12:00` <br> **Invalid**: `2022-10-10 12:00 pm`                                           |
...
| **Find Phone Number** | `find p/PHONE_NUMBER` or `fp PHONE_NUMBER` or `find NAME$` <br> e.g `find p/98765432` or `fp 987654432`                                                                                                                                                                                 |
