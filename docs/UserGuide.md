...
| d/     | date    | Dates should be in the format `dd-MM-yy` or `ddMMyy` (e.g., 25-12-24 or 251224)                                                                                      | Unique to `apt` command.                                                                          |                                                                                         |         |
| fr/    | from    | Times should be in the format `HH:mm` or `HHmm` (e.g., 0900 or 09:00)                                                                                                | Unique to `apt` command.                                                                          |                                                                                         |         |
| to/    | to      | Times should be in the format `HH:mm` or `HHmm` (e.g., 0900 or 09:00)                                                                                                | Unique to `apt` command.                                                                          |                                                                                         |         |
| pr/    | price   | Price should only contain `positive numbers` and cannot start with `zeroes`, and it should be at least `6` digits long                                               | Unique to `listing` command.                                                                      | listing n/Warton House pr/4000 ar/1000 add/123 PASIR RIS (S)123456 reg/east sel/2 buy/1 |         |
| ar/    | area    | Area should only contain `positive numbers` and cannot start with `zeroes`, and it should be at least `2` digits long                                                | Unique to `listing` command.                                                                      | listing n/Warton House pr/4000 ar/1000 add/123 PASIR RIS (S)123456 reg/east sel/2 buy/1 |         |
| add/   | address | Addresses can take any values, and it should not be `blank`                                                                                                          | Unique to `listing` command.                                                                      | listing n/Warton House pr/4000 ar/1000 add/123 PASIR RIS (S)123456 reg/east sel/2 buy/1 |         |
| reg/   | region  | Only the following 9 regions are allowed:<br/>EAST<br/>`WEST`<br/>`NORTHEAST`<br/>`SOUTH`<br/>`NORTH`<br/>``NORTHWEST`<br/>`SOUTHEAST`<br/>`SOUTHWEST`<br/>`CENTRAL` | Unique to `listing` command.                                                                      | listing n/Warton House pr/4000 ar/1000 add/123 PASIR RIS (S)123456 reg/east sel/2 buy/1 |         |
| sel/   | seller  | Can only take `non-zero unsigned integer`                                                                                                                            | In `listing`, sel is used instead of seller to refer to the seller of the listing.                | listing n/Warton House pr/4000 ar/1000 add/123 PASIR RIS (S)123456 reg/east sel/2 buy/1 |         |
| buy/   | buyer   | Can only take `non-zero unsigned integer`                                                                                                                            | In `addlistingbuyers` and `removelistingbuyers`, buy is used instead of buyer to refer to buyers. | addlistingbuyers 1 buy/Charlotte Oliveiro                                               |         |
