...
**Find** : Finds students whose names contain any of the given keywords *and* their schedule contain any of the given days | `find [n/KEYWORD [MORE_KEYWORDS]] [d/DAY [MORE_DAYS]]`<br> e.g., `find n/Alex John d/Friday`
...
Finds students whose names contain any of the given keywords *and* their tuition day contain any of the given days.
