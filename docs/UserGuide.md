...
* [Help Command](#viewing-help--help-or-h)
  * [Contact Management](#contact-management)
    ...
    * [Saving your sort preference](#saving-sort-preference-save_sort-or-svp)
    * [Delete a contact](#deleting-a-person--delete-or-del)
    * [Add a remark to a contact](#adding-a-remark-to-a-person--remark)
    * [Delete all contacts](#clearing-all-entries--clear-or-c)
  * [Reminder Management](#reminder-management)
    * [Create a reminder](#creating-a-reminder-remind-or-rem)
