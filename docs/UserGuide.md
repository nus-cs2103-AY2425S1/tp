...
| `ALLERGY`          | Allergy of the patient.                                                                                    | - Only alphanumeric characters are allowed.<br> - Should not exceed 30 characters in length.<br> - Should not be blank.<br> - Multiple consecutive spaces between letters and/or words are not allowed.                                                                                                                                                                                    | :white_check_mark: `Peanuts`<br>:x: `Pe@nuts` <br>:x: `Pea  nuts`                                                                 |
...
| `CONDITION`        | Medical Condition of the patient.                                                                          | - Only alphanumeric characters are allowed.<br> - Should not exceed 30 characters in length.<br> - Should not be blank.<br> - Multiple consecutive spaces between letters and/or words are not allowed.                                                                                                                                                                                    | :white_check_mark: `High Blood Pressure`<br>:x: `@high-bp` <br>:x: `High    Blood     Pressure`                                   |
