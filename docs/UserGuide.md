...
|:-----:|:-----------------:|:----------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   1   |      Address      |                  `a/ADDRESS`                   | Can take any values, but should not be blank. Note that using certain prefixes may cause an error.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|   7   |       Note        |                   `nt/NOTE`                    | Can take any values, and can be blank. Note that using certain prefixes may cause an error.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
|  11   | Task Description  |              `t/TASK_DESCRIPTION`              | Can take any values, but should not be blank. Note that using certain prefixes may cause an error.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
