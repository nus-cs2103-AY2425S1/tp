...
| **Tag**                                                                 | `t/`                        | Must only contain alphanumeric characters (letters and numbers only)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | [`add`](#adding-a-person--add) <br> [`edit`](#editing-a-person--edit) <br> [`filter`](#filter-persons-by-tag--filter) |
