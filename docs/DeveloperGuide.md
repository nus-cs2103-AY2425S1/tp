...
| `* *`    | User           | export contacts to a file securely                           | I can share them with other authorized patientnel or have a backup.                            |
...
| `* *`    | User           | add notes to a contact                                       | I can remember important information about that patient.                                       |
