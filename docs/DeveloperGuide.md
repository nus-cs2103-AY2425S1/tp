...
| `* * *`  | First-time user | Delete all data in the app                             | I can start over when I make a mistake                       |               |
| `* *`    | First-time user | Import data from an existing Google Sheets or CSV file | I can quickly upload my data without manual entry            |               |

#### Second-time User

| Priority | As a …​          | I want to …​           | So that I can …​              | Remarks/Notes |
| -------- | ---------------- | ---------------------- | ----------------------------- | ------------- |
| `* * *`  | Second-time user | Delete all sample data | I can use it for personal use |               |
...
| `* *`    | Frequent user | Automatically track attendance at each session                   | I don’t need to manually mark attendance for each session            | Using QR codes? Complicated integration required                |
| `* *`    | Frequent user | Set up notifications or reminders for sessions                   | I can remind members about upcoming sessions automatically           |                                                                 |
...
| `* *`    | Frequent user | Export attendance data                                           | I can share participation reports with other stakeholders            |                                                                 |
| `* *`    | Frequent user | Export reports to PDF or CSV formats                             | I can share the data in a format useful to other stakeholders        | What format? Customisable? Fixed templates may be more feasible |
| `* *`    | Frequent user | Manage multiple sub-groups in the same app                       | I can track participation across different activities or teams       | There may be sub-groups within CCAs                             |
| `* *`    | Frequent user | Set up custom attendance categories (e.g., Excused, Late)        | I can categorize different types of attendance                       |                                                                 |
| `* *`    | Frequent user | View analytics or visual reports of attendance and participation | I can see trends and member engagement at a glance                   | Charts or graphs to visualize data                              |
...
| `* * *`  | User    | Mark members as inactive or active                                                                   | I can filter out inactive members from my view                 |                                                        |
...
| `*`      | User    | Receive notifications or alerts when certain thresholds are met (e.g., low attendance or milestones) | I can take action promptly                                     |                                                        |
...
| `*`      | Expert user | Submit feedback or feature requests within the app    | I can suggest improvements easily                                       | Submit to who? Gotta have a hotline to the devs if that's the case |
| `*`      | Expert user | Automate repetitive tasks, such as attendance updates | I can save time by reducing manual input                                |                                                                    |

#### Impatient or Forgetful User

| Priority | As a …​                  | I want to …​                    | So that I can …​                              | Remarks/Notes |
| -------- | ------------------------ | ------------------------------- | --------------------------------------------- | ------------- |
| `*`      | Impatient/forgetful user | Have a history of actions taken | I can quickly undo or repeat previous actions |               |
