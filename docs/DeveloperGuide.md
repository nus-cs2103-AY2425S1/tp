...
| `* * *`  | User                        | Add or delete points for each member                                                                 | I can track the overall participation status in the CCA                 |                                                                                                  |
...
| `* *`    | Frequent user               | Export reports to PDF or CSV formats                                                                 | I can share the data in a format useful to other stakeholders           | What format per se? Customisable? That's a lot more work than fixed templates, if it is possible |
| `* *`    | User                        | Bulk update attendance or points for multiple members                                                | I can efficiently manage large groups                                   |                                                                                                  |
| `* *`    | User                        | See an overview of attendance for all sessions in a semester                                         | I can track participation trends over time                              |                                                                                                  |
| `* *`    | User                        | Manage multiple sub-groups in the same app                                                           | I can track participation across different activities or teams          | There may be sub-groups within CCAs                                                              |
...
| `*`      | Impatient or forgetful user | Have a history of actions taken                                                                      | I can quickly undo or repeat previous actions                           |                                                                                                  |
