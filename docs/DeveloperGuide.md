...
| `* *`    | user                                     | list all the doctors stored in the address book.                                                 |                                                                                                                                 |
| `* *`    | user                                     | find a specific doctor in the address book                                                       | see all doctors’ contact details in the address book                                                                            |
| `* *`    | healthcare provider                      | add notes to patient records                                                                     | check if a certain doctor's details are stored in the address book                                                              |
