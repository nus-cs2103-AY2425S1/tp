...
| `* * *`  | tuition teacher | quickly get into contact with my student's emergency contact                            | contact them in an emergency                                                                     |
...
| `* *`    | tuition teacher | delete tasks for a specific student                                                     | delete tasks for a particular student when I am done with a particular task                      |
