...
1. Dealing with missing/corrupted data files
    ...
    1. Test case: Delete the `ugteach.json` file and start the application.<br>
       Expected: UGTeach should create a new `ugteach.json` file with default data.

    1. Test case: Delete the `data` folder together with the `ugteach.json` file and start the application.<br>
       Expected: Similar to previous.
