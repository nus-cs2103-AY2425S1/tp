...
2.  The should be able to maintain as many contacts as possible based on business needs without a noticeable sluggishness in performance for typical usage.
...
6.  The system should be able to continue functioning in the event of a missing or corrupted save file.
7.  The system should be able to encrypt sensitive data.
9.  The interface should be intuitive and easy to use.
