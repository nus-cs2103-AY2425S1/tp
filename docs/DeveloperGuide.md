...
| `* * *`  | Y1 CS student                                                                                                | search for contacts info from my address book using name, module code (with role), or tag                                   | find their contact immediately and reach out to them to settle any issues            |
