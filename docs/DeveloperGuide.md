...
| `* * *`  | user                        | delete a member from the address book                                                                                                                                                    | update the address book accordingly if he is no longer in the CCA                                                                |
| `* * *`  | user                        | use this app to populate the member’s details into the app database                                                                                                                      | save their details (name, student status, telegram handle, email address) into the database for future reference                 |
