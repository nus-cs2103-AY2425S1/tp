...
6. Allow users to view the details of the different schemes: Currently, it is difficult for users to know what are the requirements to enroll under a scheme and to find out the exact details of the scheme such as  the benefits. We plan to allow the user to view the details of added schemes. 
7. Allow adding of images to person: Currently, SocialBook only shows word based information about the person. To make identifying the person easier, a photo of the person could be attached to the person card.
