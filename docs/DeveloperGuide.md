...
| `* *`    | Max                                       | add the medicinal information of beneficiaries                             | to know when to follow up on critical medicines                                                        |
...
| `*`      | Max                                       | know the households I need to visit on a certain day                       | so that I can schedule my day and not forget to visit any households                                   |
| `*`      | Short on time                             | Visit households that are geographically close in the same day/visit       | Minimise the travelling time for myself                                                                |
