...
| `* * *`  | Y1 CS student who struggles to remember who to reach out to for certain issues                               | find the correct contact info by searching the category of the issue that I am trying to settle                             |                                                                                     |
| `* *`    | Y1 CS student who needs to update contact info                                                               | update contact info for courses in this semester with that in the next semester                                             | I can keep info updated in more efficient ways                                      |
...
| `*`      | User who performed action wrongly when using the app                                                         | redo/undo current actions                                                                                                   | Peform multiple actions efficiently without wasting time on correcting the mistakes |
