...
| -------- |------------------------|-------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|
 ...
 | `****` | Frequent User          | Verify that the same elderly has not been added before                  | I don't add the same elderly multiple times                                                      | 
 | `****` | Frequent User          | Be warned if a I am trying to add an elderly similar to an existing one | I don't add the same elderly multiple times                                                      |
