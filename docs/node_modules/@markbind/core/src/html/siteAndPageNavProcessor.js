...
exports.addSitePageNavPortal = exports.renderSiteNav = exports.PageNavProcessor = void 0;
...
class PageNavProcessor {
    ...
    renderPageNav(node) {
        [this.uuidTextNode] = (0, node_1.parseHTML)((0, uuid_1.v4)());
        (0, cheerio_1.default)(node).replaceWith(this.uuidTextNode);
    }
    finalizePageNavUuid(mainHtml, mainHtmlNodes, footnotesHtml) {
        ...
        do {
            ...
            if (numMatches > 1) {
                this.uuidTextNode.data = (0, uuid_1.v4)();
                mainHtmlString = (0, cheerio_1.default)(mainHtmlNodes).html();
            }
        } while (numMatches > 1);
...
exports.PageNavProcessor = PageNavProcessor;
function renderSiteNav(node) {
    const $original = (0, cheerio_1.default)(node);
    const siteNavText = $original.text().trim();
    if (siteNavText === '') {
        return;
    }
    // collapse into tight list
    const siteNavHtml = markdown_it_1.default.render(siteNavText.replace(SITE_NAV_EMPTY_LINE_REGEX, '\n'));
    const $ = cheerio_1.default.load(siteNavHtml);
    $('ul').each((_i1, ulElem) => {
...
exports.renderSiteNav = renderSiteNav;
...
exports.addSitePageNavPortal = addSitePageNavPortal;
//# sourceMappingURL=siteAndPageNavProcessor.js.map