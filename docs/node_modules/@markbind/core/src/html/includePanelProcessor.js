 ...
 */
function processInclude(node, context, pageSources, variableProcessor, renderMd, renderMdInline, config, siteLinkManager, getNextFootnodeNumber = buildGetNextFootnodeNumber()) {
