...
const ICON_REGEXP = /:(fa[brs]|fa-brands|fa-solid|glyphicon|octicon|octiconlight|mi[forst]|bi)-([a-z-]+)~?([a-z-]+)?:/;
...
const handleBootstrapIcon = (iconFontName) => `<i class="bi-${iconFontName}"></i>`;
