...
exports.HighlightRuleComponent = void 0;
...
class HighlightRuleComponent {
    ...
    static isValidLineNumber(lineNumStr, min, max, offset) {
        let lineNum = Number(lineNumStr);
        if (Number.isNaN(lineNum) || !Number.isInteger(lineNum))
            return null;
        lineNum += offset;
    ...
    static parseRuleComponent(compString, lineNumberOffset, lines) {
        ...
        if (sliceMatch) {
            ...
            const lineNumber = HighlightRuleComponent
                .isValidLineNumber((_a = groups.shift()) !== null && _a !== void 0 ? _a : '', 1, lines.length, lineNumberOffset);
            if (!lineNumber)
                return null;
    ...
    static computeCharBounds(bound, line) {
        const [indents] = (0, helper_1.splitCodeAndIndentation)(line);
        let [start, end] = bound;
        if (start === UNBOUNDED) {
    ...
    static computeWordBounds(bound, line) {
        const [indents, content] = (0, helper_1.splitCodeAndIndentation)(line);
...
exports.HighlightRuleComponent = HighlightRuleComponent;
//# sourceMappingURL=HighlightRuleComponent.js.map