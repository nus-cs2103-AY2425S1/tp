...
export declare class VariableProcessor {
     ...
     */
    private getParentSiteVariables;
    /**
     ...
     */
    private static extractIncludeVariables;
    /**
     ...
     */
    renderIncludeFile(filePath: string, pageSources: PageSources, node: MbNode, context: Context, asIfAt: string): {
        nunjucksProcessed: string;
