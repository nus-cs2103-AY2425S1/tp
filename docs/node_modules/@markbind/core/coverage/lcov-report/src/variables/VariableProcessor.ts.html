...
<head>
    <title>Code coverage report for src/variables/VariableProcessor.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/variables</a> VariableProcessor.ts</h1>
        <div class='clearfix'>
...
<a name='L273'></a><a href='#L273'>273</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">8x</span>
...
&nbsp;
   ...
   */
&nbsp;
<span class="fstat-no" title="function not covered" >  invalidateCache(</span>) {
<span class="cstat-no" title="statement not covered" >    Object.values(this.variableRendererMap).forEach(<span class="fstat-no" title="function not covered" >variableRenderer </span>=&gt; <span class="cstat-no" title="statement not covered" >variableRenderer.invalidateCache())</span>;</span>
  }
&nbsp;
  /*
   * --------------------------------------------------
...
<span class="cstat-no" title="statement not covered" >      logger.warn('Check _markbind/variables.md for variable declarations.');</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  addUserDefinedVariableForAllSites(</span>name: string, value: any) {
<span class="cstat-no" title="statement not covered" >    Object.keys(this.userDefinedVariablesMap)</span>
      .forEach(<span class="fstat-no" title="function not covered" >base </span>=&gt; <span class="cstat-no" title="statement not covered" >this.addUserDefinedVariable(base, name, value))</span>;
  }
&nbsp;
...
&nbsp;
  ...
  renderWithSiteVariables(
    ...
    lowerPriorityVariables: Record&lt;string, any&gt; = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span>
  ) {
...
&nbsp;
    Object.entries(includeElement.attribs || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>.forEach(([attribute, val]) =&gt; {
      if (!attribute.startsWith('var-')) {
        return;
      }
      const variableName = <span class="cstat-no" title="statement not covered" >attribute.slice(4);</span>
<span class="cstat-no" title="statement not covered" >      includeInlineVariables[variableName] = val;</span>
    });
&nbsp;
...
&nbsp;
  ...
  private static extractIncludeChildElementVariables(includeElement: MbNode) {
    ...
    const includeChildVariables: Record&lt;string, string&gt; = <span class="cstat-no" title="statement not covered" >{};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    includeElement.children.forEach(<span class="fstat-no" title="function not covered" >(c</span>hild) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (child.name !== 'variable' &amp;&amp; child.name !== 'span') {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      const variableName = <span class="cstat-no" title="statement not covered" >child.attribs?.name || child.attribs?.id;</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (!variableName) {</span>
<span class="cstat-no" title="statement not covered" >        logger.warn(`Missing 'name' or 'id' in variable for ${includeElement.attribs.src}'s include in ${</span>
          includeElement.attribs[ATTRIB_CWF]}.\n`);
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (!includeChildVariables[variableName]) {</span>
<span class="cstat-no" title="statement not covered" >        includeChildVariables[variableName] = cheerio(child).html() || '';</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return includeChildVariables;</span>
  }
&nbsp;
  /**
