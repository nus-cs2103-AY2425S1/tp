...
<head>
    <title>Code coverage report for src/variables/VariableRenderer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/variables</a> VariableRenderer.ts</h1>
        <div class='clearfix'>
...
<a name='L85'></a><a href='#L85'>85</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">8x</span>
...
<span class="fstat-no" title="function not covered" >  invalidateCache(</span>) {
    ...
    // @ts-ignore
<span class="cstat-no" title="statement not covered" >    this.nj.invalidateCache();</span>
  }
&nbsp;
  /**
