...
<head>
    <title>Code coverage report for src/Site/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/Site</a> index.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">30.42% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>199/654</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>49/193</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">24.26% </span>
                <span class="quiet">Functions</span>
                <span class='fraction'>33/136</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">30.97% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>193/623</span>
            </div>
...
<a name='L1570'></a><a href='#L1570'>1570</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import cheerio from 'cheerio';
...
&nbsp;
    ...
    this.backgroundBuildMode = onePagePath &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >backgroundBuildMode;</span>
    this.stopGenerationTimeThreshold = new Date();
    this.postBackgroundBuildFunc = postBackgroundBuildFunc || (<span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >() =</span>&gt; {})</span>;
&nbsp;
    // Lazy reload properties
    this.onePagePath = onePagePath;
    this.currentPageViewed = onePagePath
      ? <span class="branch-0 cbranch-no" title="branch not covered" >path.resolve(this.rootPath, fsUtil.removeExtension(onePagePath))</span>
      : '';
...
&nbsp;
   ...
   */
&nbsp;
<span class="fstat-no" title="function not covered" >  static </span>async rejectHandler(error: unknown, removeFolders: string[]) {
<span class="cstat-no" title="statement not covered" >    logger.warn(error);</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await Promise.all(removeFolders.map(<span class="fstat-no" title="function not covered" >folder </span>=&gt; <span class="cstat-no" title="statement not covered" >fs.remove(folder))</span>);</span>
    } catch (err) {
<span class="cstat-no" title="statement not covered" >      logger.error(`Failed to remove generated files after error!\n${(err as Error).message}`);</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  beforeSiteGenerate(</span>) {
<span class="cstat-no" title="statement not covered" >    this.variableProcessor.invalidateCache();</span>
<span class="cstat-no" title="statement not covered" >    this.externalManager.reset();</span>
<span class="cstat-no" title="statement not covered" >    this.pluginManager.beforeSiteGenerate();</span>
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  changeCurrentPage(</span>normalizedUrl: string) {
<span class="cstat-no" title="statement not covered" >    this.currentPageViewed = path.join(this.rootPath, normalizedUrl);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.toRebuild.has(this.currentPageViewed)) {</span>
<span class="cstat-no" title="statement not covered" >      this.beforeSiteGenerate();</span>
      /*
       ...
       */
<span class="cstat-no" title="statement not covered" >      this.rebuildPagesBeingViewed(this.currentPageViewed);</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  changeCurrentOpenedPages(</span>normalizedUrls: string[]) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.onePagePath) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    const openedPages = <span class="cstat-no" title="statement not covered" >normalizedUrls.map(<span class="fstat-no" title="function not covered" >normalizedUrl </span>=&gt; <span class="cstat-no" title="statement not covered" >path.join(this.rootPath, normalizedUrl))</span>;</span>
<span class="cstat-no" title="statement not covered" >    this.currentOpenedPages = _.uniq(openedPages);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.currentOpenedPages.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Current opened pages, from most-to-least recent:');</span>
<span class="cstat-no" title="statement not covered" >      this.currentOpenedPages.forEach(<span class="fstat-no" title="function not covered" >(p</span>agePath, idx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        logger.info(`${idx + 1}. ${fsUtil.ensurePosix(path.relative(this.rootPath, pagePath))}`);</span>
      });
    } else {
<span class="cstat-no" title="statement not covered" >      logger.info('No pages are currently opened');</span>
    }
  }
&nbsp;
  /**
...
&nbsp;
<span class="fstat-no" title="function not covered" >  listAssets(</span>fileIgnore: Ignore) {
    const files = <span class="cstat-no" title="statement not covered" >walkSync(this.rootPath, { directories: false });</span>
<span class="cstat-no" title="statement not covered" >    return fileIgnore.filter(files);</span>
  }
&nbsp;
  /**
   * Create a Page object from the site and page creation config.
   */
<span class="fstat-no" title="function not covered" >  createPage(</span>config: PageCreationConfig): Page {
    const sourcePath = <span class="cstat-no" title="statement not covered" >path.join(this.rootPath, config.pageSrc);</span>
    const resultPath = <span class="cstat-no" title="statement not covered" >path.join(this.outputPath, fsUtil.setExtension(config.pageSrc, '.html'));</span>
&nbsp;
    const baseAssetsPath = <span class="cstat-no" title="statement not covered" >path.posix.join(</span>
      this.siteConfig.baseUrl || '/', TEMPLATE_SITE_ASSET_FOLDER_NAME,
    );
&nbsp;
    const pageConfig = <span class="cstat-no" title="statement not covered" >new PageConfig({</span>
      asset: {
...
<span class="cstat-no" title="statement not covered" >    return new Page(pageConfig, this.siteConfig);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  static </span>printBaseUrlMessage() {
<span class="cstat-no" title="statement not covered" >    logger.info('The default base URL of your site is set to /\n'</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  updateAddressablePages(</span>) {
    const oldAddressablePagesSources = <span class="cstat-no" title="statement not covered" >this.addressablePages.slice().map(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page.src)</span>;</span>
<span class="cstat-no" title="statement not covered" >    this.collectAddressablePages();</span>
    const newAddressablePagesSources = <span class="cstat-no" title="statement not covered" >this.addressablePages.map(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page.src)</span>;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _.difference(oldAddressablePagesSources, newAddressablePagesSources)</span>
      .map(<span class="fstat-no" title="function not covered" >filePath </span>=&gt; <span class="cstat-no" title="statement not covered" >fsUtil.setExtension(filePath, '.html'))</span>;
  }
&nbsp;
  getPageGlobPaths(page: SiteConfigPage, pagesExclude: string[]) {
    const pageGlobs = page.glob ?? <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    return walkSync(this.rootPath, {
      directories: false,
      globs: Array.isArray(pageGlobs) ? <span class="branch-0 cbranch-no" title="branch not covered" >pageGlobs </span>: [pageGlobs],
      ignore: [
        CONFIG_FOLDER_NAME,
        SITE_FOLDER_NAME,
...
&nbsp;
  ...
  collectAddressablePages() {
    ...
    const pagesFromSrc = _.flatMap(pages.filter(page =&gt; page.src), page =&gt; (Array.isArray(page.src)
      ? <span class="branch-0 cbranch-no" title="branch not covered" >page.src.map(<span class="fstat-no" title="function not covered" >pageSrc </span>=&gt; <span class="cstat-no" title="statement not covered" >({ ...page, src: pageSrc }))</span></span>
...
<span class="cstat-no" title="statement not covered" >        logger.warn((e as Error).message);</span>
      }
&nbsp;
      /*
...
&nbsp;
      ...
      $('variable,span').each((_index, element) =&gt; {
        const name = $(element).attr('name') || <span class="branch-1 cbranch-no" title="branch not covered" >$(element).attr('id');</span>
&nbsp;
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  collectUserDefinedVariablesMapIfNeeded(</span>filePaths: string[]) {
    const variablesPath = <span class="cstat-no" title="statement not covered" >path.resolve(this.rootPath, USER_VARIABLES_PATH);</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (filePaths.includes(variablesPath)) {</span>
<span class="cstat-no" title="statement not covered" >      this.collectUserDefinedVariablesMap();</span>
<span class="cstat-no" title="statement not covered" >      return true;</span>
    }
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
&nbsp;
   ...
   * @param baseUrl user defined base URL (if exists)
   */
  async <span class="fstat-no" title="function not covered" >generate(</span>baseUrl: string | undefined): Promise&lt;any&gt; {
    const startTime = <span class="cstat-no" title="statement not covered" >new Date();</span>
    // Create the .tmp folder for storing intermediate results.
<span class="cstat-no" title="statement not covered" >    fs.emptydirSync(this.tempPath);</span>
    // Clean the output folder; create it if not exist.
<span class="cstat-no" title="statement not covered" >    fs.emptydirSync(this.outputPath);</span>
    const lazyWebsiteGenerationString = <span class="cstat-no" title="statement not covered" >this.onePagePath ? '(lazy) ' : '';</span>
<span class="cstat-no" title="statement not covered" >    logger.info(`Website generation ${lazyWebsiteGenerationString}started at ${</span>
      startTime.toLocaleTimeString()}`);
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await this.readSiteConfig(baseUrl);</span>
<span class="cstat-no" title="statement not covered" >      this.collectAddressablePages();</span>
<span class="cstat-no" title="statement not covered" >      this.collectBaseUrl();</span>
<span class="cstat-no" title="statement not covered" >      this.collectUserDefinedVariablesMap();</span>
<span class="cstat-no" title="statement not covered" >      await this.buildAssets();</span>
<span class="cstat-no" title="statement not covered" >      await (this.onePagePath ? this.lazyBuildSourceFiles() : this.buildSourceFiles());</span>
<span class="cstat-no" title="statement not covered" >      await this.copyCoreWebAsset();</span>
<span class="cstat-no" title="statement not covered" >      await this.copyBootstrapIconsAsset();</span>
<span class="cstat-no" title="statement not covered" >      await this.copyBootstrapTheme(false);</span>
<span class="cstat-no" title="statement not covered" >      await this.copyFontAwesomeAsset();</span>
<span class="cstat-no" title="statement not covered" >      await this.copyOcticonsAsset();</span>
<span class="cstat-no" title="statement not covered" >      await this.copyMaterialIconsAsset();</span>
<span class="cstat-no" title="statement not covered" >      await this.writeSiteData();</span>
<span class="cstat-no" title="statement not covered" >      this.calculateBuildTimeForGenerate(startTime, lazyWebsiteGenerationString);</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode) {</span>
<span class="cstat-no" title="statement not covered" >        this.backgroundBuildNotViewedFiles();</span>
      }
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      await Site.rejectHandler(error, [this.tempPath, this.outputPath]);</span>
    }
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  calculateBuildTimeForGenerate(</span>startTime: Date, lazyWebsiteGenerationString: string) {
    const endTime = <span class="cstat-no" title="statement not covered" >new Date();</span>
    const totalBuildTime = <span class="cstat-no" title="statement not covered" >(endTime.getTime() - startTime.getTime()) / 1000;</span>
<span class="cstat-no" title="statement not covered" >    logger.info(`Website generation ${lazyWebsiteGenerationString}complete! Total build time: ${</span>
      totalBuildTime}s`);
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.onePagePath &amp;&amp; totalBuildTime &gt; LAZY_LOADING_BUILD_TIME_RECOMMENDATION_LIMIT) {</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Your site took quite a while to build...'</span>
...
&nbsp;
   ...
   */
  async <span class="fstat-no" title="function not covered" >buildSourceFiles(</span>) {
<span class="cstat-no" title="statement not covered" >    this.beforeSiteGenerate();</span>
<span class="cstat-no" title="statement not covered" >    logger.info('Generating pages...');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await this.generatePages();</span>
<span class="cstat-no" title="statement not covered" >      await fs.remove(this.tempPath);</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Pages built');</span>
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      await Site.rejectHandler(error, [this.tempPath, this.outputPath]);</span>
    }
  }
&nbsp;
   ...
   */
  async <span class="fstat-no" title="function not covered" >lazyBuildAllPagesNotViewed(</span>viewedPages: string | string[]) {
    const viewedPagesArray = <span class="cstat-no" title="statement not covered" >Array.isArray(viewedPages) ? viewedPages : [viewedPages];</span>
<span class="cstat-no" title="statement not covered" >    this.pages.forEach(<span class="fstat-no" title="function not covered" >(p</span>age) =&gt; {</span>
      const normalizedUrl = <span class="cstat-no" title="statement not covered" >fsUtil.removeExtension(page.pageConfig.sourcePath);</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (!viewedPagesArray.some(<span class="fstat-no" title="function not covered" >viewedPage </span>=&gt; <span class="cstat-no" title="statement not covered" >normalizedUrl === viewedPage)</span>) {</span>
<span class="cstat-no" title="statement not covered" >        this.toRebuild.add(normalizedUrl);</span>
      }
    });
  }
&nbsp;
   ...
   */
  async <span class="fstat-no" title="function not covered" >lazyBuildSourceFiles(</span>) {
<span class="cstat-no" title="statement not covered" >    this.beforeSiteGenerate();</span>
<span class="cstat-no" title="statement not covered" >    logger.info('Generating landing page...');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await this.generateLandingPage();</span>
<span class="cstat-no" title="statement not covered" >      await this.copyLazySourceFiles();</span>
<span class="cstat-no" title="statement not covered" >      await fs.remove(this.tempPath);</span>
<span class="cstat-no" title="statement not covered" >      await this.lazyBuildAllPagesNotViewed(this.currentPageViewed);</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Landing page built, other pages will be built as you navigate to them!');</span>
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      await Site.rejectHandler(error, [this.tempPath, this.outputPath]);</span>
    }
  }
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  copyLazySourceFiles(</span>) {
    const lazyLoadingSpinnerHtmlFilePath = <span class="cstat-no" title="statement not covered" >path.join(__dirname, LAZY_LOADING_SITE_FILE_NAME);</span>
    const outputSpinnerHtmlFilePath = <span class="cstat-no" title="statement not covered" >path.join(this.outputPath, LAZY_LOADING_SITE_FILE_NAME);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return fs.copy(lazyLoadingSpinnerHtmlFilePath, outputSpinnerHtmlFilePath);</span>
  }
&nbsp;
  async <span class="fstat-no" title="function not covered" >_rebuildAffectedSourceFiles(</span>filePaths: string | string[]) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode) {</span>
<span class="cstat-no" title="statement not covered" >      this.stopOngoingBuilds();</span>
    }
&nbsp;
    const filePathArray = <span class="cstat-no" title="statement not covered" >Array.isArray(filePaths) ? filePaths : [filePaths];</span>
    const uniquePaths = <span class="cstat-no" title="statement not covered" >_.uniq(filePathArray);</span>
<span class="cstat-no" title="statement not covered" >    this.beforeSiteGenerate();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await this.layoutManager.updateLayouts(filePathArray);</span>
<span class="cstat-no" title="statement not covered" >      await this.regenerateAffectedPages(uniquePaths);</span>
<span class="cstat-no" title="statement not covered" >      await fs.remove(this.tempPath);</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode) {</span>
<span class="cstat-no" title="statement not covered" >        this.backgroundBuildNotViewedFiles();</span>
      }
...
&nbsp;
  async <span class="fstat-no" title="function not covered" >_rebuildPagesBeingViewed(</span>normalizedUrls: string[]) {
    const startTime = <span class="cstat-no" title="statement not covered" >new Date();</span>
    const normalizedUrlArray = <span class="cstat-no" title="statement not covered" >Array.isArray(normalizedUrls) ? normalizedUrls : [normalizedUrls];</span>
    const uniqueUrls = <span class="cstat-no" title="statement not covered" >_.uniq(normalizedUrlArray);</span>
<span class="cstat-no" title="statement not covered" >    uniqueUrls.forEach(<span class="fstat-no" title="function not covered" >normalizedUrl </span>=&gt; <span class="cstat-no" title="statement not covered" >logger.info(</span></span>
      `Building ${normalizedUrl} as some of its dependencies were changed since the last visit`));
&nbsp;
    const pagesToRebuild = <span class="cstat-no" title="statement not covered" >this.pages.filter(<span class="fstat-no" title="function not covered" >page </span>=&gt;</span>
<span class="cstat-no" title="statement not covered" >      uniqueUrls.some(<span class="fstat-no" title="function not covered" >pageUrl </span>=&gt; <span class="cstat-no" title="statement not covered" >fsUtil.removeExtension(page.pageConfig.sourcePath) === pageUrl)</span>)</span>;
    const pageGenerationTask = <span class="cstat-no" title="statement not covered" >{</span>
      mode: 'async',
      pages: pagesToRebuild,
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      this._setTimestampVariable();</span>
<span class="cstat-no" title="statement not covered" >      await this.runPageGenerationTasks([pageGenerationTask]);</span>
<span class="cstat-no" title="statement not covered" >      await this.writeSiteData();</span>
<span class="cstat-no" title="statement not covered" >      Site.calculateBuildTimeForRebuildPagesBeingViewed(startTime);</span>
    } catch (err) {
<span class="cstat-no" title="statement not covered" >      await Site.rejectHandler(err, [this.tempPath, this.outputPath]);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    await fs.remove(this.tempPath);</span>
  }
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  static </span>calculateBuildTimeForRebuildPagesBeingViewed(startTime: Date) {
    const endTime = <span class="cstat-no" title="statement not covered" >new Date();</span>
    const totalBuildTime = <span class="cstat-no" title="statement not covered" >(endTime.getTime() - startTime.getTime()) / 1000;</span>
<span class="cstat-no" title="statement not covered" >    return logger.info(`Lazy website regeneration complete! Total build time: ${totalBuildTime}s`);</span>
  }
&nbsp;
  async <span class="fstat-no" title="function not covered" >_backgroundBuildNotViewedFiles(</span>) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.toRebuild.size === 0) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    logger.info('Building files that are not viewed in the background...');</span>
    const isCompleted = <span class="cstat-no" title="statement not covered" >await this.generatePagesMarkedToRebuild();</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (isCompleted) {</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Background building completed!');</span>
<span class="cstat-no" title="statement not covered" >      this.postBackgroundBuildFunc();</span>
    }
  }
&nbsp;
  /**
   ...
   */
  async <span class="fstat-no" title="function not covered" >generatePagesMarkedToRebuild(</span>): Promise&lt;boolean&gt; {
    const pagesToRebuild = <span class="cstat-no" title="statement not covered" >this.pages.filter(<span class="fstat-no" title="function not covered" >(p</span>age) =&gt; {</span>
      const normalizedUrl = <span class="cstat-no" title="statement not covered" >fsUtil.removeExtension(page.pageConfig.sourcePath);</span>
<span class="cstat-no" title="statement not covered" >      return this.toRebuild.has(normalizedUrl);</span>
    });
&nbsp;
    const pageRebuildTask = <span class="cstat-no" title="statement not covered" >{</span>
      mode: 'async',
      pages: pagesToRebuild,
    };
<span class="cstat-no" title="statement not covered" >    return this.runPageGenerationTasks([pageRebuildTask]);</span>
  }
&nbsp;
  async <span class="fstat-no" title="function not covered" >_rebuildSourceFiles(</span>) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode) {</span>
<span class="cstat-no" title="statement not covered" >      this.stopOngoingBuilds();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    logger.info('Pages or site config modified, updating pages...');</span>
<span class="cstat-no" title="statement not covered" >    this.beforeSiteGenerate();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.layoutManager.removeLayouts();</span>
&nbsp;
    const removedPageFilePaths = <span class="cstat-no" title="statement not covered" >this.updateAddressablePages();</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await this.removeAsset(removedPageFilePaths);</span>
<span class="cstat-no" title="statement not covered" >      await this.rebuildRequiredPages();</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode) {</span>
<span class="cstat-no" title="statement not covered" >        this.backgroundBuildNotViewedFiles();</span>
      }
    } catch (error) {
...
&nbsp;
   ...
   */
  async <span class="fstat-no" title="function not covered" >rebuildRequiredPages(</span>) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.onePagePath) {</span>
<span class="cstat-no" title="statement not covered" >      this.mapAddressablePagesToPages(this.addressablePages || [], this.getFavIconUrl());</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      await this._rebuildPagesBeingViewed(this.currentOpenedPages);</span>
<span class="cstat-no" title="statement not covered" >      await this.lazyBuildAllPagesNotViewed(this.currentOpenedPages);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    logger.warn('Rebuilding all pages...');</span>
<span class="cstat-no" title="statement not covered" >    await this.buildSourceFiles();</span>
  }
&nbsp;
  async <span class="fstat-no" title="function not covered" >_buildMultipleAssets(</span>filePaths: string | string[]) {
    const filePathArray = <span class="cstat-no" title="statement not covered" >Array.isArray(filePaths) ? filePaths : [filePaths];</span>
    const uniquePaths = <span class="cstat-no" title="statement not covered" >_.uniq(filePathArray);</span>
    const fileIgnore = <span class="cstat-no" title="statement not covered" >ignore().add(this.siteConfig.ignore);</span>
    const fileRelativePaths = <span class="cstat-no" title="statement not covered" >uniquePaths.map(<span class="fstat-no" title="function not covered" >filePath </span>=&gt; <span class="cstat-no" title="statement not covered" >path.relative(this.rootPath, filePath))</span>;</span>
    const copyAssets = <span class="cstat-no" title="statement not covered" >fileIgnore.filter(fileRelativePaths)</span>
      .map(<span class="fstat-no" title="function not covered" >asset </span>=&gt; <span class="cstat-no" title="statement not covered" >fs.copy(path.join(this.rootPath, asset), path.join(this.outputPath, asset)))</span>;
<span class="cstat-no" title="statement not covered" >    await Promise.all(copyAssets);</span>
<span class="cstat-no" title="statement not covered" >    logger.info('Assets built');</span>
  }
&nbsp;
  async _removeMultipleAssets(filePaths: string | string[]) {
    const filePathArray = Array.isArray(filePaths) ? filePaths : <span class="branch-1 cbranch-no" title="branch not covered" >[filePaths];</span>
...
&nbsp;
  async <span class="fstat-no" title="function not covered" >buildAssets(</span>) {
<span class="cstat-no" title="statement not covered" >    logger.info('Building assets...');</span>
    const outputFolder = <span class="cstat-no" title="statement not covered" >path.relative(this.rootPath, this.outputPath);</span>
    const fileIgnore = <span class="cstat-no" title="statement not covered" >ignore().add([...this.siteConfig.ignore, outputFolder]);</span>
&nbsp;
    // Scan and copy assets (excluding ignore files).
<span class="cstat-no" title="statement not covered" >    try {</span>
      const listOfAssets = <span class="cstat-no" title="statement not covered" >this.listAssets(fileIgnore);</span>
      const assetsToCopy = <span class="cstat-no" title="statement not covered" >listOfAssets.map(<span class="fstat-no" title="function not covered" >asset </span>=&gt;</span>
<span class="cstat-no" title="statement not covered" >        fs.copy(path.join(this.rootPath, asset), path.join(this.outputPath, asset)))</span>;
<span class="cstat-no" title="statement not covered" >      await Promise.all(assetsToCopy);</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Assets built');</span>
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      await Site.rejectHandler(error, []); </span>// assets won't affect deletion
    }
  }
&nbsp;
  async <span class="fstat-no" title="function not covered" >reloadSiteConfig(</span>) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode) {</span>
<span class="cstat-no" title="statement not covered" >      this.stopOngoingBuilds();</span>
    }
&nbsp;
    const oldSiteConfig = <span class="cstat-no" title="statement not covered" >this.siteConfig;</span>
    const oldAddressablePages = <span class="cstat-no" title="statement not covered" >this.addressablePages.slice();</span>
    const oldPagesSrc = <span class="cstat-no" title="statement not covered" >oldAddressablePages.map(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page.src)</span>;</span>
<span class="cstat-no" title="statement not covered" >    await this.readSiteConfig();</span>
<span class="cstat-no" title="statement not covered" >    await this.handleIgnoreReload(oldSiteConfig.ignore);</span>
<span class="cstat-no" title="statement not covered" >    await this.handlePageReload(oldAddressablePages, oldPagesSrc, oldSiteConfig);</span>
<span class="cstat-no" title="statement not covered" >    await this.handleStyleReload(oldSiteConfig.style);</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode) {</span>
<span class="cstat-no" title="statement not covered" >      this.backgroundBuildNotViewedFiles();</span>
    }
  }
&nbsp;
   ...
   */
  async <span class="fstat-no" title="function not covered" >handlePageReload(</span>oldAddressablePages: AddressablePage[], oldPagesSrc: string[],
                         oldSiteConfig: SiteConfig) {
<span class="cstat-no" title="statement not covered" >    this.collectAddressablePages();</span>
&nbsp;
    // Comparator for the _differenceWith comparison below
    const isNewPage = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(n</span>ewPage: AddressablePage, oldPage: AddressablePage) =&gt;</span>
<span class="cstat-no" title="statement not covered" >      _.isEqual(newPage, oldPage) || newPage.src === oldPage.src;</span>
&nbsp;
    const addedPages = <span class="cstat-no" title="statement not covered" >_.differenceWith(this.addressablePages, oldAddressablePages, isNewPage);</span>
    const removedPages = <span class="cstat-no" title="statement not covered" >_.differenceWith(oldAddressablePages, this.addressablePages, isNewPage)</span>
      .map(<span class="fstat-no" title="function not covered" >filePath </span>=&gt; <span class="cstat-no" title="statement not covered" >fsUtil.setExtension(filePath.src as string, '.html'))</span>;
&nbsp;
    // Checks if any attributes of site.json requiring a global rebuild are modified
    const isGlobalConfigModified = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >!_.isEqual(oldSiteConfig.faviconPath, this.siteConfig.faviconPath)</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (isGlobalConfigModified() || !_.isEmpty(addedPages) || !_.isEmpty(removedPages)) {</span>
<span class="cstat-no" title="statement not covered" >      await this.removeAsset(removedPages);</span>
<span class="cstat-no" title="statement not covered" >      this.buildManagers();</span>
<span class="cstat-no" title="statement not covered" >      await this._rebuildSourceFiles();</span>
<span class="cstat-no" title="statement not covered" >      await this.writeSiteData();</span>
    } else {
      // Get pages with edited attributes but with the same src
      const editedPages = <span class="cstat-no" title="statement not covered" >_.differenceWith(this.addressablePages, oldAddressablePages, <span class="fstat-no" title="function not covered" >(n</span>ewPage, oldPage) =&gt;</span>
<span class="cstat-no" title="statement not covered" >        _.isEqual(newPage, oldPage) || !oldPagesSrc.includes(newPage.src))</span>;
<span class="cstat-no" title="statement not covered" >      this.updatePages(editedPages);</span>
      const siteConfigDirectory = <span class="cstat-no" title="statement not covered" >path.dirname(path.join(this.rootPath, this.siteConfigPath));</span>
<span class="cstat-no" title="statement not covered" >      this.regenerateAffectedPages(editedPages.map(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >path.join(siteConfigDirectory, page.src))</span>);</span>
    }
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  updatePages(</span>pagesToUpdate: AddressablePage[]) {
<span class="cstat-no" title="statement not covered" >    pagesToUpdate.forEach(<span class="fstat-no" title="function not covered" >(p</span>ageToUpdate) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.pages.forEach(<span class="fstat-no" title="function not covered" >(p</span>age, index) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (page.pageConfig.src === pageToUpdate.src) {</span>
          const newPage = <span class="cstat-no" title="statement not covered" >this.createNewPage(pageToUpdate, this.getFavIconUrl());</span>
<span class="cstat-no" title="statement not covered" >          newPage.resetState();</span>
<span class="cstat-no" title="statement not covered" >          this.pages[index] = newPage;</span>
        }
      });
    });
  }
&nbsp;
   ...
   */
  async <span class="fstat-no" title="function not covered" >handleIgnoreReload(</span>oldIgnore: string[]) {
    const assetsToRemove = <span class="cstat-no" title="statement not covered" >_.difference(this.siteConfig.ignore, oldIgnore);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isEqual(oldIgnore, this.siteConfig.ignore)) {</span>
<span class="cstat-no" title="statement not covered" >      await this._removeMultipleAssets(assetsToRemove);</span>
<span class="cstat-no" title="statement not covered" >      this.buildManagers();</span>
<span class="cstat-no" title="statement not covered" >      await this.buildAssets();</span>
    }
  }
&nbsp;
   ...
   */
  async <span class="fstat-no" title="function not covered" >handleStyleReload(</span>oldStyle: SiteConfigStyle) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isEqual(oldStyle.bootstrapTheme, this.siteConfig.style.bootstrapTheme)) {</span>
<span class="cstat-no" title="statement not covered" >      await this.copyBootstrapTheme(true);</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Updated bootstrap theme');</span>
    }
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  isDependencyOfPage(</span>filePath: string): boolean {
<span class="cstat-no" title="statement not covered" >    return this.pages.some(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page.isDependency(filePath))</span></span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  isFilepathAPage(</span>filePath: string): boolean {
    const { pages, pagesExclude } = <span class="cstat-no" title="statement not covered" >this.siteConfig;</span>
    const relativeFilePath = <span class="cstat-no" title="statement not covered" >fsUtil.ensurePosix(path.relative(this.rootPath, filePath));</span>
    const srcesFromPages = <span class="cstat-no" title="statement not covered" >_.flatMap(pages.filter(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page.src)</span>,</span>
<span class="fstat-no" title="function not covered" >                                     page </span>=&gt; (<span class="cstat-no" title="statement not covered" >Array.isArray(page.src) ? page.src : [page.src])</span>);
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (srcesFromPages.includes(relativeFilePath)) {</span>
<span class="cstat-no" title="statement not covered" >      return true;</span>
    }
&nbsp;
    const filePathsFromGlobs = <span class="cstat-no" title="statement not covered" >_.flatMap(pages.filter(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page.glob)</span>,</span>
<span class="fstat-no" title="function not covered" >                                         page </span>=&gt; <span class="cstat-no" title="statement not covered" >this.getPageGlobPaths(page, pagesExclude))</span>;
<span class="cstat-no" title="statement not covered" >    return filePathsFromGlobs.some(<span class="fstat-no" title="function not covered" >fp </span>=&gt; <span class="cstat-no" title="statement not covered" >fp === relativeFilePath)</span>;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getFavIconUrl(</span>) {
    const { baseUrl, faviconPath } = <span class="cstat-no" title="statement not covered" >this.siteConfig;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (faviconPath) {</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (!fs.existsSync(path.join(this.rootPath, faviconPath))) {</span>
<span class="cstat-no" title="statement not covered" >        logger.warn(`${faviconPath} does not exist`);</span>
      }
<span class="cstat-no" title="statement not covered" >      return url.join('/', baseUrl, faviconPath);</span>
    } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (fs.existsSync(path.join(this.rootPath, FAVICON_DEFAULT_PATH))) {</span>
<span class="cstat-no" title="statement not covered" >      return url.join('/', baseUrl, FAVICON_DEFAULT_PATH);</span>
    }
&nbsp;
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  mapAddressablePagesToPages(</span>addressablePages: AddressablePage[], faviconUrl: string | undefined) {
<span class="cstat-no" title="statement not covered" >    this.pages = addressablePages.map(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >this.createNewPage(page, faviconUrl))</span>;</span>
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  createNewPage(</span>page: AddressablePage, faviconUrl: string | undefined) {
<span class="cstat-no" title="statement not covered" >    return this.createPage({</span>
      faviconUrl,
      pageSrc: page.src,
      title: page.title,
      layout: page.layout,
...
&nbsp;
<span class="fstat-no" title="function not covered" >  stopOngoingBuilds(</span>) {
<span class="cstat-no" title="statement not covered" >    this.stopGenerationTimeThreshold = new Date();</span>
  }
&nbsp;
  /**
   ...
   * ran to completion
   */
  async <span class="fstat-no" title="function not covered" >runPageGenerationTasks(</span>pageGenerationTasks: PageGenerationTask[]): Promise&lt;boolean&gt; {
    const pagesCount = <span class="cstat-no" title="statement not covered" >pageGenerationTasks.reduce(<span class="fstat-no" title="function not covered" >(a</span>cc, task) =&gt; <span class="cstat-no" title="statement not covered" >acc + task.pages.length,</span> 0);</span>
    const progressBar = <span class="cstat-no" title="statement not covered" >new ProgressBar(`[:bar] :current / ${pagesCount} pages built`, { total: pagesCount });</span>
<span class="cstat-no" title="statement not covered" >    progressBar.render();</span>
<span class="cstat-no" title="statement not covered" >    logger.setProgressBar(progressBar);</span>
&nbsp;
    const startTime = <span class="cstat-no" title="statement not covered" >new Date();</span>
    let isCompleted = <span class="cstat-no" title="statement not covered" >true;</span>
<span class="cstat-no" title="statement not covered" >    await sequentialAsyncForEach(pageGenerationTasks, <span class="fstat-no" title="function not covered" >async (t</span>ask) =&gt;<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" > {</span></span></span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode &amp;&amp; startTime &lt; this.stopGenerationTimeThreshold) {</span>
<span class="cstat-no" title="statement not covered" >        logger.info('Page generation stopped');</span>
<span class="cstat-no" title="statement not covered" >        logger.debug('Page generation stopped at generation task queue');</span>
<span class="cstat-no" title="statement not covered" >        isCompleted = false;</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (task.mode === 'sequential') {</span>
<span class="cstat-no" title="statement not covered" >        isCompleted = await this.generatePagesSequential(task.pages, progressBar);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        isCompleted = await this.generatePagesAsyncThrottled(task.pages, progressBar) as boolean;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      logger.removeProgressBar();</span>
<span class="cstat-no" title="statement not covered" >      this.siteLinkManager.validateAllIntralinks();</span>
    });
<span class="cstat-no" title="statement not covered" >    return isCompleted;</span>
  }
&nbsp;
  /**
   ...
   * ran to completion
   */
  async <span class="fstat-no" title="function not covered" >generatePagesSequential(</span>pages: Page[], progressBar: any): Promise&lt;boolean&gt; {
    const startTime = <span class="cstat-no" title="statement not covered" >new Date();</span>
    let isCompleted = <span class="cstat-no" title="statement not covered" >true;</span>
<span class="cstat-no" title="statement not covered" >    await sequentialAsyncForEach(pages, <span class="fstat-no" title="function not covered" >async (p</span>age) =&gt;<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" > {</span></span></span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode &amp;&amp; startTime &lt; this.stopGenerationTimeThreshold) {</span>
<span class="cstat-no" title="statement not covered" >        logger.info('Page generation stopped');</span>
<span class="cstat-no" title="statement not covered" >        logger.debug('Page generation stopped at sequential generation');</span>
<span class="cstat-no" title="statement not covered" >        isCompleted = false;</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        await page.generate(this.externalManager);</span>
<span class="cstat-no" title="statement not covered" >        this.toRebuild.delete(fsUtil.removeExtension(page.pageConfig.sourcePath));</span>
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode) {</span>
<span class="cstat-no" title="statement not covered" >          await this.writeSiteData(false);</span>
        }
<span class="cstat-no" title="statement not covered" >        progressBar.tick();</span>
      } catch (err) {
<span class="cstat-no" title="statement not covered" >        logger.error(err);</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(`Error while generating ${page.pageConfig.sourcePath}`);</span>
      }
    });
<span class="cstat-no" title="statement not covered" >    return isCompleted;</span>
  }
&nbsp;
   ...
   * ran to completion
   */
<span class="fstat-no" title="function not covered" >  generatePagesAsyncThrottled(</span>pages: Page[], progressBar: any): Promise&lt;boolean&gt; {
<span class="cstat-no" title="statement not covered" >    return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
      const context: PageGenerationContext = <span class="cstat-no" title="statement not covered" >{</span>
        startTime: new Date(),
        numPagesGenerated: 0,
...
&nbsp;
      ...
      const pageGenerationQueue = <span class="cstat-no" title="statement not covered" >pages.map(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >async () =</span>&gt;<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" > {</span></span></span></span>
        // Pre-generate guard to ensure no newly executed callbacks start on stop
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.backgroundBuildMode &amp;&amp; context.startTime &lt; this.stopGenerationTimeThreshold) {</span>
<span class="cstat-no" title="statement not covered" >          <span class="missing-if-branch" title="if path not taken" >I</span>if (context.isCompleted) {</span>
<span class="cstat-no" title="statement not covered" >            logger.info('Page generation stopped');</span>
<span class="cstat-no" title="statement not covered" >            logger.debug('Page generation stopped at asynchronous generation');</span>
<span class="cstat-no" title="statement not covered" >            context.isCompleted = false;</span>
...
<span class="cstat-no" title="statement not covered" >          this.generateProgressBarStatus(progressBar, context, pageGenerationQueue, resolve);</span>
        } catch (err) {
<span class="cstat-no" title="statement not covered" >          logger.error(err);</span>
<span class="cstat-no" title="statement not covered" >          reject(new Error(`Error while generating ${page.pageConfig.sourcePath}`));</span>
        }
      });
&nbsp;
      /*
       ...
       */
<span class="cstat-no" title="statement not covered" >      pageGenerationQueue.splice(0, MAX_CONCURRENT_PAGE_GENERATION_PROMISES)</span>
        .forEach(<span class="fstat-no" title="function not covered" >generatePage </span>=&gt; <span class="cstat-no" title="statement not covered" >generatePage())</span>;
    });
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  generateProgressBarStatus(</span>progressBar: any, context: PageGenerationContext,
...
<span class="cstat-no" title="statement not covered" >    progressBar.tick();</span>
<span class="cstat-no" title="statement not covered" >    context.numPagesGenerated += 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (pageGenerationQueue.length) {</span>
<span class="cstat-no" title="statement not covered" >      pageGenerationQueue.pop()!();</span>
    } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (context.numPagesGenerated === context.numPagesToGenerate) {</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  generatePages(</span>) {
    // Run MarkBind include and render on each source file.
    // Render the final rendered page to the output folder.
    const addressablePages = <span class="cstat-no" title="statement not covered" >this.addressablePages || [];</span>
&nbsp;
    const faviconUrl = <span class="cstat-no" title="statement not covered" >this.getFavIconUrl();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._setTimestampVariable();</span>
<span class="cstat-no" title="statement not covered" >    this.mapAddressablePagesToPages(addressablePages, faviconUrl);</span>
&nbsp;
    const pageGenerationTask = <span class="cstat-no" title="statement not covered" >{</span>
      mode: 'async',
      pages: this.pages,
    };
<span class="cstat-no" title="statement not covered" >    return this.runPageGenerationTasks([pageGenerationTask]);</span>
  }
&nbsp;
  /**
   * Renders only the starting page for lazy loading to the output folder.
   */
  async <span class="fstat-no" title="function not covered" >generateLandingPage(</span>) {
    const addressablePages = <span class="cstat-no" title="statement not covered" >this.addressablePages || [];</span>
    const faviconUrl = <span class="cstat-no" title="statement not covered" >this.getFavIconUrl();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._setTimestampVariable();</span>
<span class="cstat-no" title="statement not covered" >    this.mapAddressablePagesToPages(addressablePages, faviconUrl);</span>
&nbsp;
    const landingPage = <span class="cstat-no" title="statement not covered" >this.pages.find(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page.pageConfig.src === this.onePagePath)</span>;</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!landingPage) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(`${this.onePagePath} is not specified in the site configuration.`);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    await landingPage.generate(this.externalManager);</span>
  }
&nbsp;
  async <span class="fstat-no" title="function not covered" >regenerateAffectedPages(</span>filePaths: string[]) {
    const startTime = <span class="cstat-no" title="statement not covered" >new Date();</span>
&nbsp;
    const shouldRebuildAllPages = <span class="cstat-no" title="statement not covered" >this.collectUserDefinedVariablesMapIfNeeded(filePaths) || this.forceReload;</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (shouldRebuildAllPages) {</span>
<span class="cstat-no" title="statement not covered" >      logger.warn('Rebuilding all pages as variables file was changed, or the --force-reload flag was set');</span>
    }
<span class="cstat-no" title="statement not covered" >    this._setTimestampVariable();</span>
&nbsp;
    let openedPagesToRegenerate: Page[] = <span class="cstat-no" title="statement not covered" >[];</span>
    const asyncPagesToRegenerate = <span class="cstat-no" title="statement not covered" >this.pages.filter(<span class="fstat-no" title="function not covered" >(p</span>age) =&gt; {</span>
      const doFilePathsHaveSourceFiles = <span class="cstat-no" title="statement not covered" >filePaths.some(<span class="fstat-no" title="function not covered" >filePath </span>=&gt; <span class="cstat-no" title="statement not covered" >page.isDependency(filePath))</span>;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (shouldRebuildAllPages || doFilePathsHaveSourceFiles) {</span>
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.onePagePath) {</span>
          const normalizedSource = <span class="cstat-no" title="statement not covered" >fsUtil.removeExtension(page.pageConfig.sourcePath);</span>
          const openIdx = <span class="cstat-no" title="statement not covered" >this.currentOpenedPages.findIndex(<span class="fstat-no" title="function not covered" >pagePath </span>=&gt; <span class="cstat-no" title="statement not covered" >pagePath === normalizedSource)</span>;</span>
          const isRecentlyViewed = <span class="cstat-no" title="statement not covered" >openIdx !== -1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!isRecentlyViewed) {</span>
<span class="cstat-no" title="statement not covered" >            this.toRebuild.add(normalizedSource);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            openedPagesToRegenerate[openIdx] = page;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    openedPagesToRegenerate = openedPagesToRegenerate.filter(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page)</span>;</span>
&nbsp;
    const totalPagesToRegenerate = <span class="cstat-no" title="statement not covered" >openedPagesToRegenerate.length + asyncPagesToRegenerate.length;</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (totalPagesToRegenerate === 0) {</span>
<span class="cstat-no" title="statement not covered" >      logger.info('No pages needed to be rebuilt');</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    logger.info(`Rebuilding ${totalPagesToRegenerate} pages`);</span>
&nbsp;
    const pageGenerationTasks = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (openedPagesToRegenerate.length &gt; 0) {</span>
      const recentPagesGenerationTask = <span class="cstat-no" title="statement not covered" >{</span>
        mode: 'sequential',
        pages: openedPagesToRegenerate,
      };
<span class="cstat-no" title="statement not covered" >      pageGenerationTasks.push(recentPagesGenerationTask);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (asyncPagesToRegenerate.length &gt; 0) {</span>
      const asyncPagesGenerationTask = <span class="cstat-no" title="statement not covered" >{</span>
        mode: 'async',
        pages: asyncPagesToRegenerate,
      };
<span class="cstat-no" title="statement not covered" >      pageGenerationTasks.push(asyncPagesGenerationTask);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await this.runPageGenerationTasks(pageGenerationTasks);</span>
<span class="cstat-no" title="statement not covered" >      await this.writeSiteData();</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Pages rebuilt');</span>
<span class="cstat-no" title="statement not covered" >      this.calculateBuildTimeForRegenerateAffectedPages(startTime);</span>
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      await Site.rejectHandler(error, []);</span>
    }
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  calculateBuildTimeForRegenerateAffectedPages(</span>startTime: Date) {
    const endTime = <span class="cstat-no" title="statement not covered" >new Date();</span>
    const totalBuildTime = <span class="cstat-no" title="statement not covered" >(endTime.getTime() - startTime.getTime()) / 1000;</span>
<span class="cstat-no" title="statement not covered" >    logger.info(`Website regeneration complete! Total build time: ${totalBuildTime}s`);</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.onePagePath &amp;&amp; totalBuildTime &gt; LAZY_LOADING_REBUILD_TIME_RECOMMENDATION_LIMIT) {</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Your pages took quite a while to rebuild...'</span>
          + 'Have you considered using markbind serve -o when writing content to speed things up?');
    }
  }
&nbsp;
   ...
   */
  async <span class="fstat-no" title="function not covered" >copyFontAwesomeAsset(</span>) {
    const faRootSrcPath = <span class="cstat-no" title="statement not covered" >path.dirname(require.resolve('@fortawesome/fontawesome-free/package.json'));</span>
    const faCssSrcPath = <span class="cstat-no" title="statement not covered" >path.join(faRootSrcPath, 'css', 'all.min.css');</span>
    const faCssDestPath = <span class="cstat-no" title="statement not covered" >path.join(this.siteAssetsDestPath, 'fontawesome', 'css', 'all.min.css');</span>
    const faFontsSrcPath = <span class="cstat-no" title="statement not covered" >path.join(faRootSrcPath, 'webfonts');</span>
    const faFontsDestPath = <span class="cstat-no" title="statement not covered" >path.join(this.siteAssetsDestPath, 'fontawesome', 'webfonts');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    await fs.copy(faCssSrcPath, faCssDestPath);</span>
<span class="cstat-no" title="statement not covered" >    await fs.copy(faFontsSrcPath, faFontsDestPath);</span>
  }
&nbsp;
  /**
   * Copies Octicon assets to the assets folder
   */
<span class="fstat-no" title="function not covered" >  copyOcticonsAsset(</span>) {
    const octiconsCssSrcPath = <span class="cstat-no" title="statement not covered" >require.resolve('@primer/octicons/build/build.css');</span>
    const octiconsCssDestPath = <span class="cstat-no" title="statement not covered" >path.join(this.siteAssetsDestPath, 'css', 'octicons.css');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return fs.copy(octiconsCssSrcPath, octiconsCssDestPath);</span>
  }
&nbsp;
  /**
   * Copies Google Material Icons assets to the assets folder
   */
<span class="fstat-no" title="function not covered" >  copyMaterialIconsAsset(</span>) {
    const materialIconsRootSrcPath = <span class="cstat-no" title="statement not covered" >path.dirname(require.resolve('material-icons/package.json'));</span>
    const materialIconsCssAndFontsSrcPath = <span class="cstat-no" title="statement not covered" >path.join(materialIconsRootSrcPath, 'iconfont');</span>
    const materialIconsCssAndFontsDestPath = <span class="cstat-no" title="statement not covered" >path.join(this.siteAssetsDestPath, 'material-icons');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return fs.copy(materialIconsCssAndFontsSrcPath, materialIconsCssAndFontsDestPath);</span>
  }
&nbsp;
  /**
   * Copies core-web bundles and external assets to the assets output folder
   */
<span class="fstat-no" title="function not covered" >  copyCoreWebAsset(</span>) {
    const coreWebRootPath = <span class="cstat-no" title="statement not covered" >path.dirname(require.resolve('@markbind/core-web/package.json'));</span>
    const coreWebAssetPath = <span class="cstat-no" title="statement not covered" >path.join(coreWebRootPath, 'asset');</span>
<span class="cstat-no" title="statement not covered" >    fs.copySync(coreWebAssetPath, this.siteAssetsDestPath);</span>
&nbsp;
    const dirsToCopy = <span class="cstat-no" title="statement not covered" >['fonts'];</span>
    const filesToCopy = <span class="cstat-no" title="statement not covered" >[</span>
      'js/markbind.min.js',
      'css/markbind.min.css',
    ];
&nbsp;
    const copyAllFiles = <span class="cstat-no" title="statement not covered" >filesToCopy.map(<span class="fstat-no" title="function not covered" >(f</span>ile) =&gt; {</span>
      const srcPath = <span class="cstat-no" title="statement not covered" >path.join(coreWebRootPath, 'dist', file);</span>
      const destPath = <span class="cstat-no" title="statement not covered" >path.join(this.siteAssetsDestPath, file);</span>
<span class="cstat-no" title="statement not covered" >      return fs.copy(srcPath, destPath);</span>
    });
&nbsp;
    const copyFontsDir = <span class="cstat-no" title="statement not covered" >dirsToCopy.map(<span class="fstat-no" title="function not covered" >(d</span>ir) =&gt; {</span>
      const srcPath = <span class="cstat-no" title="statement not covered" >path.join(coreWebRootPath, 'dist', dir);</span>
      const destPath = <span class="cstat-no" title="statement not covered" >path.join(this.siteAssetsDestPath, 'css', dir);</span>
<span class="cstat-no" title="statement not covered" >      return fs.copy(srcPath, destPath);</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return Promise.all([...copyAllFiles, ...copyFontsDir]);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  copyBootstrapIconsAsset(</span>) {
    const bootstrapIconsCssSrcPath = <span class="cstat-no" title="statement not covered" >require.resolve('bootstrap-icons/font/bootstrap-icons.css');</span>
    const bootstrapIconsFontsSrcPath = <span class="cstat-no" title="statement not covered" >path.dirname(bootstrapIconsCssSrcPath);</span>
    const bootstrapIconsFontsDestPath = <span class="cstat-no" title="statement not covered" >path.join(this.siteAssetsDestPath, 'bootstrap-icons', 'font');</span>
<span class="cstat-no" title="statement not covered" >    return fs.copy(bootstrapIconsFontsSrcPath, bootstrapIconsFontsDestPath);</span>
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  copyBootstrapTheme(</span>isRebuild: boolean) {
    const { bootstrapTheme } = <span class="cstat-no" title="statement not covered" >this.siteConfig.style;</span>
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if ((!isRebuild &amp;&amp; !bootstrapTheme)</span>
...
&nbsp;
    const themeSrcPath = <span class="cstat-no" title="statement not covered" >!bootstrapTheme</span>
      ? require.resolve('@markbind/core-web/asset/css/bootstrap.min.css')
      : SUPPORTED_THEMES_PATHS[bootstrapTheme];
    const themeDestPath = <span class="cstat-no" title="statement not covered" >path.join(this.siteAssetsDestPath, 'css', 'bootstrap.min.css');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return fs.copy(themeSrcPath, themeDestPath);</span>
  }
&nbsp;
  /**
   ...
   */
  async <span class="fstat-no" title="function not covered" >writeSiteData(</span>verbose: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >true)</span> {
    const siteDataPath = <span class="cstat-no" title="statement not covered" >path.join(this.outputPath, SITE_DATA_NAME);</span>
    const siteData = <span class="cstat-no" title="statement not covered" >{</span>
      enableSearch: this.siteConfig.enableSearch,
      pages: this.pages.filter(<span class="fstat-no" title="function not covered" >page </span>=&gt; <span class="cstat-no" title="statement not covered" >page.pageConfig.searchable &amp;&amp; page.headings)</span>
        .map(<span class="fstat-no" title="function not covered" >page </span>=&gt; (<span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      await fs.outputJson(siteDataPath, siteData, { spaces: 2 });</span>
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (verbose) {</span>
<span class="cstat-no" title="statement not covered" >        logger.info('Site data built');</span>
      }
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      await Site.rejectHandler(error, [this.tempPath, this.outputPath]);</span>
    }
...
&nbsp;
  ...
  async getDepOptions(ciTokenVar: boolean | string, defaultDeployConfig: DeployOptions,
    ...
    const options: DeployOptions = {
      ...
      message: this.siteConfig.deploy.message || <span class="branch-1 cbranch-no" title="branch not covered" >defaultDeployConfig.message,</span>
...
&nbsp;
    if (ciTokenVar) {
      const ciToken = _.isBoolean(ciTokenVar) ? 'GITHUB_TOKEN' : <span class="branch-1 cbranch-no" title="branch not covered" >ciTokenVar;</span>
...
&nbsp;
    ...
    function <span class="fstat-no" title="function not covered" >constructGhPagesUrl(</span>remoteUrl: string) {
<span class="cstat-no" title="statement not covered" >      <span class="missing-if-branch" title="if path not taken" >I</span>if (!remoteUrl) {</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
      }
      const parts = <span class="cstat-no" title="statement not covered" >remoteUrl.split('/');</span>
<span class="cstat-no" title="statement not covered" >      if (remoteUrl.startsWith(HTTPS_PREAMBLE)) {</span>
        // https://github.com/&lt;name|org&gt;/&lt;repo&gt;.git (HTTPS)
        const repoNameWithExt = <span class="cstat-no" title="statement not covered" >parts[parts.length - 1];</span>
        const repoName = <span class="cstat-no" title="statement not covered" >repoNameWithExt.substring(0, repoNameWithExt.lastIndexOf('.'));</span>
        const name = <span class="cstat-no" title="statement not covered" >parts[parts.length - 2].toLowerCase();</span>
<span class="cstat-no" title="statement not covered" >        return `https://${name}.${GITHUB_IO_PART}/${repoName}`;</span>
      } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>if (remoteUrl.startsWith(SSH_PREAMBLE)) {</span>
        // git@github.com:&lt;name|org&gt;/&lt;repo&gt;.git (SSH)
        const repoNameWithExt = <span class="cstat-no" title="statement not covered" >parts[parts.length - 1];</span>
        const repoName = <span class="cstat-no" title="statement not covered" >repoNameWithExt.substring(0, repoNameWithExt.lastIndexOf('.'));</span>
        const name = <span class="cstat-no" title="statement not covered" >parts[0].substring(SSH_PREAMBLE.length);</span>
<span class="cstat-no" title="statement not covered" >        return `https://${name}.${GITHUB_IO_PART}/${repoName}`;</span>
      }
<span class="cstat-no" title="statement not covered" >      return null;</span>
    }
...
&nbsp;
    try {
      ...
      const generateGhPagesUrl = (results: string[]) =&gt; {
        ...
        if (cname) {
          return cname.trim();
        } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span><span class="missing-if-branch" title="else path not taken" >E</span>if (repo) {</span>
<span class="cstat-no" title="statement not covered" >          return constructGhPagesUrl(repo);</span>
        }
<span class="cstat-no" title="statement not covered" >        return constructGhPagesUrl(remoteUrl.trim());</span>
      };
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  _setTimestampVariable(</span>) {
    const options: Intl.DateTimeFormatOptions = <span class="cstat-no" title="statement not covered" >{</span>
      weekday: 'short',
      year: 'numeric',
      month: 'short',
      day: 'numeric',
    ...
    const time = <span class="cstat-no" title="statement not covered" >new Date().toLocaleTimeString(this.siteConfig.locale, options);</span>
<span class="cstat-no" title="statement not covered" >    this.variableProcessor.addUserDefinedVariableForAllSites('timestamp', time);</span>
  }
&nbsp;
  /**
