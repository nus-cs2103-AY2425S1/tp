...
<head>
    <title>Code coverage report for src/Site/SiteConfig.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/Site</a> SiteConfig.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  constructor(siteConfigJson: Record&lt;string, any&gt;, cliBaseUrl?: string) {
    this.baseUrl = cliBaseUrl !== undefined
      ? <span class="branch-0 cbranch-no" title="branch not covered" >cliBaseUrl</span>
...
&nbsp;
    ...
    this.style.codeLineNumbers = this.style.codeLineNumbers !== undefined
      ? <span class="branch-0 cbranch-no" title="branch not covered" >this.style.codeLineNumbers </span>: false;
&nbsp;
    this.pages = siteConfigJson.pages || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    this.pagesExclude = siteConfigJson.pagesExclude || [];
    this.ignore = siteConfigJson.ignore || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
&nbsp;
    ...
    this.deploy = siteConfigJson.deploy || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
&nbsp;
    ...
    this.plantumlCheck = siteConfigJson.plantumlCheck !== undefined
      ? <span class="branch-0 cbranch-no" title="branch not covered" >siteConfigJson.plantumlCheck </span>: true; // check PlantUML's prerequisite by default
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >      throw (new Error(`Failed to read the site config file '${siteConfigPath}' at`</span>
