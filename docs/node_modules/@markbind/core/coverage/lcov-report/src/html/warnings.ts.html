...
<head>
    <title>Code coverage report for src/html/warnings.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/html</a> warnings.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as logger from '../utils/logger';
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  attrsConflictingWith.forEach(<span class="fstat-no" title="function not covered" >(c</span>onflictingAttr) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (conflictingAttr in node.attribs) {</span>
<span class="cstat-no" title="statement not covered" >      logger.warn(`Usage of conflicting ${node.name} attributes: `</span>
