...
<head>
    <title>Code coverage report for src/html/MdAttributeRenderer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/html</a> MdAttributeRenderer.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">83.07% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>54/65</span>
            </div>
...
<a name='L205'></a><a href='#L205'>205</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">11x</span>
...
&nbsp;
      ...
      node.children = node.children
        ...
        : <span class="branch-1 cbranch-no" title="branch not covered" >attributeSlotElement;</span>
    }
&nbsp;
...
&nbsp;
  ...
  hasSlotOverridingAttribute(node: MbNode, attribute: string, slotName = <span class="branch-0 cbranch-no" title="branch not covered" >attribute)</span>: boolean {
...
&nbsp;
   ...
   */
&nbsp;
<span class="fstat-no" title="function not covered" >  processThumbnailAttributes(</span>node: MbNode) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!node.attribs) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    const isImage = <span class="cstat-no" title="statement not covered" >_.has(node.attribs, 'src') &amp;&amp; node.attribs.src !== '';</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (isImage) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    const text = <span class="cstat-no" title="statement not covered" >_.has(node.attribs, 'text') ? node.attribs.text : '';</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (text === '') {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    const renderedText = <span class="cstat-no" title="statement not covered" >this.markdownProcessor.renderMdInline(text);</span>
<span class="cstat-no" title="statement not covered" >    node.children = parseHTML(renderedText);</span>
<span class="cstat-no" title="statement not covered" >    delete node.attribs.text;</span>
  }
&nbsp;
