...
<head>
    <title>Code coverage report for src/html/headerProcessor.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/html</a> headerProcessor.ts</h1>
        <div class='clearfix'>
...
<a name='L101'></a><a href='#L101'>101</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">11x</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!addHeaderCount) {
<span class="cstat-no" title="statement not covered" >    node.attribs.id = headerId;</span>
...
function _findHeaderElement(node: MbNode): undefined | NodeOrText {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!elements || !elements.length) {
...
&nbsp;
    if (nextEl<span class="branch-0 cbranch-no" title="branch not covered" >?.n</span>ame &amp;&amp; (/^h[1-6]$/).test(nextEl.name)) {
      return nextEl;
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (nextEl?.children) {</span>
<span class="cstat-no" title="statement not covered" >      nextEl.children.forEach(<span class="fstat-no" title="function not covered" >child </span>=&gt; <span class="cstat-no" title="statement not covered" >elementQueue.push(child))</span>;</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return undefined;</span>
...
&nbsp;
  if (headerSlot) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!header) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!header.attribs || !_.has(header.attribs, 'id')) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Found a panel heading without an assigned id.\n'</span>
