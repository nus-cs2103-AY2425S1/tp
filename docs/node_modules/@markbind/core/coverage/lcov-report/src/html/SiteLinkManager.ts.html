...
<head>
    <title>Code coverage report for src/html/SiteLinkManager.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/html</a> SiteLinkManager.ts</h1>
        <div class='clearfix'>
...
<a name='L118'></a><a href='#L118'>118</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">8x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import has from 'lodash/has';
...
&nbsp;
<span class="fstat-no" title="function not covered" >  validateAllIntralinks(</span>) {
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.config.intrasiteLinkValidation.enabled) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    this.intralinkCollection.forEach(<span class="fstat-no" title="function not covered" >(r</span>esourcePaths, cwf) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      resourcePaths.forEach(<span class="fstat-no" title="function not covered" >resourcePath </span>=&gt; <span class="cstat-no" title="statement not covered" >linkProcessor.validateIntraLink(resourcePath,</span></span>
                                                                            cwf,
                                                                            this.config,
                                                                            this.filePathToHashesMap));
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.intralinkCollection = new Map();</span>
  }
&nbsp;
  /**
...
&nbsp;
  ...
  maintainHashesForInclude(node: MbNode, cwf: string) {
    ...
    const isHeadingTag = <span class="cstat-no" title="statement not covered" >(/^h[1-6]$/).test(node.name);</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (isHeadingTag &amp;&amp; node.attribs &amp;&amp; !node.attribs.id) {</span>
<span class="cstat-no" title="statement not covered" >      setHeadingId(node, this.config, false);</span>
<span class="cstat-no" title="statement not covered" >      this.maintainFilePathToHashesMap(node, cwf);</span>
<span class="cstat-no" title="statement not covered" >      node.attribs.id = undefined;</span>
    }
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (node.attribs &amp;&amp; node.attribs.id) {</span>
<span class="cstat-no" title="statement not covered" >      this.maintainFilePathToHashesMap(node, cwf);</span>
    }
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (node.children) {</span>
<span class="cstat-no" title="statement not covered" >      node.children.forEach(<span class="fstat-no" title="function not covered" >(c</span>hild) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.maintainHashesForInclude(child as MbNode, cwf);</span>
      });
    }
  }
}
