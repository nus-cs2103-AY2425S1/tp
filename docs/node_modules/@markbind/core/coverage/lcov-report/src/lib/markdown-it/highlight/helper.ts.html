...
<head>
    <title>Code coverage report for src/lib/markdown-it/highlight/helper.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/lib/markdown-it/highlight</a> helper.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">10x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Common helper functions to be used in HighlightRule or HighlightRuleComponent
&nbsp;
