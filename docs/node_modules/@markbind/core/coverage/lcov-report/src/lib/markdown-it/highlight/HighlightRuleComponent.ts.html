...
<head>
    <title>Code coverage report for src/lib/markdown-it/highlight/HighlightRuleComponent.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/lib/markdown-it/highlight</a> HighlightRuleComponent.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">96.07% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>98/102</span>
            </div>
...
<a name='L213'></a><a href='#L213'>213</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">31x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { splitCodeAndIndentation } from './helper';
&nbsp;
...
&nbsp;
      const lineNumber = HighlightRuleComponent
        .isValidLineNumber(groups.shift() ?? <span class="branch-1 cbranch-no" title="branch not covered" >'',</span> 1, lines.length, lineNumberOffset);
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!lineNumber) <span class="cstat-no" title="statement not covered" >return null;</span>
&nbsp;
...
&nbsp;
      let bound = groups.map(x =&gt; (x !== '' ? parseInt(x, 10) : <span class="branch-1 cbranch-no" title="branch not covered" >UNBOUNDED)</span>) as [number, number];
      const isCharSlice = sliceMatch === linesliceCharMatch;
      bound = isCharSlice
        ? HighlightRuleComponent.computeCharBounds(bound, lines[lineNumber - 1])
        : <span class="branch-1 cbranch-no" title="branch not covered" >HighlightRuleComponent.computeWordBounds(bound, lines[lineNumber - 1]);</span>
&nbsp;
...
&nbsp;
    if (start === UNBOUNDED) {
      ...
      start += indents.length;
      // Clamp values
      <span class="missing-if-branch" title="if path not taken" >I</span>if (start &lt; indents.length) {
<span class="cstat-no" title="statement not covered" >        start = indents.length;</span>
...
&nbsp;
    if (end === UNBOUNDED) {
      ...
      // Clamp values
      <span class="missing-if-branch" title="if path not taken" >I</span>if (end &lt; indents.length) {
<span class="cstat-no" title="statement not covered" >        end = indents.length;</span>
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (end &lt; 0) {
<span class="cstat-no" title="statement not covered" >      end = indents.length;</span>
    } else {
