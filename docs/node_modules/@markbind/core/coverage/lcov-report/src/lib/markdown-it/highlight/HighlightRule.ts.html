...
<head>
    <title>Code coverage report for src/lib/markdown-it/highlight/HighlightRule.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/lib/markdown-it/highlight</a> HighlightRule.ts</h1>
        <div class='clearfix'>
...
<a name='L107'></a><a href='#L107'>107</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">29x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { HighlightRuleComponent } from './HighlightRuleComponent';
&nbsp;
...
&nbsp;
  ...
  static splitByChar(allRules: string, splitter: string) {
    ...
    for (let i = 0; i &lt; allRules.length; i += 1) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (allRules.charAt(i) === '\'' &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >i === 0 </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >allRules.charAt(i - 1) !== '\\')</span>) {
<span class="cstat-no" title="statement not covered" >        isWithinQuote = !isWithinQuote;</span>
      }
    }
...
&nbsp;
    const atLineNumber = <span class="cstat-no" title="statement not covered" >compares[0] === 0;</span>
<span class="cstat-no" title="statement not covered" >    return atLineNumber;</span>
  }
&nbsp;
