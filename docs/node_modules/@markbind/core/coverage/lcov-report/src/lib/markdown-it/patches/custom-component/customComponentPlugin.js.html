...
<head>
    <title>Code coverage report for src/lib/markdown-it/patches/custom-component/customComponentPlugin.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/lib/markdown-it/patches/custom-component</a> customComponentPlugin.js</h1>
        <div class='clearfix'>
 ...
 */
function <span class="fstat-no" title="function not covered" >customComponentPlugin(</span>md, tagsToIgnore) {
  const customComponentHtmlBlockRule = <span class="cstat-no" title="statement not covered" >initCustomComponentHtmlBlockRule(tagsToIgnore);</span>
&nbsp;
  // override default html block ruler
<span class="cstat-no" title="statement not covered" >  md.block.ruler.at('html_block', customComponentHtmlBlockRule, {</span>
    alt: ['paragraph', 'reference', 'blockquote'],
  });
&nbsp;
  // override default html inline ruler
<span class="cstat-no" title="statement not covered" >  md.inline.ruler.at('html_inline', htmlInlineRule);</span>
};
&nbsp;
/**
 ...
 */
function <span class="fstat-no" title="function not covered" >injectTags(</span>tagsToIgnore) {
<span class="cstat-no" title="statement not covered" >  markdownIt.use(customComponentPlugin, tagsToIgnore);</span>
}
&nbsp;
module.exports = {
  injectTags,
