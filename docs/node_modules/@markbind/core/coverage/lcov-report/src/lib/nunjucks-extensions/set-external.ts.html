...
<head>
    <title>Code coverage report for src/lib/nunjucks-extensions/set-external.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/lib/nunjucks-extensions</a> set-external.ts</h1>
        <div class='clearfix'>
...
<a name='L91'></a><a href='#L91'>91</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">10x</span>
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (fileType === 'json') {
            const resourceRaw = <span class="cstat-no" title="statement not covered" >fs.readFileSync(fullResourcePath);</span>
<span class="cstat-no" title="statement not covered" >            buffer.push(`{% set ${variableName} = ${resourceRaw} %}`);</span>
...
<span class="cstat-no" title="statement not covered" >      logger.error(`Invalid {% ext %} tag at line ${setExtTagToken.lineno}.`);</span>
<span class="cstat-no" title="statement not covered" >      return new nodes.NodeList(setExtTagToken.lineno, setExtTagToken.colno, []);</span>
    }
&nbsp;
