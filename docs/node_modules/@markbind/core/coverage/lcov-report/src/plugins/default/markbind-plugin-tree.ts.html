...
<head>
    <title>Code coverage report for src/plugins/default/markbind-plugin-tree.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/plugins/default</a> markbind-plugin-tree.ts</h1>
        <div class='clearfix'>
...
&nbsp;
   ...
   */
  isLastChild(): boolean {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.parent === null) {
...
&nbsp;
  ...
  getPositionalToken(): string {
    return this.isLastChild() ? TOKEN.lastChild : <span class="branch-1 cbranch-no" title="branch not covered" >TOKEN.child;</span>
  }
&nbsp;
  /**
  ...
  static levelize(line: string): number {
    const lineMatch = line.match(/^\s*/) ?? <span class="branch-1 cbranch-no" title="branch not covered" >[''];</span>
...
&nbsp;
  ...
  static traverse(currNode: TreeNode, result: string[]) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!currNode.children) {
...
&nbsp;
      ...
      while (curr &amp;&amp; _.has(curr, 'parent.parent')) {
        tokens.push(curr.isLastChild() ? TOKEN.space : <span class="branch-1 cbranch-no" title="branch not covered" >TOKEN.connector)</span>;
        curr = curr.parent;
      }
&nbsp;
...
export = {
  ...
  getLinks: <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >[`&lt;link rel="stylesheet" href="${CSS_FILE_NAME}"&gt;`],</span>
  processNode: (_pluginContext: PluginContext, node: MbNode) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (node.name !== 'tree') {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    node.name = 'div';
    node.attribs.class = node.attribs.class ? <span class="branch-0 cbranch-no" title="branch not covered" >`${node.attribs.class} tree` </span>: 'tree';
    node.children = node.children ?? <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
