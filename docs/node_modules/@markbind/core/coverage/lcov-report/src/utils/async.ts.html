...
<head>
    <title>Code coverage report for src/utils/async.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> async.ts</h1>
        <div class='clearfix'>
 ...
 */
export async function <span class="fstat-no" title="function not covered" >sequentialAsyncForEach&lt;</span>T&gt;(array: T[], func: (arg: T) =&gt; Promise&lt;unknown&gt;) {
<span class="cstat-no" title="statement not covered" >  for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; array.length; i += 1) {</span>
    // eslint-disable-next-line no-await-in-loop
<span class="cstat-no" title="statement not covered" >    await func(array[i]);</span>
  }
}
&nbsp;</pre></td></tr></table></pre>
