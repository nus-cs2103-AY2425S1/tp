...
<head>
    <title>Code coverage report for src/utils/delay.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> delay.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      pendingArgs = pendingArgs.concat(arg);</span>
    } else {
...
&nbsp;
    if (waitingPromise === null) {
      waitingPromise = Promise.all([Promise.delay(wait), runningPromise])
        .then(() =&gt; {
          runningPromise = waitingPromise || <span class="branch-1 cbranch-no" title="branch not covered" >Promise.resolve();</span>
          waitingPromise = null;
