...
public class CancelLessonCommandParserTest {
    ...
    private final Date VALID_DATE = new Date("15-10-2024");
    private final Time VALID_TIME = new Time("10:30");
    ...
    public void parse_noMissingParts_success() {
        ...
        String userInput = " " + PREFIX_DATE + "15-10-2024 " + PREFIX_START_TIME + "14:30";
        assertParseSuccess(parser, userInput, expectedCommand);
    }

    @Test
    public void parse_dateNotPresent_failure() {
        String userInput = PREFIX_START_TIME + "14:30";
        assertParseFailure(parser, userInput, MESSAGE_INVALID_FORMAT);
    }

    @Test
    public void parse_startTimeNotPresent_failure() {
        String userInput = PREFIX_DATE + "15-10-2024";
        assertParseFailure(parser, userInput, MESSAGE_INVALID_FORMAT);
    }

    @Test
    public void parse_invalidDateFormat_failure() {
        String userInput = PREFIX_DATE + "2024-10-15 " + PREFIX_START_TIME + "14:30";
        assertParseFailure(parser, userInput, Date.MESSAGE_CONSTRAINTS);
    }

    @Test
    public void parse_invalidStartTimeFormat_failure() {
        String userInput = PREFIX_DATE + "15-10-2024 " + PREFIX_START_TIME + "1430";
