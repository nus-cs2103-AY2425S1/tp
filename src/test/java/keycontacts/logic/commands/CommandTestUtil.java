...
public class CommandTestUtil {
    ...
    public static final String VALID_GRADELEVEL_AMY = "RSL 2";
    public static final String VALID_GRADELEVEL_BOB = "ABRSM 3";
    ...
    public static final String GRADELEVEL_DESC_AMY = " " + PREFIX_GRADELEVEL + VALID_GRADELEVEL_AMY;
    public static final String GRADELEVEL_DESC_BOB = " " + PREFIX_GRADELEVEL + VALID_GRADELEVEL_BOB;
    ...
    public static final String INVALID_GRADELEVEL_DESC = " " + PREFIX_GRADELEVEL + "RSL*";
