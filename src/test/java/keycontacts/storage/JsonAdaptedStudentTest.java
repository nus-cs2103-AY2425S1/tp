...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_PIANO_PIECES, EMPTY_REGULAR_LESSON);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                invalidTags, VALID_PIANO_PIECES, EMPTY_REGULAR_LESSON);
    ...
    public void toModelType_invalidPianoPieces_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, invalidPianoPieces, EMPTY_REGULAR_LESSON);
        assertThrows(IllegalValueException.class, student::toModelType);
    }
}
