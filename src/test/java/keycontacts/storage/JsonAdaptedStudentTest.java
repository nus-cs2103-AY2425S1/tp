...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_GRADE_LEVEL, VALID_PIANO_PIECES, EMPTY_REGULAR_LESSON);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                invalidTags, VALID_GRADE_LEVEL, VALID_PIANO_PIECES, EMPTY_REGULAR_LESSON);
    ...
    public void toModelType_invalidPianoPieces_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_GRADE_LEVEL, invalidPianoPieces, EMPTY_REGULAR_LESSON);
        assertThrows(IllegalValueException.class, student::toModelType);
    }
}
