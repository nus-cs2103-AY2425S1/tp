...
import static tuteez.storage.JsonAdaptedPerson.MISSING_FIELD_MESSAGE_FORMAT;
...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedLesson> VALID_LESSONS = BENSON.getLessons().stream()
            ...
            .collect(Collectors.toList());
    private static final JsonAdaptedRemarkList VALID_REMARKLIST = new JsonAdaptedRemarkList(BENSON.getRemarkList());
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_TELEGRAM, invalidTags, VALID_LESSONS, VALID_REMARKLIST);
    ...
    public void toModelType_invalidLessons_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_TELEGRAM, VALID_TAGS, invalidLessons, VALID_REMARKLIST);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
