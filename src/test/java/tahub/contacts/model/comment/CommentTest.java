...
public class CommentTest {
    @Test
    void testCommenter() {
        Person commenter = new Person(new Name("Alice"), new Phone("1234567890"),
                new Email("alice@example.com"), new Address("123 Street"), new HashSet<>());
        Person receiver = new Person(new Name("Bob"), new Phone("9876543210"),
    ...
    void testEquals() {
        ...
        Person commenter2 = new Person(new Name("Alice"), new Phone("1234567890"),
                new Email("alice@example.com"), new Address("123 Street"), new HashSet<>());
        Person receiver2 = new Person(new Name("Bob"), new Phone("9876543210"),
                new Email("bob@example.com"), new Address("321 Avenue"), new HashSet<>());
    ...
    void testNotEquals() {
        ...
        Person receiver = new Person(new Name("Bob"), new Phone("9876543210"),
                new Email("bob@example.com"), new Address("321 Avenue"), new HashSet<>());
        Comment comment1 = new Comment(commenter, receiver, "Great job!");
        Person commenter2 = new Person(new Name("Charlie"), new Phone("1112223334"),
                new Email("charlie@example.com"), new Address("456 Lane"), new HashSet<>());
        Person receiver2 = new Person(new Name("Dave"), new Phone("4445556667"),
