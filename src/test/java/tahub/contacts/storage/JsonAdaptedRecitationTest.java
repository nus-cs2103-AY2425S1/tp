...
public class JsonAdaptedRecitationTest {
    ...
    private final Recitation validRecitation = new Recitation("R01", new Course("CS2030S", "Advanced Computer Science"));

    @Test
    public void toModelType_validRecitationDetails_returnsRecitation() throws Exception {
        JsonAdaptedRecitation recitation = new JsonAdaptedRecitation(validRecitation.getRecitationId(), validRecitation.getCourse());
