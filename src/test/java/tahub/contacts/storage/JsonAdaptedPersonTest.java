...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidMatriculationNumber_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_MATRICULATION_NUMBER, VALID_NAME, VALID_PHONE,
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_MATRICULATION_NUMBER, INVALID_NAME, VALID_PHONE,
                        VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_MATRICULATION_NUMBER, null,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_MATRICULATION_NUMBER, VALID_NAME, INVALID_PHONE,
                        VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_MATRICULATION_NUMBER, VALID_NAME, null,
                VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_MATRICULATION_NUMBER, VALID_NAME, VALID_PHONE,
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_MATRICULATION_NUMBER, VALID_NAME,
