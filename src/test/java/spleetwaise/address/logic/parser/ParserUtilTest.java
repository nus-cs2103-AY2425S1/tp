...
public class ParserUtilTest {
    ...
    private static final String VALID_REMARK = "Sean is a loanable";
    ...
    public void parseRemark_validValueWithWhitespace_returnsTrimmedRemark() throws Exception {
        ...
        Remark expectedName = new Remark(VALID_REMARK);
        assertEquals(expectedName, ParserUtil.parseRemark(remarkWithWhitespace));
    }
