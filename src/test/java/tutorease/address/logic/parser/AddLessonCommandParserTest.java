...
public class AddLessonCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() throws ParseException {
        ...
        AddLessonCommand expectedCommand = new AddLessonCommand(studentId, expectedLesson.getStartDateTime(),
                expectedLesson.getEndDateTime());
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + STUDENT_ID_DESC
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedLessonString = STUDENT_ID_DESC + START_DATE_TIME_DESC + DURATION_DESC;
        // multiple studentId
    ...
    public void parse_invalidValue_failure() {
        // invalid studentId
        assertParseFailure(parser, INVALID_STUDENT_ID_CHAR + START_DATE_TIME_DESC
                        + DURATION_DESC,
                StudentId.MESSAGE_CONSTRAINTS);

        // invalid startDateTime
        assertParseFailure(parser, STUDENT_ID_DESC + INVALID_START_DATE_DAY
                        + DURATION_DESC,
                StartDateTime.START_DATE_MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, STUDENT_ID_DESC + INVALID_START_DATE_MONTH
                        + DURATION_DESC,
                StartDateTime.START_DATE_MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, STUDENT_ID_DESC + INVALID_START_DATE_YEAR
                        + DURATION_DESC,
                StartDateTime.START_DATE_MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, STUDENT_ID_DESC + INVALID_START_DATE_HOUR
                        + DURATION_DESC,
                StartDateTime.START_DATE_MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, STUDENT_ID_DESC + INVALID_START_DATE_MINUTE
                        + DURATION_DESC,
                StartDateTime.START_DATE_MESSAGE_CONSTRAINTS);

        // invalid duration
        assertParseFailure(parser, STUDENT_ID_DESC + START_DATE_TIME_DESC
