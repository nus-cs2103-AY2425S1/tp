...
public class StorageManagerTest {
    ...
    public void addressBookReadSave() throws Exception {
         ...
         * More extensive testing of UserPref saving/reading is done in {@link JsonResearchRosterStorageTest} class.
         */
        ResearchRoster original = getTypicalAddressBook();
        storageManager.saveAddressBook(original);
        ReadOnlyResearchRoster retrieved = storageManager.readAddressBook().get();
        assertEquals(original, new ResearchRoster(retrieved));
    }
