...
public class CommandTestUtil {
    ...
    public static final String VALID_WORKEXP_AMY = "Intern,Google,2023";
    public static final String VALID_WORKEXP_BOB = "Engineer,Microsoft,2022";
    ...
    public static final String WORKEXP_DESC_AMY = " " + PREFIX_WORKEXP + VALID_WORKEXP_AMY;
