...
public class CommandTestUtil {
    ...
    public static final String TUTORIALCLASS_DESC_AMY = " " + PREFIX_TUTORIALCLASS + VALID_STUDENTID_AMY;
    ...
    public static final String INVALID_STUDENTID_DESC = " " + PREFIX_STUDENTID; // empty string not allowed for addresses
    public static final String INVALID_TUTORIALCLASS_DESC = " " + PREFIX_TUTORIALCLASS; // empty string not allowed for addresses
