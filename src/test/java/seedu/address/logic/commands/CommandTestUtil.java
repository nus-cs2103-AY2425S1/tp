...
public class CommandTestUtil {
    ...
    public static final String VALID_IDENTITY_NUMBER_AMY = "S0490308J";
    public static final String VALID_IDENTITY_NUMBER_BOB = "T0892856D";
    public static final String VALID_PHONE_AMY = "88767788";
    public static final String VALID_PHONE_BOB = "93330333";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_STATUS_AMY = "HIGH";
    public static final String VALID_STATUS_BOB = "LOW";
    ...
    public static final String IDENTITY_NUMBER_DESC_BOB = " " + PREFIX_IDENTITY_NUMBER + VALID_IDENTITY_NUMBER_BOB;
    ...
    public static final String INVALID_STATUS_DESC = " " + PREFIX_STATUS + "low*";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withIdentityNumber(VALID_IDENTITY_NUMBER_AMY).withPhone(VALID_PHONE_AMY)
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredPersonList(new NameOrIdentityNumberContainsKeywordsPredicate(Arrays.asList(splitName[0])));
