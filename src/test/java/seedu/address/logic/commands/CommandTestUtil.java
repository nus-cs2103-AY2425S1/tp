...
public class CommandTestUtil {
    ...
    public static final String INVALID_COURSE_DESC = " " + PREFIX_COURSE + "CS2103T*"; // '*' not allowed in courses
    ...
    public static void assertCommandSuccess(Command command, Model actualModel, String expectedMessage,
            Model expectedModel) {
        CommandResult expectedCommandResult = new CommandResult(expectedMessage, CommandType.EXIT);
