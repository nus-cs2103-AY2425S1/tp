...
public class CommandTestUtil {
    ...
    public static final String ADDRESS_DESC_ALAN = " " + PREFIX_ASKING_PRICE + VALID_ASKING_PRICE_ALAN;
    public static final String ADDRESS_DESC_BRENDA = " " + PREFIX_ASKING_PRICE + VALID_ASKING_PRICE_BRENDA;
