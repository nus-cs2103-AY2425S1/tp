...
public class CommandTestUtil {
    ...
    public static final String VALID_AGE_AMY = "32";
    ...
    public static final String VALID_APPOINTMENT_AMY = "01 January 2024 12:00";
    public static final String VALID_APPOINTMENT_BOB = "02 February 2024 13:30";
    ...
    public static final String INVALID_AGE_DESC = " " + PREFIX_AGE + "1234"; // age cannot be more than 3 digits
    public static final String INVALID_GENDER_DESC = " " + PREFIX_GENDER + "E"; // 'E' not allowed in genders
    public static final String INVALID_NRIC_DESC = " " + PREFIX_NRIC + "S12Z"; // should have 7 numbers
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for addresses
    public static final String INVALID_APPOINTMENT_DESC = " " + PREFIX_APPOINTMENT + "40/2023 23:10"; // no day
