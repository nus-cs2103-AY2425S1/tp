...
public class CommandTestUtil {
    ...
    public static final String VALID_NOTES_AMY = "Prefers calling.";
    public static final String VALID_INCOME_AMY = "low";
    public static final String VALID_INCOME_BOB = "low";
