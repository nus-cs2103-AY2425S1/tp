...
public class CommandTestUtil {
    ...
    public static final String VALID_STUDENTID_BOB = "A1234567B";
    public static final String VALID_CATEGORY_AMY = "student";
    public static final String VALID_CATEGORY_BOB = "company";
