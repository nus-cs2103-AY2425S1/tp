...
public class CommandTestUtil {
    ...
    public static final DeletePropertyToBuyCommand.EditPersonPropertyDescriptor DESC_CLIF;
    public static final DeletePropertyToBuyCommand.EditPersonPropertyDescriptor DESC_DAN;
