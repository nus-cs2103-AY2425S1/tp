...
public class CommandTestUtil {
    ...
    public static final double VALID_BUDGET_AMY = 2000.00;
    public static final double VALID_BUDGET_BOB = 4500.00;
    ...
    public static final String RSVP_DESC_AMY = " " + PREFIX_RSVP + VALID_RSVP_ACCEPTED;
    ...
    public static final EditGuestDescriptor DESC_AMY;
    public static final EditGuestDescriptor DESC_BOB;
    public static final EditVendorDescriptor DESC_VENDOR_AMY;
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        List<Person> expectedFilteredList = new ArrayList<>(actualModel.getFilteredGuestList());
