...
public class CommandTestUtil {
    ...
    public static final Integer VALID_RATING_AMY = 5;
    public static final Integer VALID_RATING_BOB = 9;
    ...
    public static final String INVALID_PRICE_DESC = " " + PREFIX_PRICE + "$$$$$"; // $$$$$ is not an allowed price
