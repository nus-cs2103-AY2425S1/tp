...
public class CommandTestUtil {
    ...
    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + "     "; // whitespace-only names are invalid
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withDateOfLastVisit(VALID_DATEOFLASTVISIT_AMY).build();
