...
public class CommandTestUtil {
     ...
     * {@code model}'s address book.
     */
    public static void showPersonByNric(Model model, Nric nric) {
        ...
        // Use the found person's NRIC to update the filtered list
        model.updateFilteredPersonList(new NricMatchesPredicate(nric.toString()));
