...
public class CommandTestUtil {
    ...
    public static final String VALID_PHONE_BOB = "98265432";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1, #12-34 S123456";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3, #12-34 S654321";
    ...
    public static final String INVALID_POSTAL_CODE_DESC = " " + PREFIX_POSTAL_CODE + "123"; // wrong length
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withPostalCode(VALID_POSTAL_CODE_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withPostalCode(VALID_POSTAL_CODE_BOB).build();
    }
