...
public class CommandTestUtil {
    ...
    public static final String VALID_ADDRESS_ERZA = "Block 123, Fiore Street 4";
    public static final String VALID_ADDRESS_JEREMY = "Block 417, Jeremy Street 5";
    ...
    public static final String INVALID_MODULE_ROLE_DESC_MODULE_CODE =
