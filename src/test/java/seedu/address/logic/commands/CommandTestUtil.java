...
public class CommandTestUtil {
    ...
    public static final String INVALID_CONTACTTYPE_DESC = " " + PREFIX_CONTACTTYPE + "misc."; // must be work or
                                                                                              // personal
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTelegramHandle(VALID_TELEHANDLE_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
                .withTelegramHandle(VALID_TELEHANDLE_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    }
