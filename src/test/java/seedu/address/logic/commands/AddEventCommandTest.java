...
public class AddEventCommandTest {
    ...
    public void execute_nullInput_throwsException() {
        assertThrows(NullPointerException.class, () -> addEventCommand.execute((EventManager) null));
    }

    @Test
    public void execute_duplicateEvent_throwsCommandException() {
        assertThrows(CommandException.class, () -> addEventCommand.execute(new EventManagerStubWithEvent()));
    }
    ...
    public void execute_newEvent_success() throws CommandException {
        ...
        assertEquals(new CommandResult(String.format("New event added: %1$s", "Festival")),
                addEventCommand.execute(eventManagerStubWithoutEvent));
