...
public class UpdateMaxStockLevelCommand extends Command {
    ...
    public static final String MESSAGE_EDIT_PRODUCT_SUCCESS = "Edited Product: %1$s with Max Stock Level: %2$s";
    ...
    /**
     * Constructs an {@code UpdateMaxStockLevelCommand} to update the max stock level of the specified product.
     *
     * @param productName   Name of the product to update.
     * @param maxStockLevel New maximum stock level.
     */
    public UpdateMaxStockLevelCommand(ProductName productName, int maxStockLevel) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof UpdateMaxStockLevelCommand)) { // instanceof handles nulls
            return false;
        }

        UpdateMaxStockLevelCommand otherCommand = (UpdateMaxStockLevelCommand) other;
