...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonAddressBookStorage addressBookStorage =
                new JsonAddressBookStorage(temporaryFolder.resolve("MediBase3.json"));
    ...
    @Test
    public void getFilteredOwnedAppointmentList_modifyList_throwsUnsupportedOperationException() {
