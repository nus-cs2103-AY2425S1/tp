...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        JsonReminderAddressBookStorage reminderAddressBookStorage = new JsonReminderAddressBookStorage(temporaryFolder
                                                                    .resolve("reminderAddressBook.json"));
        StorageManager storage = new StorageManager(addressBookStorage, userPrefsStorage, reminderAddressBookStorage);
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        Model expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs(), new ReminderAddressBook());
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonReminderAddressBookStorage reminderAddressBookStorage =
                new JsonReminderAddressBookStorage(temporaryFolder.resolve("ExceptionUserPrefs.json"));
        StorageManager storage = new StorageManager(addressBookStorage, userPrefsStorage, reminderAddressBookStorage);
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                ...
                + LAST_SEEN_DESC_AMY + PRIORITY_DESC_LOW + REMARK_DESC_PRETTY;
