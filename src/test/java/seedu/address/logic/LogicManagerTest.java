...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonEduContactsStorage eduContactsStorage =
                new JsonEduContactsStorage(temporaryFolder.resolve("eduContacts.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(eduContactsStorage, userPrefsStorage);
    ...
    public void getPersonToDisplay_validPerson_success() {
        ...
        model.addPerson(AMY);
        model = new ModelManager(model.getEduContacts(), model.getUserPrefs(), AMY);
        setUp();
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an EduContactsStorage that throws the IOException e when saving
        JsonEduContactsStorage eduContactsStorage = new JsonEduContactsStorage(prefPath) {
            @Override
            public void saveEduContacts(ReadOnlyEduContacts eduContacts, Path filePath)
                    throws IOException {
                throw e;
            }
        };
