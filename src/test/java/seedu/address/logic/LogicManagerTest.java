...
import static seedu.address.logic.Messages.MESSAGE_INVALID_GUEST_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteGuestCommand = "delete_guest 9";
        assertCommandException(deleteGuestCommand, MESSAGE_INVALID_GUEST_DISPLAYED_INDEX);
    }

    @Test
    public void execute_validCommand_success() throws Exception {
        String listCommand = ListCommand.COMMAND_WORD;
        String guestMessage = "Number of guests: 0 (0 pending, 0 coming, 0 not coming)\n";
        String vendorMessage = "Number of vendors: 0";

        assertCommandSuccess(listCommand, ListCommand.MESSAGE_LIST_SUCCESS + guestMessage
                + vendorMessage, model);
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addGuestCommand = AddGuestCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + RSVP_DESC_AMY + RELATION_DESC_AMY;
        Guest expectedGuest = new GuestBuilder(AMY).withTags().build();
        ModelManager expectedModel = new ModelManager();
        expectedModel.addPerson(expectedGuest);
        assertCommandFailure(addGuestCommand, CommandException.class, expectedMessage, expectedModel);
    }
}
