...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + BUDGET_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditBuyerDescriptorBuilder().withBudget(VALID_BUDGET_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + BUDGET_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + BUDGET_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + PHONE_DESC_BOB + BUDGET_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;
