...
import static seedu.address.logic.commands.CommandTestUtil.VALID_PERSON_TYPE_AMY;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_PERSON_TYPE_DESC,
                BuyerType.MESSAGE_CONSTRAINTS); // invalid personType
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + PERSON_TYPE_DESC_AMY + TAG_DESC_FRIEND;

        EditPersonDescriptor descriptor = new EditBuyerDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withPersonType(VALID_PERSON_TYPE_AMY).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditPersonDescriptor descriptor = new EditBuyerDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        EditPersonDescriptor descriptor = new EditBuyerDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        // personType
        userInput = targetIndex.getOneBased() + PERSON_TYPE_DESC_AMY;
        descriptor = new EditBuyerDescriptorBuilder().withPersonType(VALID_PERSON_TYPE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_resetTags_success() {
        ...
        EditPersonDescriptor descriptor = new EditBuyerDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
