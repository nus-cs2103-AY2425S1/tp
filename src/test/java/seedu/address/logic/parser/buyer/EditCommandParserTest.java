...
<<<<<<< HEAD:src/test/java/seedu/address/logic/parser/EditPersonCommandParserTest.java
...
import static seedu.address.logic.commands.CommandTestUtil.VALID_BUYER_TYPE_AMY;
...
>>>>>>> 3d58915b92d82f9ea38dc63271c5afd6a23ae415:src/test/java/seedu/address/logic/parser/buyer/EditCommandParserTest.java
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_BUYER_TYPE_DESC,
                BuyerType.MESSAGE_CONSTRAINTS); // invalid buyerType
    ...
    public void parse_allFieldsSpecified_success() {
        Index targetIndex = INDEX_SECOND_BUYER;
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + BUYER_TYPE_DESC_AMY + TAG_DESC_FRIEND;

        EditBuyerDescriptor descriptor = new EditBuyerDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withBuyerType(VALID_BUYER_TYPE_AMY).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    ...
    public void parse_someFieldsSpecified_success() {
        Index targetIndex = INDEX_FIRST_BUYER;
    ...
    public void parse_oneFieldSpecified_success() {
        // name
        Index targetIndex = INDEX_THIRD_BUYER;
        ...
        // buyerType
        userInput = targetIndex.getOneBased() + BUYER_TYPE_DESC_AMY;
        descriptor = new EditBuyerDescriptorBuilder().withBuyerType(VALID_BUYER_TYPE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                ...
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + BUYER_TYPE_DESC_AMY + BUYER_TYPE_DESC_BOB
                + TAG_DESC_HUSBAND;
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
                + INVALID_BUYER_TYPE_DESC + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
                + INVALID_BUYER_TYPE_DESC;
