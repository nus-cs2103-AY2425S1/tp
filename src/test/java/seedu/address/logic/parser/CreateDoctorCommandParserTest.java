...
public class CreateDoctorCommandParserTest {
    ...
    public void parse_invalidName_throwsParseException() {
        ...
        assertParseFailure(parser, userInput, String.format(Name.MESSAGE_CONSTRAINTS, CreateDoctorCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_invalidPhone_throwsParseException() {
        String userInput = " " + PREFIX_NAME + VALID_NAME_AMY + INVALID_PHONE_DESC + " " + PREFIX_EMAIL + VALID_EMAIL_AMY
                + " " + PREFIX_ADDRESS + VALID_ADDRESS_AMY;
        assertParseFailure(parser, userInput, String.format(Phone.MESSAGE_CONSTRAINTS, CreateDoctorCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_invalidEmail_throwsParseException() {
        String userInput = " " + PREFIX_NAME + VALID_NAME_AMY + " " + PREFIX_PHONE + VALID_PHONE_AMY + INVALID_EMAIL_DESC
                + " " + PREFIX_ADDRESS + VALID_ADDRESS_AMY;
        assertParseFailure(parser, userInput, String.format(Email.MESSAGE_CONSTRAINTS, CreateDoctorCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_invalidAddress_throwsParseException() {
        ...
        assertParseFailure(parser, userInput, String.format(Address.MESSAGE_CONSTRAINTS, CreateDoctorCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_missingPhone_throwsParseException() {
        String userInput = " " + PREFIX_NAME + VALID_NAME_AMY + " " + PREFIX_EMAIL + VALID_EMAIL_AMY
                + " " + PREFIX_ADDRESS + VALID_ADDRESS_AMY;
        assertParseFailure(parser, userInput, String.format(MESSAGE_INVALID_COMMAND_FORMAT, CreateDoctorCommand.MESSAGE_USAGE));
    }
