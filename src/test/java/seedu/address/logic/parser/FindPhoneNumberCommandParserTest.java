...
public class FindPhoneNumberCommandParserTest {
    ...
    @Test
    public void parse_characterArgs_throwsParseException() {
        assertParseFailure(parser, "not a number",
                String.format(MESSAGE_INVALID_PHONE_NUMBER_KEYWORDS, FindPhoneNumberCommand.MESSAGE_USAGE));
    }
