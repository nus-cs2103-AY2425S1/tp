...
public class ModuleCommandParserTest {
    ...
    public void parse_repeatedNonRoleValue_failure() {
        ...
        assertParseFailure(parser,
                validExpectedModuleString + MODULE_DESC_AMY,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_MODULE));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing studentId
        assertParseFailure(parser, MODULE_DESC_BOB, expectedMessage);
    ...
    public void parse_extraneousInput_throwsParseException() {
        String input = ModuleCommand.COMMAND_WORD + STUDENTID_DESC_BOB + MODULE_DESC_BOB;
        assertParseFailure(parser, input, String.format(MESSAGE_INVALID_COMMAND_FORMAT, ModuleCommand.MESSAGE_USAGE));
    }
}
