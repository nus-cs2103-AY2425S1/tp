...
public class EditConcertCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // negative index
        assertParseFailure(parser, "-5" + NAME_DESC_COACHELLA, MESSAGE_INVALID_CONCERT_DISPLAYED_INDEX);

        // zero index
        assertParseFailure(parser, "0" + NAME_DESC_COACHELLA, MESSAGE_INVALID_CONCERT_DISPLAYED_INDEX);

        // invalid arguments being parsed as preamble
        assertParseFailure(parser, "1 some random string", MESSAGE_INVALID_CONCERT_DISPLAYED_INDEX);

        // invalid prefix being parsed as preamble
        assertParseFailure(parser, "1 i/ string", MESSAGE_INVALID_CONCERT_DISPLAYED_INDEX);
    }
