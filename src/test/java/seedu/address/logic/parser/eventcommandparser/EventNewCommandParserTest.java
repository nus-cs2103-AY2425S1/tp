...
public class EventNewCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + EVENT_NAME_DESC_BEACH_CLEANUP + EVENT_LOCATION_DESC_BEACH_CLEANUP
                + EVENT_DATE_DESC_BEACH_CLEANUP, new EventNewCommand(expectedEvent));
    }

    @Test
    public void parse_duplicateFields_failure() {
        String validCommand = EVENT_NAME_DESC_BEACH_CLEANUP + EVENT_LOCATION_DESC_BEACH_CLEANUP + EVENT_DATE_DESC_BEACH_CLEANUP;
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_EVENT_NAME_BEACH_CLEANUP + EVENT_LOCATION_DESC_BEACH_CLEANUP
                + EVENT_DATE_DESC_BEACH_CLEANUP, expectedMessage);
        ...
        // missing date prefix
        assertParseFailure(parser, EVENT_NAME_DESC_BEACH_CLEANUP + EVENT_LOCATION_DESC_BEACH_CLEANUP
                + VALID_EVENT_DATE_BEACH_CLEANUP, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_EVENT_NAME_DESC + EVENT_LOCATION_DESC_BEACH_CLEANUP
                + EVENT_DATE_DESC_BEACH_CLEANUP, EventName.MESSAGE_CONSTRAINTS);

        // invalid location
        assertParseFailure(parser, EVENT_NAME_DESC_BEACH_CLEANUP + INVALID_EVENT_LOCATION_DESC
                + EVENT_DATE_DESC_BEACH_CLEANUP, Location.MESSAGE_CONSTRAINTS);

        // invalid date
        assertParseFailure(parser, EVENT_NAME_DESC_BEACH_CLEANUP + EVENT_LOCATION_DESC_BEACH_CLEANUP
                + INVALID_EVENT_DATE_DESC, Date.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + EVENT_NAME_DESC_BEACH_CLEANUP + EVENT_LOCATION_DESC_BEACH_CLEANUP
                + EVENT_DATE_DESC_BEACH_CLEANUP, String.format(MESSAGE_INVALID_COMMAND_FORMAT, EventNewCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_multipleDates_success() {
        ...
        assertParseSuccess(parser, EVENT_NAME_DESC_BEACH_CLEANUP + EVENT_LOCATION_DESC_BEACH_CLEANUP
                + multipleDatesDesc, new EventNewCommand(expectedEventTwoDates));
    }
