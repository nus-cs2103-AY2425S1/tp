...
import static seedu.address.logic.commands.CommandTestUtil.PHONE_DESC_EMPTY;
...
public class EditClientCommandParserTest {
    ...
    @Test
    public void parse_emptyPhone_success() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = targetIndex.getOneBased() + PHONE_DESC_EMPTY + EMAIL_DESC_AMY;
    ...
    public void parse_emptyEmail_success() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + EMAIL_DESC_EMPTY;
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
