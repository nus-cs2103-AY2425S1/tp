...
public class AddVendorCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + VALID_COMPANY_BOB + TAG_DESC_FRIEND, new AddVendorCommand(expectedVendor));
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + VALID_COMPANY_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedVendorString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + VALID_COMPANY_BOB + TAG_DESC_FRIEND;
        ...
        // multiple rsvp
        assertParseFailure(parser, VALID_COMPANY_AMY + validExpectedVendorString,
        ...
        assertParseFailure(parser,
                validExpectedVendorString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY
                        + VALID_COMPANY_AMY + validExpectedVendorString,
