...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonRoleValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + TELEGRAM_HANDLE_DESC_BOB + EMAIL_DESC_BOB
        ...
        assertParseFailure(parser,
                validExpectedPersonString + TELEGRAM_HANDLE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY
