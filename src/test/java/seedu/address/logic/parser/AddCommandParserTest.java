...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + ORGANISATION_DESC_BOB + LAST_SEEN_DESC_BOB + TAG_DESC_FRIEND
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + ORGANISATION_DESC_BOB + LAST_SEEN_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                + PRIORITY_DESC_LOW + REMARK_DESC_HANDSOME, Address.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + PRIORITY_DESC_LOW + REMARK_DESC_HANDSOME,
