...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GENDER_DESC_BOB + AGE_DESC_BOB + TAG_DESC_FRIEND
                + DETAIL_DESC_BOB, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GENDER_DESC_BOB
                        + AGE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + DETAIL_DESC_BOB,
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GENDER_DESC_BOB + AGE_DESC_BOB + TAG_DESC_FRIEND + DETAIL_DESC_BOB;
    ...
    //                + GENDER_DESC_BOB + AGE_DESC_BOB
    //                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + DETAIL_DESC_BOB, Name.MESSAGE_CONSTRAINTS);
    //
    //        // invalid phone
    //        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
    //                + GENDER_DESC_BOB + AGE_DESC_BOB
    //                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + DETAIL_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);
    //
    //        // invalid email
    ...
    //                + GENDER_DESC_BOB + AGE_DESC_BOB
    //                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + DETAIL_DESC_BOB, Address.MESSAGE_CONSTRAINTS);
    //
    //        // invalid tag
    //        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
    //                + GENDER_DESC_BOB + AGE_DESC_BOB
    //                + INVALID_TAG_DESC + VALID_TAG_FRIEND + DETAIL_DESC_BOB, Tag.MESSAGE_CONSTRAINTS);
    //
