...
public class AddCommandParserTest {
        ...
        public void parse_allFieldsPresent_success() {
                Company expectedCompany = new CompanyBuilder(MICROSOFT).withTags(VALID_TAG_COMPANY).build();

                // whitespace only preamble
                assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_MICROSOFT + PHONE_DESC_MICROSOFT + EMAIL_DESC_MICROSOFT
                                + ADDRESS_DESC_MICROSOFT + TAG_DESC_COMPANY, new AddCommand(expectedCompany));

                // multiple tags - all accepted
                Company expectedCompanyMultipleTags = new CompanyBuilder(MICROSOFT).withTags(VALID_TAG_COMPANY, VALID_TAG_BIGTECH)
                                .build();
                assertParseSuccess(parser,
                                NAME_DESC_MICROSOFT + PHONE_DESC_MICROSOFT + EMAIL_DESC_MICROSOFT + ADDRESS_DESC_MICROSOFT + TAG_DESC_BIGTECH
                                                + TAG_DESC_COMPANY,
        ...
        public void parse_repeatedNonTagValue_failure() {
                String validExpectedPersonString = NAME_DESC_MICROSOFT + PHONE_DESC_MICROSOFT + EMAIL_DESC_MICROSOFT
                                + ADDRESS_DESC_MICROSOFT + TAG_DESC_COMPANY;
                ...
                assertParseFailure(parser,
                                validExpectedPersonString + PHONE_DESC_TESLA + EMAIL_DESC_TESLA + NAME_DESC_TESLA
                                                + ADDRESS_DESC_TESLA
