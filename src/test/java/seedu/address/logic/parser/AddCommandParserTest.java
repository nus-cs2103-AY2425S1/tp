...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + SKILLS_DESC_BOB
                        + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + NOTE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + NOTE_DESC_BOB
                + TAG_DESC_FRIEND;
        ...
        assertParseFailure(parser,
                validExpectedPersonString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY
                        + ADDRESS_DESC_AMY + SKILLS_DESC_AMY + EXPERIENCE_DESC_AMY + STATUS_DESC_AMY + NOTE_DESC_AMY
                        + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_ADDRESS, PREFIX_EMAIL,
                        PREFIX_PHONE, PREFIX_SKILLS, PREFIX_EXPERIENCE, PREFIX_STATUS, PREFIX_NOTE));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + SKILLS_DESC_AMY + EXPERIENCE_DESC_AMY + STATUS_DESC_AMY + NOTE_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + SKILLS_DESC_BOB + VALID_EXPERIENCE_BOB + STATUS_DESC_BOB + NOTE_DESC_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB
                        + VALID_SKILLS_BOB + VALID_EXPERIENCE_BOB + VALID_STATUS_BOB + VALID_NOTE_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid experience
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SKILLS_DESC_BOB + INVALID_EXPERIENCE_DESC + STATUS_DESC_BOB + NOTE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Experience.MESSAGE_CONSTRAINTS);

        // invalid skills
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_SKILLS_DESC + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + NOTE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Skills.MESSAGE_CONSTRAINTS);

        // invalid status
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + INVALID_STATUS_DESC + NOTE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Status.MESSAGE_CONSTRAINTS);

        // invalid note
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + INVALID_NOTE_DESC
