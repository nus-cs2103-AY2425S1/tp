...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
            + ADDRESS_DESC_BOB + DESIREDROLE_DESC_BOB + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + DESIREDROLE_DESC_AMY + SKILLS_DESC_AMY + EXPERIENCE_DESC_AMY + STATUS_DESC_AMY
                + NOTE_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + DESIREDROLE_DESC_BOB + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + NOTE_DESC_BOB,
            expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + VALID_DESIREDROLE_BOB + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + NOTE_DESC_BOB,
            expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + INVALID_DESIREDROLE_DESC + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + NOTE_DESC_BOB
            + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, DesiredRole.MESSAGE_CONSTRAINTS);

        // invalid skills
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + DESIREDROLE_DESC_BOB + INVALID_SKILLS_DESC + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + NOTE_DESC_BOB
            + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Skills.MESSAGE_CONSTRAINTS);

        // invalid experience
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + DESIREDROLE_DESC_BOB + SKILLS_DESC_BOB + INVALID_EXPERIENCE_DESC + STATUS_DESC_BOB + NOTE_DESC_BOB
            + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Experience.MESSAGE_CONSTRAINTS);

        // invalid status
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + DESIREDROLE_DESC_BOB + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + INVALID_STATUS_DESC + NOTE_DESC_BOB
            + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Status.MESSAGE_CONSTRAINTS);

        // invalid note
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
            + DESIREDROLE_DESC_BOB + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB + INVALID_NOTE_DESC
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DESIREDROLE_DESC_BOB + SKILLS_DESC_BOB + EXPERIENCE_DESC_BOB + STATUS_DESC_BOB
