...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB, new AddClientProfile(expectedPersonMultipleTags));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + VALID_ADDRESS_BOB, expectedMessage);
        //  + EMAIL_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + VALID_TAG_FRIEND, Tag.MESSAGE_CONSTRAINTS);
