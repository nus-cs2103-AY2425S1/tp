...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + JOB_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SKILL_DESC_PYTHON + SKILL_DESC_JAVA + INTERVIEW_SCORE_DESC_BOB
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + JOB_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                ...
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_JOB, PREFIX_ADDRESS, PREFIX_EMAIL,
                        PREFIX_PHONE));
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + JOB_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + JOB_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SKILL_DESC_PYTHON + SKILL_DESC_JAVA + INTERVIEW_SCORE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid job
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_JOB_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SKILL_DESC_PYTHON + SKILL_DESC_JAVA + INTERVIEW_SCORE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Job.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + JOB_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SKILL_DESC_PYTHON + SKILL_DESC_JAVA + INTERVIEW_SCORE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + JOB_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + SKILL_DESC_PYTHON + SKILL_DESC_JAVA + INTERVIEW_SCORE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + JOB_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_ADDRESS_DESC + SKILL_DESC_PYTHON + SKILL_DESC_JAVA + INTERVIEW_SCORE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid skills
        assertParseFailure(parser, NAME_DESC_BOB + JOB_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INVALID_SKILL_DESC + INTERVIEW_SCORE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Skill.MESSAGE_CONSTRAINTS);

        // invalid interview score
        assertParseFailure(parser, NAME_DESC_BOB + JOB_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SKILL_DESC_PYTHON + SKILL_DESC_JAVA + INVALID_INTERVIEW_SCORE_DESC
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, InterviewScore.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + JOB_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SKILL_DESC_PYTHON + SKILL_DESC_JAVA + INTERVIEW_SCORE_DESC_BOB
