...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + MEETUP_NAME_DESC_PITCH
                ...
                + MEETUP_TO_DESC_PITCH, new AddCommand(expectedMeetUp));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_MEETUP_NAME_PITCH + MEETUP_INFO_DESC_PITCH
                + MEETUP_FROM_DESC_PITCH + MEETUP_TO_DESC_PITCH, expectedMessage);
        ...
        assertParseFailure(parser, MEETUP_NAME_DESC_PITCH + MEETUP_INFO_DESC_PITCH
                + VALID_MEETUP_FROM_PITCH + MEETUP_TO_DESC_PITCH, expectedMessage);

        // missing to prefix
        assertParseFailure(parser, MEETUP_NAME_DESC_PITCH + MEETUP_INFO_DESC_PITCH
                + MEETUP_FROM_DESC_PITCH + VALID_MEETUP_TO_PITCH, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_MEETUP_NAME_PITCH + VALID_MEETUP_INFO_PITCH
                + VALID_MEETUP_FROM_PITCH + VALID_MEETUP_TO_PITCH, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid to
        assertParseFailure(parser, MEETUP_NAME_DESC_PITCH + MEETUP_INFO_DESC_PITCH
                + MEETUP_FROM_DESC_PITCH + INVALID_MEETUP_TO_DESC, To.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_MEETUP_NAME_DESC + MEETUP_INFO_DESC_PITCH
                + MEETUP_FROM_DESC_PITCH + INVALID_MEETUP_TO_DESC, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + MEETUP_NAME_DESC_PITCH
                + MEETUP_INFO_DESC_PITCH + MEETUP_FROM_DESC_PITCH
                + MEETUP_TO_DESC_PITCH, String.format(MESSAGE_INVALID_COMMAND_FORMAT, MESSAGE_USAGE));
    }
}
