...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + MEETUP_SUBJECT_DESC_PITCH
    ...
    public void parse_repeatedNonBuyerAddedValue_failure() {
        String validExpectedMeetUpString = MEETUP_SUBJECT_DESC_PITCH + MEETUP_INFO_DESC_PITCH
                + MEETUP_FROM_DESC_PITCH + MEETUP_TO_DESC_PITCH + MEETUP_ADDED_BUYER_DESC_PITCH;

        // multiple subjects
        assertParseFailure(parser, MEETUP_SUBJECT_DESC_NETWORKING + validExpectedMeetUpString,
        ...
        assertParseFailure(parser,
                validExpectedMeetUpString + MEETUP_SUBJECT_DESC_PITCH + MEETUP_INFO_DESC_PITCH
                        + MEETUP_FROM_DESC_PITCH + MEETUP_TO_DESC_PITCH + validExpectedMeetUpString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_SUBJECT, PREFIX_INFO, PREFIX_FROM, PREFIX_TO));

        // invalid value followed by valid value

        // invalid subject
        assertParseFailure(parser, INVALID_MEETUP_SUBJECT_DESC + validExpectedMeetUpString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_SUBJECT));
        ...
        // invalid subject
        assertParseFailure(parser, validExpectedMeetUpString + INVALID_MEETUP_SUBJECT_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_SUBJECT));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_MEETUP_SUBJECT_PITCH + MEETUP_INFO_DESC_PITCH
                + MEETUP_FROM_DESC_PITCH + MEETUP_TO_DESC_PITCH + MEETUP_ADDED_BUYER_DESC_PITCH, expectedMessage);

        // missing info prefix
        assertParseFailure(parser, MEETUP_SUBJECT_DESC_PITCH + VALID_MEETUP_INFO_PITCH
                + MEETUP_FROM_DESC_PITCH + MEETUP_TO_DESC_PITCH + MEETUP_ADDED_BUYER_DESC_PITCH, expectedMessage);
        ...
        assertParseFailure(parser, VALID_MEETUP_SUBJECT_PITCH + VALID_MEETUP_INFO_PITCH
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid subject
        assertParseFailure(parser, INVALID_MEETUP_SUBJECT_DESC + MEETUP_INFO_DESC_PITCH
                + MEETUP_FROM_DESC_PITCH + MEETUP_TO_DESC_PITCH
                + MEETUP_ADDED_BUYER_DESC_PITCH, Subject.MESSAGE_CONSTRAINTS);

        // invalid info
        assertParseFailure(parser, MEETUP_SUBJECT_DESC_PITCH + INVALID_MEETUP_INFO_DESC
                + MEETUP_FROM_DESC_PITCH + MEETUP_TO_DESC_PITCH
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + MEETUP_SUBJECT_DESC_PITCH
