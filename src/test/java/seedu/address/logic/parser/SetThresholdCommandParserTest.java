...
public class SetThresholdCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        // basic case
        assertParseSuccess(parser, " pr/Product1 stk/1000",
                new SetThresholdCommand(new ProductName("Product1"), 1000));
        ...
        assertParseSuccess(parser, " pr/AnotherProduct stk/500",
                new SetThresholdCommand(new ProductName("AnotherProduct"), 500));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, " pr/Product1", expectedMessage);
        ...
        assertParseFailure(parser, " pr/Product1 stk/", ProductName.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_zeroAndNegativeValues_failure() {
        // zero stock level
        assertParseFailure(parser, " pr/Product1 stk/0", MESSAGE_INVALID_STOCK_LEVEL);
