 ...
 * the DeletePersonCommand code. For example, inputs "1" and "1 abc" take the same path through the
 * DeletePersonCommand, and therefore we test only one of them. The path variation for those two cases
