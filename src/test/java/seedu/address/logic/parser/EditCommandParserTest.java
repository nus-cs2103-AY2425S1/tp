...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_PRODUCT_DESC, Product.MESSAGE_CONSTRAINTS); // invalid product
        ...
        assertParseFailure(parser, "1" + PRODUCT_DESC_BREAD + PRODUCT_EMPTY + PRODUCT_DESC_RICE,
                Product.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + PRODUCT_EMPTY + PRODUCT_DESC_BREAD + PRODUCT_DESC_RICE,
                Product.MESSAGE_CONSTRAINTS);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + COMPANY_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + PRODUCT_DESC_BREAD + PHONE_DESC_AMY + COMPANY_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + PRODUCT_DESC_BREAD + PHONE_DESC_BOB + COMPANY_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND
                + PRODUCT_DESC_RICE;
