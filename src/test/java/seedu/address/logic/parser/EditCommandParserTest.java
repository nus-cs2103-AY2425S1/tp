...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + ROLE_DESC_FRIEND + ROLE_DESC_HUSBAND + TAG_EMPTY, Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + ROLE_DESC_FRIEND + TAG_EMPTY + ROLE_DESC_HUSBAND, Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_EMPTY + ROLE_DESC_FRIEND + ROLE_DESC_HUSBAND, Tag.MESSAGE_CONSTRAINTS);
