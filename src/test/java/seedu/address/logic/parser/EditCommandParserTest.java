...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                ...
                + DATE_OF_BIRTH_DESC_AMY + INCOME_DESC_AMY + FAMILY_SIZE_DESC_AMY;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withDateOfBirth(VALID_DATE_OF_BIRTH_AMY).withIncome(VALID_INCOME_AMY)
                .withFamilySize(VALID_FAMILY_SIZE_AMY).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // family size
        userInput = targetIndex.getOneBased() + FAMILY_SIZE_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withFamilySize(VALID_FAMILY_SIZE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                ...
                + REMARK_DESC_AMY + REMARK_DESC_BOB
                + DATE_OF_BIRTH_DESC_AMY + DATE_OF_BIRTH_DESC_BOB
                + INCOME_DESC_AMY + INCOME_DESC_BOB
                + FAMILY_SIZE_DESC_AMY + FAMILY_SIZE_DESC_BOB;

        assertParseFailure(parser, userInput,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_REMARK,
