...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_TAG_DESC, EditCommand.MESSAGE_CANNOT_EDIT_TAG); // invalid tag
        ...
        assertParseFailure(parser, "1"
                + TAG_DESC_FRIEND + TAG_DESC_HUSBAND + TAG_EMPTY, EditCommand.MESSAGE_CANNOT_EDIT_TAG);
        assertParseFailure(parser, "1"
                + TAG_DESC_FRIEND + TAG_EMPTY + TAG_DESC_HUSBAND, EditCommand.MESSAGE_CANNOT_EDIT_TAG);
        assertParseFailure(parser, "1"
                + TAG_EMPTY + TAG_DESC_FRIEND + TAG_DESC_HUSBAND, EditCommand.MESSAGE_CANNOT_EDIT_TAG);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseFailure(parser, userInput, EditCommand.MESSAGE_CANNOT_EDIT_TAG);
    }
