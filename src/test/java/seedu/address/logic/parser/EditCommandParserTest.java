...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        // todo: invalid phone followed by valid emergency contact
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + SUBJECT_DESC_MATH
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // Subjects
        userInput = targetIndex.getOneBased() + SUBJECT_DESC_ENGLISH;
        descriptor = new EditPersonDescriptorBuilder().withSubjects(VALID_SUBJECT_ENGLISH).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
