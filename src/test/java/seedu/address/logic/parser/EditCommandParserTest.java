...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + TAG_DESC_COMPANY + TAG_DESC_BIGTECH + INVALID_TAG_DESC, Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_DESC_COMPANY + INVALID_TAG_DESC + TAG_DESC_BIGTECH, Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + INVALID_TAG_DESC + TAG_DESC_COMPANY + TAG_DESC_BIGTECH, Tag.MESSAGE_CONSTRAINTS);
