...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, " z/1" + INVALID_TAG_DESC, Tag.MESSAGE_CONSTRAINTS); // invalid tag
        ...
        assertParseFailure(parser, " z/1" + TAG_DESC_FRIEND + TAG_DESC_HUSBAND + TAG_EMPTY, Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, " z/1" + TAG_DESC_FRIEND + TAG_EMPTY + TAG_DESC_HUSBAND, Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, " z/1" + TAG_EMPTY + TAG_DESC_FRIEND + TAG_DESC_HUSBAND, Tag.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = ID_DESC_SECOND + PHONE_DESC_BOB + TAG_DESC_HUSBAND
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // tags
        userInput = ID_DESC_THIRD + TAG_DESC_FRIEND;
    ...
    public void parse_resetTags_success() {
        int targetId = ID_SECOND_PERSON;
        String userInput = ID_DESC_SECOND + TAG_EMPTY;
