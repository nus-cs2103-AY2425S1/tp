...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_DESIREDROLE_DESC, DesiredRole.MESSAGE_CONSTRAINTS);
        // invalid tag
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
            ...
            + STATUS_DESC_AMY + DESIREDROLE_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
            ...
            .withDesiredRole(VALID_DESIREDROLE_AMY).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // desired role
        userInput = targetIndex.getOneBased() + DESIREDROLE_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withDesiredRole(VALID_DESIREDROLE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
            + DESIREDROLE_DESC_AMY + EXPERIENCE_DESC_AMY + TAG_DESC_FRIEND + PHONE_DESC_BOB
            + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + DESIREDROLE_DESC_BOB + EXPERIENCE_DESC_BOB + TAG_DESC_HUSBAND;
