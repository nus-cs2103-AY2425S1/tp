...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid experience
        assertParseFailure(parser, "1" + INVALID_EXPERIENCE_DESC, Experience.MESSAGE_CONSTRAINTS);
        // invalid status
        assertParseFailure(parser, "1" + INVALID_STATUS_DESC, Status.MESSAGE_CONSTRAINTS);
        // invalid desired role
        assertParseFailure(parser, "1" + INVALID_DESIRED_ROLE_DESC, DesiredRole.MESSAGE_CONSTRAINTS);
        // invalid tag
        ...
        // reset tags with valid and invalid combination
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
            + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + SKILLS_DESC_AMY + EXPERIENCE_DESC_AMY
            + STATUS_DESC_AMY + DESIRED_ROLE_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
            .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
            .withSkills(VALID_SKILLS_AMY).withExperience(VALID_EXPERIENCE_AMY).withStatus(VALID_STATUS_AMY)
            .withDesiredRole(VALID_DESIRED_ROLE_AMY).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // desired role
        userInput = targetIndex.getOneBased() + DESIRED_ROLE_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withDesiredRole(VALID_DESIRED_ROLE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
            + DESIRED_ROLE_DESC_AMY + EXPERIENCE_DESC_AMY + TAG_DESC_FRIEND + PHONE_DESC_BOB
            + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + DESIRED_ROLE_DESC_BOB + EXPERIENCE_DESC_BOB + TAG_DESC_HUSBAND;

        assertParseFailure(parser, userInput, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE, PREFIX_EMAIL,
            PREFIX_ADDRESS, PREFIX_DESIREDROLE, PREFIX_EXPERIENCE));
    }
