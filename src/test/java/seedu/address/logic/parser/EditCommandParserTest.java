...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_ECNAME_DESC, EcName.MESSAGE_CONSTRAINTS); // invalid ecName
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY
                ...
                + VALID_ECNAME_AMY, Name.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                ...
                + STUDENT_CLASS_DESC_AMY + ECNAME_DESC_AMY + TAG_DESC_FRIEND;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // register number
        userInput = targetIndex.getOneBased() + REGISTER_NUMBER_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withRegisterNumber(VALID_REGISTER_NUMBER_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        // class
        userInput = targetIndex.getOneBased() + STUDENT_CLASS_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withStudentClass(VALID_STUDENT_CLASS_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // ecName
        userInput = targetIndex.getOneBased() + ECNAME_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withEcName(VALID_ECNAME_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
                ...
                + INVALID_SEX_DESC + INVALID_ECNAME_DESC;
