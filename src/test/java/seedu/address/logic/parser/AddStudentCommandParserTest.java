...
public class AddStudentCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_MICHAEL + PHONE_DESC_MICHAEL + EMAIL_DESC_MICHAEL
                + VALID_ADDRESS_MICHAEL + SUBJECT_DESC_MICHAEL + CLASSES_DESC_MICHAEL, expectedMessage);

        // missing subject prefix
        assertParseFailure(parser, NAME_DESC_MICHAEL + PHONE_DESC_MICHAEL + EMAIL_DESC_MICHAEL
                + ADDRESS_DESC_MICHAEL + CLASSES_DESC_MICHAEL, expectedMessage);

        // missing classes prefix
        assertParseFailure(parser, NAME_DESC_MICHAEL + PHONE_DESC_MICHAEL + EMAIL_DESC_MICHAEL
                + ADDRESS_DESC_MICHAEL + SUBJECT_DESC_MICHAEL, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_MICHAEL + VALID_PHONE_MICHAEL + VALID_EMAIL_MICHAEL
                + VALID_ADDRESS_MICHAEL + VALID_SUBJECT_MICHAEL + VALID_CLASSES_MICHAEL, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_MICHAEL + EMAIL_DESC_MICHAEL
                        + ADDRESS_DESC_MICHAEL + SUBJECT_DESC_MICHAEL + CLASSES_DESC_MICHAEL + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
