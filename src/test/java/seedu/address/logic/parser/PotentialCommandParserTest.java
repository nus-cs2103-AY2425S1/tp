...
public class PotentialCommandParserTest {
    private PotentialCommandParser parser = new PotentialCommandParser();

    @Test
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withIsEmployee(false).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DEPARTMENT_DESC_BOB + ROLE_DESC_BOB,
                new PotentialCommand(expectedPerson));
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                validExpectedPersonString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY
                        + DEPARTMENT_DESC_AMY + ROLE_DESC_AMY
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Person expectedPerson = new PersonBuilder(AMY).withIsEmployee(false).build();
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, PotentialCommand.MESSAGE_USAGE);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DEPARTMENT_DESC_BOB + ROLE_DESC_BOB,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, PotentialCommand.MESSAGE_USAGE));
    }
}
