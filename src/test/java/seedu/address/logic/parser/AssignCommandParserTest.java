...
public class AssignCommandParserTest {
    ...
    public void parse_repeatedValue_failure() {
        String validExpectedPersonString = ASSIGNMENT_ID_DESC_ONE + PROJECT_ID_DESC_BETA
                + EMPLOYEE_ID_DESC_BOB;

        // multiple assignmentIds
        assertParseFailure(parser, ASSIGNMENT_ID_DESC_TWO + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ASSIGNMENT_ID));

        // multiple projectIds
        assertParseFailure(parser, PROJECT_ID_DESC_ALPHA + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PROJECT_ID));

        // multiple employeeIds
        assertParseFailure(parser, EMPLOYEE_ID_DESC_BOB + validExpectedPersonString,
        ...
        assertParseFailure(parser, INVALID_ASSIGNMENT_ID_DESC + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ASSIGNMENT_ID));

        // invalid projectId
        assertParseFailure(parser, INVALID_PROJECT_ID_DESC + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PROJECT_ID));

        // invalid phone
        assertParseFailure(parser, INVALID_EMPLOYEE_ID_DESC + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_EMPLOYEE_ID));

        // valid value followed by invalid value

        // invalid assignmentId
        assertParseFailure(parser, validExpectedPersonString + INVALID_ASSIGNMENT_ID_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ASSIGNMENT_ID));

        // invalid projectId
        assertParseFailure(parser, validExpectedPersonString + INVALID_PROJECT_ID_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PROJECT_ID));

        // invalid phone
        assertParseFailure(parser, validExpectedPersonString + INVALID_EMPLOYEE_ID_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_EMPLOYEE_ID));
    }
