...
public class AddSupplierCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddSupplierCommand(expectedSupplier));
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        // multiple addresses
        assertParseFailure(parser, ADDRESS_DESC_AMY + validExpectedSupplierString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ADDRESS));

        // multiple fields repeated
        assertParseFailure(parser,
                validExpectedSupplierString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY
        ...
        // invalid address
        assertParseFailure(parser, INVALID_ADDRESS_DESC + validExpectedSupplierString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ADDRESS));
        ...
        // invalid address
        assertParseFailure(parser, validExpectedSupplierString + INVALID_ADDRESS_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ADDRESS));
    }
