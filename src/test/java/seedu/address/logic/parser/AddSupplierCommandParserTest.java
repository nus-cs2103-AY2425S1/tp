...
public class AddSupplierCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Supplier expectedSupplier = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Supplier expectedSupplierMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Supplier expectedSupplier = new PersonBuilder(AMY).withTags().build();
