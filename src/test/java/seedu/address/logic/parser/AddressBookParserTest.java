...
public class AddressBookParserTest {
    ...
    public void parseCommand_find() throws Exception {
        ...
        assertEquals(new FindCommand(new ClientContainsKeywordsPredicate(keywords)), command);
    }
    ...
    public void parseCommand_listTransaction() throws Exception {
        ListTransactionCommand command = (ListTransactionCommand) parser.parseCommand(
                ListTransactionCommand.COMMAND_WORD + " " + INDEX_FIRST_CLIENT.getOneBased());
        assertEquals(new ListTransactionCommand(INDEX_FIRST_CLIENT), command);
    }
