...
public class AddressBookParserTest {
    ...
    public void parseCommand_list() throws Exception {
        assertTrue(parser.parseCommand(ListEventsCommand.COMMAND_WORD) instanceof ListCommand);
        assertTrue(parser.parseCommand(ListEventsCommand.COMMAND_WORD + " 3") instanceof ListCommand);
    }
