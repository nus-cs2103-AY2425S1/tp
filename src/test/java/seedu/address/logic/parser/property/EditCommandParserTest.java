...
//        String userInput = targetIndex.getOneBased() + PHONE_DESC_BRENDA + TAG_DESC_HUSBAND
//                + ADDRESS_DESC_ALAN + ASKING_PRICE_DESC_ALAN + LANDLORD_NAME_DESC_ALAN + TAG_DESC_FRIEND;
//
//        EditPropertyDescriptor descriptor = new EditPropertyDescriptorBuilder()
//        .withLandlordName(VALID_LANDLORD_NAME_ALAN)
//                .withPhone(VALID_PHONE_BRENDA).withAddress(VALID_ADDRESS_ALAN)
...
//                + TAG_DESC_FRIEND + PHONE_DESC_ALAN + ASKING_PRICE_DESC_ALAN + ADDRESS_DESC_ALAN + TAG_DESC_FRIEND
//                + PHONE_DESC_BRENDA + ASKING_PRICE_DESC_BRENDA + ADDRESS_DESC_BRENDA + TAG_DESC_HUSBAND;
//
