...
public class TypicalStudents {
    ...
    public static final Student ALICE = new StudentBuilder().withName("Alice Pauline")
                                                            ...
                                                            .withRate("250.50").withPaidAmount("0").withOwedAmount("250.50").build();
    public static final Student BENSON = new StudentBuilder().withName("Benson Meier")
                                                             .withAddress("311, Clementi Ave 2, #02-25")
                                                             .withEmail("johnd@example.com").withPhone("98765432").withSchedule("Monday-1800-1900")
                                                             .withSubject("Mathematics").withRate("100.80").withPaidAmount("201.6").withOwedAmount("0").build();
    ...
    public static final Student GEORGE = new StudentBuilder().withName("George Best").withPhone("94824420")
                                                             ...
                                                             .withSubject("Mathematics").withRate("120").withPaidAmount("1200").withOwedAmount("0").build();
    ...
    public static final Student HOON = new StudentBuilder().withName("Hoon Meier").withPhone("84820424")
                                                           ...
                                                           .withSubject("Science").withRate("200").withPaidAmount("8000").withOwedAmount("1000").build();
    public static final Student IDA = new StudentBuilder().withName("Ida Mueller").withPhone("84820131")
                                                          ...
                                                          .withSubject("Economics").withRate("450").withPaidAmount("900").withOwedAmount("900").build();
    ...
    public static final Student AMY = new StudentBuilder().withName(VALID_NAME_AMY)
                                                          ...
                                                          .withRate(VALID_RATE_AMY).withPaidAmount(VALID_PAID_AMOUNT_AMY).withOwedAmount(VALID_OWED_AMOUNT_AMY).build();
    public static final Student BOB = new StudentBuilder().withName(VALID_NAME_BOB)
                                                          ...
                                                          .withRate(VALID_RATE_BOB).withPaidAmount(VALID_PAID_AMOUNT_BOB).withOwedAmount(VALID_OWED_AMOUNT_BOB).build();
