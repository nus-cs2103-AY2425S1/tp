...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withRate("250.50").withPaid("0").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432").withSchedule("Monday-1800-1900")
            .withSubject("Mathematics").withRate("100.80").withPaid("201.6").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street")
            .withSchedule("Tuesday-1800-1900").withSubject("Mathematics").withRate("300").withPaid("1200").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street")
            .withSchedule("Wednesday-1800-1900").withSubject("Mathematics").withRate("450.5").withPaid("450.5").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave")
            .withSchedule("Thursday-1800-1900").withSubject("Mathematics").withRate("350").withPaid("2800").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo")
            .withSchedule("Friday-1800-1900").withSubject("Mathematics").withRate("260.25").withPaid("0").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street").withSchedule("Saturday-1800-1900")
            .withSubject("Mathematics").withRate("120").withPaid("1200").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india")
            .withSchedule("Sunday-1800-1900").withRate("200").withPaid("8000").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withAddress("chicago ave")
            .withSchedule("Monday-1800-1900").withRate("450").withPaid("900").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY)
            .withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withSchedule(VALID_SCHEDULE_AMY)
            .withRate(VALID_RATE_AMY).withPaid(VALID_PAID_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB)
            .withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withSchedule(VALID_SCHEDULE_BOB)
            .withRate(VALID_RATE_BOB).withPaid(VALID_PAID_BOB).build();
