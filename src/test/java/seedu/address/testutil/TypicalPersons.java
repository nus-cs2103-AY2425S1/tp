...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            .withId("P12345").withWard("A1").withDiagnosis("Celiac Disease").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withId("P54321").withWard("A2").withDiagnosis("Celiac Disease").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz")
            .withId("P73443").withWard("B3").withDiagnosis("Celiac Disease").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier")
            .withId("P54786").withWard("C8").withDiagnosis("Celiac Disease").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer")
            .withId("P27346").withWard("I5").withDiagnosis("Celiac Disease").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz")
            .withId("P07962").withWard("A1").withDiagnosis("Celiac Disease").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best")
            .withId("P18277").withWard("B1").withDiagnosis("Celiac Disease").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withId(VALID_ID_AMY)
            .withWard(VALID_WARD_AMY).withDiagnosis("Celiac Disease").build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withId(VALID_ID_BOB)
            .withWard(VALID_WARD_BOB).withDiagnosis("Chronic Sinusitis").build();
