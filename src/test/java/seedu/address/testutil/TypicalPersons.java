...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253")
            .withTags("friends").withDateOfLastVisit("01-01-2024").withRemark("").build();
    ...
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("84827424")
            .withEmail("stefan@example.com").withAddress("little india").withDateOfLastVisit("01-01-2024").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("84821315")
            .withEmail("hans@example.com").withAddress("chicago ave").withDateOfLastVisit("01-01-2024").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND)
            .withDateOfLastVisit(VALID_DATEOFLASTVISIT_AMY).build();
