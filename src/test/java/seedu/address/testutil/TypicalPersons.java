...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withEcName("Sarah Lim").withEcPhone("98761234")
            .withEcRelationship("Parent").withTags("friends").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432").withEcName("Kevin Goh")
            .withEcPhone("98764123")
            .withEcRelationship("Husband")
            .withTags("owesMoney", "friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEcName("Kevin Goh").withEcPhone("98764123").withEcRelationship("Husband")
            .withEmail("heinz@example.com").withAddress("wall street").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEcName("Haziq Bin Abudllah").withEcPhone("98763412").withEcRelationship("Brother")
            .withEmail("cornelia@example.com").withAddress("10th street").withTags("friends").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEcName("Amanda Lee").withEcPhone("98762341").withEcRelationship("Cousin")
            .withEmail("werner@example.com").withAddress("michegan ave").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEcName("Nurul Ain").withEcPhone("98761243").withEcRelationship("Grandmother")
            .withEmail("lydia@example.com").withAddress("little tokyo").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEcName("Anjali Devi").withEcPhone("98763124").withEcRelationship("Daughter")
