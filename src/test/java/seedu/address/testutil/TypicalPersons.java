...
public class TypicalPersons {
    ...
    public static final Person ELLE = new PersonBuilder().withNric("S5674593I")
            ...
            .withCallFrequency("7").build();
    public static final Person FIONA = new PersonBuilder().withNric("S1092693I")
            .withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo")
            .withCallFrequency("7").build();
    public static final Person GEORGE = new PersonBuilder().withNric("S8596794J")
            .withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street")
            .withCallFrequency("7").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withNric("S5594223D")
            .withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india")
            .withCallFrequency("7").build();
    public static final Person IDA = new PersonBuilder().withNric("S1751126B")
