...
public class TypicalPersons {
    ...
    public static final Patient CARL = new PersonBuilder().withName("Carl Kurz")
            .withNric("T0481580Z")
            .withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").build();
    public static final Patient DANIEL = new PersonBuilder().withName("Daniel Meier")
            .withNric("T0381280Z")
            .withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").build();
    public static final Patient ELLE = new PersonBuilder().withName("Elle Meyer")
            .withNric("T0081280F")
            .withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave").build();
    public static final Patient FIONA = new PersonBuilder().withName("Fiona Kunz")
            .withNric("T0100280Z")
            .withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").build();
    public static final Patient GEORGE = new PersonBuilder().withName("George Best")
            .withNric("T0181003Z")
            .withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street").build();

    // Manually added
    public static final Patient HOON = new PersonBuilder().withName("Hoon Meier")
            .withNric("S1234567H")
            .withPhone("8482424")
    ...
    public static final Patient AMY = new PersonBuilder().withName(VALID_NAME_AMY).withNric(VALID_NRIC_AMY)
            .withSex(VALID_SEX_AMY).withBirthdate(VALID_BIRTHDATE_AMY).build();
    public static final Patient BOB = new PersonBuilder().withName(VALID_NAME_BOB).withNric(VALID_NRIC_BOB)
            .withSex(VALID_SEX_BOB).withBirthdate(VALID_BIRTHDATE_BOB).build();

    public static final Patient JAKE = new PersonBuilder().withName("Jake Tio").withPhone("9982131")
            .withEmail("jakers@example.com").withAddress("nus drive").build();

    public static final Patient KEANU = new PersonBuilder().withName("Keanu Reeves").withNric("S9975483H").withSex("M")
