...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withTags("friends").withAttendance(new HashMap<>()).withSubmissions("Assignment 1", "Tutorial 1").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withTags("owesMoney", "friends").withAttendance(new HashMap<>() {{
                    ...
                    }}).withSubmissions("Assignment 1").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            ...
            .withAttendance(new HashMap<>()).withSubmissions("Assignment 1").build();
    ...
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            ...
            .withSubmissions(VALID_SUBMISSION_ASSIGNMENT_1)
            .withSubmissionStatus(VALID_SUBMISSION_ASSIGNMENT_1, VALID_SUBMISSION_STATUS_BOB).build();
