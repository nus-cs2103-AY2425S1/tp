...
import static seedu.address.testutil.TypicalPublicAddresses.VALID_PUBLIC_ADDRESS_BTC_COLD;
...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
        ...
        .withPhone("94351253")
        .withPublicAddresses(VALID_PUBLIC_ADDRESS_BTC_MAIN, VALID_PUBLIC_ADDRESS_BTC_SUB)
        .withTags("friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
        .withEmail("heinz@example.com").withAddress("wall street").withPublicAddresses(
            VALID_PUBLIC_ADDRESS_SOL_MAIN).build();
    ...
    public static final Person JOE = new PersonBuilder().withName("Joe Mama").withPhone("87654321")
        ...
        .withPublicAddresses(VALID_PUBLIC_ADDRESS_BTC_MAIN, VALID_PUBLIC_ADDRESS_BTC_SUB,
            VALID_PUBLIC_ADDRESS_ETH_MAIN).build();
    public static final Person MOE = new PersonBuilder().withName("Moe Papa").withPhone("99887766")
        ...
        .withPublicAddresses(VALID_PUBLIC_ADDRESS_BTC_COLD, VALID_PUBLIC_ADDRESS_SOL_MAIN).build();
    ...
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
        ...
        .withPublicAddresses(VALID_PUBLIC_ADDRESS_SOL_MAIN, VALID_PUBLIC_ADDRESS_SOL_SUB)
