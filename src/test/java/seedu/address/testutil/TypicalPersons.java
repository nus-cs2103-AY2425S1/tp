...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253")
            .withTag("High Risk").withAllergies("Penicillin")
            .withDate(LocalDateTime.of(2024, 11, 16, 13, 30)).build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withAllergies(VALID_ALLERGY_AMY).withDate(VALID_DATE_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTag(VALID_TAG_HIGH_RISK)
            .withAllergies(VALID_ALLERGY1_BOB, VALID_ALLERGY2_BOB).withDate(VALID_DATE_BOB).build();
