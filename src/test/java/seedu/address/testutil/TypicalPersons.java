...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withStatus("Applied").withNote("Super Confident").withTags("friends").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withNote("Dislike micro-managing").withTags("owesMoney", "friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").withSkills("DevOps, python")
            .withExperience("Intern at Google from 2022-2023").withStatus("Applied").withNote("").build();
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            ...
            .withExperience("Intern at NUS from 2022-2023").withStatus("Applied").withNote("").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").withSkills("DevOps, python")
            .withExperience("Intern at NTU from 2022-2023").withStatus("Applied").withNote("").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street").withSkills("DevOps, python")
            .withExperience("Intern at SIM from 2022-2023").withStatus("Applied").withNote("").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india").withSkills("DevOps, python")
            .withExperience("Intern at SMU from 2022-2023").withStatus("Applied").withNote("").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withAddress("chicago ave").withSkills("DevOps, python")
            .withExperience("Intern at SUSS from 2022-2023").withStatus("Applied").withNote("").build();
