...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withRegisterNumber("3").withSex("F")
            .withStudentClass("1A").withEcName("Joe Hardy")
            .withEcNumber("26283728").withTags("friends")
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz")
            ...
            .withAddress("wall street").withRegisterNumber("5")
            .withSex("M").withStudentClass("3C")
            .withEcName("James Dol").withEcNumber("")
            .withAttendance(new HashMap<>())
            .build();
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer")
            ...
            .withAddress("michegan ave").withRegisterNumber("7")
            .withSex("F").withStudentClass("3E")
    ...
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz")
            ...
            .withAddress("little tokyo").withRegisterNumber("8")
            .withSex("F").withStudentClass("2A")
            .withEcName("").withEcNumber("")
            .withAttendance(new HashMap<>())
            .build();
    ...
    public static final Person GEORGE = new PersonBuilder().withName("George Best")
            ...
            .withAddress("4th street").withRegisterNumber("9")
            .withSex("M").withStudentClass("1A")
            .withEcName("").withEcNumber("")
            .withAttendance(new HashMap<>())
            .build();
    ...
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier")
            ...
            .withAddress("little india").withRegisterNumber("10")
            .withSex("M").withStudentClass("3C")
            .withEcName("").withEcNumber("")
            .withAttendance(new HashMap<>())
            .build();
    ...
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller")
            ...
            .withAddress("chicago ave").withRegisterNumber("11")
            .withSex("F").withStudentClass("4D")
            .withEcName("").withEcNumber("")
            .withAttendance(new HashMap<>())
            .build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withEcName(VALID_ECNAME_AMY).withTags(VALID_TAG_FRIEND).withAttendance(VALID_ATTENDANCE_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            ...
            .withEcName(VALID_ECNAME_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
