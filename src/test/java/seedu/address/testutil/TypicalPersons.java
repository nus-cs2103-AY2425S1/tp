...
public class TypicalPersons {
    ...
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("64824274")
            .withEmail("lydia@example.com").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("64824432")
    ...
    /**
     * Returns an {@code CampusConnect} with all the typical persons.
     */
    public static CampusConnect getTypicalCampusConnect() {
        CampusConnect ab = new CampusConnect();
