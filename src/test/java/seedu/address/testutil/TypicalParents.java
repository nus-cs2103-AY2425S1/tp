...
public class TypicalParents {
    ...
    public static final Parent CARL = new ParentBuilder().withName("Carl Kurz")
            .withPhone("95352563")
            .withEmail("heinz@example.com")
            .withAddress("wall street")
            .build();
    public static final Parent DANIEL = new ParentBuilder().withName("Daniel Meier")
            .withPhone("87652533")
    ...
    // Manually added - Parent's details found in {@code CommandTestUtil}
    ...
    public static AddressBook getTypicalAddressBook() {
        ...
        for (Parent person : getTypicalParents()) {
            ab.addPerson(person);
        }
        return ab;
    }
