...
public class TypicalTeachers {
    ...
    public static final Teacher AMY = new TeacherBuilder().withName(VALID_NAME_AMY).withGender(VALID_GENDER_AMY)
        .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
        .withTags(VALID_TAG_FRIEND).build();
    public static final Teacher BOB = new TeacherBuilder().withName(VALID_NAME_BOB).withGender(VALID_GENDER_BOB)
