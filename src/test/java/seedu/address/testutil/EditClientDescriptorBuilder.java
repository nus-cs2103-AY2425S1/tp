...
public class EditClientDescriptorBuilder {
    ...
    public EditClientDescriptorBuilder(Client client) {
        ...
        descriptor.setCompany(client.getCompany());
    ...
    /**
     * Sets the {@code Company} of the {@code EditClientDescriptor} that we are building.
     */
    public EditClientDescriptorBuilder withCompany(String company) {
