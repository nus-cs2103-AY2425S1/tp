...
public class PhoneContainsSubstringPredicateTest {
    ...
    public void equals() {
        ...
        PhoneContainsSubstringPredicate firstPredicate = new PhoneContainsSubstringPredicate(firstPredicateSubstring);
        PhoneContainsSubstringPredicate secondPredicate = new PhoneContainsSubstringPredicate(secondPredicateSubstring);

        // same object -> returns true
        assertTrue(firstPredicate.equals(firstPredicate));

        // same values -> returns true
        PhoneContainsSubstringPredicate firstPredicateCopy = new PhoneContainsSubstringPredicate(firstPredicateSubstring);
    ...
    public void test_phoneContainsSubstring_returnsTrue() {
        ...
        assertTrue(predicate.test(new PersonBuilder().withPhone("91112222").build()));
    ...
    public void test_emptySubstring_throwsException() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> predicate.test(
                new PersonBuilder().withPhone("91112222").build()));
    }
    ...
    public void test_phoneDoesNotContainSubstring_returnsFalse() {
        ...
        PhoneContainsSubstringPredicate predicate = new PhoneContainsSubstringPredicate("91112222");
        assertFalse(predicate.test(new PersonBuilder().withPhone("81112222").build()));

        // Substring matches name but does not match phone
        predicate = new PhoneContainsSubstringPredicate("91112222");
        assertFalse(predicate.test(new PersonBuilder().withName("91112222").withPhone("91234567")
