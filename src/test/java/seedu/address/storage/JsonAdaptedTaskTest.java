...
public class JsonAdaptedTaskTest {
    ...
    public void toModelType_validTodoDetails_returnsTodo() throws Exception {
        JsonAdaptedTodo todo = new JsonAdaptedTodo(VALID_ID, VALID_TODO_DESCRIPTION, false);
        Todo expectedTodo = new Todo(VALID_ID, VALID_TODO_DESCRIPTION);
        assertEquals(expectedTodo, todo.toModelType());
    }

    @Test
    public void toModelType_invalidTodoDescription_throwsIllegalValueException() {
        JsonAdaptedTodo todo = new JsonAdaptedTodo(VALID_ID, INVALID_DESCRIPTION, false);
    ...
    public void toModelType_validDeadlineDetails_returnsDeadline() throws Exception {
        JsonAdaptedDeadline deadline = new JsonAdaptedDeadline(VALID_ID, VALID_DEADLINE_DESCRIPTION,
                false, VALID_DEADLINE_DATE);
        Deadline expectedDeadline = new Deadline(VALID_ID, VALID_DEADLINE_DESCRIPTION, VALID_DEADLINE_DATE);
    ...
    public void toModelType_validEventDetails_returnsEvent() throws Exception {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_ID, VALID_EVENT_DESCRIPTION,
                false, VALID_EVENT_START_DATE, VALID_EVENT_END_DATE);
        Event expectedEvent = new Event(VALID_ID, VALID_EVENT_DESCRIPTION, VALID_EVENT_START_DATE, VALID_EVENT_END_DATE);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedTodo todo = new JsonAdaptedTodo(VALID_ID,null, false);
