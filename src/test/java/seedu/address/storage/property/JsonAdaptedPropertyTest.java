...
public class JsonAdaptedPropertyTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedProperty property = new JsonAdaptedProperty(INVALID_NAME, VALID_PHONE, VALID_LOCATION,
    ...
    public void toModelType_invalidLocation_throwsIllegalValueException() {
        JsonAdaptedProperty property = new JsonAdaptedProperty(VALID_NAME, VALID_PHONE, INVALID_LOCATION,
                VALID_ASKING_PRICE, VALID_PROPERTY_TYPE);
    ...
    public void toModelType_invalidAskingPrice_throwsIllegalValueException() {
        JsonAdaptedProperty property = new JsonAdaptedProperty(VALID_NAME, VALID_PHONE, VALID_LOCATION,
