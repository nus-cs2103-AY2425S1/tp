...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(INVALID_NAME, VALID_PHONE, VALID_TUTORIAL_GROUP,
                        VALID_STUDENT_NUMBER, VALID_ASSIGNMENTS, VALID_ATTENDANCE_RECORD);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(null, VALID_PHONE, VALID_TUTORIAL_GROUP,
                        VALID_STUDENT_NUMBER, VALID_ASSIGNMENTS, VALID_ATTENDANCE_RECORD);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, INVALID_PHONE, VALID_TUTORIAL_GROUP,
                        VALID_STUDENT_NUMBER, VALID_ASSIGNMENTS, VALID_ATTENDANCE_RECORD);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, null, VALID_TUTORIAL_GROUP,
                        VALID_STUDENT_NUMBER, VALID_ASSIGNMENTS, VALID_ATTENDANCE_RECORD);
    ...
    public void toModelType_invalidTutorialGroup_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, INVALID_TUTORIAL_GROUP,
                        VALID_STUDENT_NUMBER, VALID_ASSIGNMENTS, VALID_ATTENDANCE_RECORD);
    ...
    public void toModelType_invalidStudentNumber_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_TUTORIAL_GROUP,
                        INVALID_STUDENT_NUMBER, VALID_ASSIGNMENTS, VALID_ATTENDANCE_RECORD);
    ...
    public void toModelType_nullStudentNumber_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_TUTORIAL_GROUP,
                        null, VALID_ASSIGNMENTS, VALID_ATTENDANCE_RECORD);
    ...
    public void toModelType_invalidAttendanceRecord_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_TUTORIAL_GROUP,
                        VALID_STUDENT_NUMBER, VALID_ASSIGNMENTS, invalidAttendanceRecords);
