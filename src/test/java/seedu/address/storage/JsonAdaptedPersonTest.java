...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_JOB = BENSON.getJob().toString();  // Valid job
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_JOB, VALID_INCOME_STRING, VALID_TAGS, VALID_REMARK);
    ...
    public void toModelType_invalidJob_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_JOB, VALID_INCOME_STRING, VALID_TAGS, VALID_REMARK);
    ...
    public void toModelType_nullJob_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        null, VALID_INCOME_STRING, VALID_TAGS, VALID_REMARK);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_JOB, VALID_INCOME_STRING, invalidTags, VALID_REMARK);
    ...
    public void toModelType_invalidRemark_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_JOB, VALID_INCOME_STRING, VALID_TAGS, null);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
}
