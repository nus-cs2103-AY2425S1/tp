...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_DATE_OF_BIRTH,
                        VALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS, VALID_MEDCON);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_DATE_OF_BIRTH, VALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS,
                VALID_MEDCON);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS, VALID_ADDRESS,
                        VALID_DATE_OF_BIRTH, VALID_GENDER, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS, VALID_MEDCON);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, null,
                VALID_ADDRESS, VALID_DATE_OF_BIRTH, VALID_GENDER, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS,
                        VALID_MEDCON);
    ...
    public void toModelType_invalidDateOfBirthDateFormat_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_DATE_OF_BIRTH_FORMAT, VALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY,
    ...
    public void toModelType_invalidDateOfBirthFutureDate_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_DATE_OF_BIRTH_FUTURE_DATE, VALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY,
                        VALID_APPOINTMENTS, VALID_MEDCON);
    ...
    public void toModelType_nullDateOfBirth_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS, VALID_MEDCON);
    ...
    public void toModelType_invalidGender_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_DATE_OF_BIRTH,
                        INVALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS, VALID_MEDCON);
    ...
    public void toModelType_nullGender_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_DATE_OF_BIRTH, null, VALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS,
                VALID_MEDCON);
    ...
    public void toModelType_invalidNric_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_DATE_OF_BIRTH,
                        VALID_GENDER, INVALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS, VALID_MEDCON);
    ...
    public void toModelType_nullNric_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_DATE_OF_BIRTH, VALID_GENDER, null, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS, VALID_MEDCON);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_ADDRESS,
                        VALID_DATE_OF_BIRTH, VALID_GENDER, invalidTags, VALID_PRIORITY, VALID_APPOINTMENTS, VALID_MEDCON);
    ...
    public void toModelType_invalidAppointments_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_ADDRESS,
                    VALID_DATE_OF_BIRTH, VALID_GENDER, VALID_TAGS, VALID_PRIORITY, invalidAppointments, VALID_MEDCON);
    }
    @Test
    public void toModelType_invalidPriority_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_DATE_OF_BIRTH, VALID_GENDER, VALID_NRIC, VALID_TAGS, INVALID_PRIORITY, VALID_APPOINTMENTS,
                VALID_MEDCON);
    ...
    public void toModelType_nullPriority_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_DATE_OF_BIRTH, VALID_GENDER, VALID_NRIC, VALID_TAGS, null, VALID_APPOINTMENTS,
                VALID_MEDCON);
