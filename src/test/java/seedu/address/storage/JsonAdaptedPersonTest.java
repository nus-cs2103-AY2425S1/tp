...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMERGENCY_CONTACT,
                        VALID_ADDRESS, "", VALID_SUBJECTS, VALID_LEVEL);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMERGENCY_CONTACT,
                        INVALID_ADDRESS, "", VALID_SUBJECTS, VALID_LEVEL);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMERGENCY_CONTACT,
                        null, "", VALID_SUBJECTS, VALID_LEVEL);
    ...
    public void toModelType_invalidSubjects_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMERGENCY_CONTACT,
                        VALID_ADDRESS, "", invalidSubjects, VALID_LEVEL);
    ...
    public void toModelType_invalidLevel_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMERGENCY_CONTACT,
                        VALID_ADDRESS, "", VALID_SUBJECTS, "JC3");
        assertThrows(IllegalValueException.class, person::toModelType);
    }
