...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedContactRecord> VALID_CONTACT_RECORDS = BENSON.getContactRecords().stream()
    ...
    public void toModelType_invalidNric_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NRIC, VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_CONTACT_RECORDS, VALID_CALL_FREQUENCY);
    ...
    public void toModelType_nullNric_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_CONTACT_RECORDS, VALID_CALL_FREQUENCY);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NRIC, VALID_NAME, VALID_PHONE, VALID_EMAIL,
                INVALID_ADDRESS, VALID_TAGS, VALID_CONTACT_RECORDS, VALID_CALL_FREQUENCY);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NRIC, VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS,
                invalidTags, VALID_CONTACT_RECORDS, VALID_CALL_FREQUENCY);
        assertThrows(IllegalValueException.class, person::toModelType);
    }

    @Test
    public void toModelType_invalidContactRecords_throwsIllegalValueException() {
        List<JsonAdaptedContactRecord> invalidContactRecords = new ArrayList<>(VALID_CONTACT_RECORDS);
        invalidContactRecords.add(new JsonAdaptedContactRecord(INVALID_CONTACT_DATE, VALID_NOTES));
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NRIC, VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS,
                VALID_TAGS, invalidContactRecords, VALID_CALL_FREQUENCY);
        assertThrows(IllegalValueException.class, person::toModelType);
    }

    @Test
    public void toModelType_emptyContactRecords_returnsPerson() throws Exception {
        List<JsonAdaptedContactRecord> emptyContactRecords = new ArrayList<>();
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NRIC, VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS,
                VALID_TAGS, emptyContactRecords, VALID_CALL_FREQUENCY);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidCallFrequency_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NRIC, VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_CONTACT_RECORDS, INVALID_CALL_FREQUENCY);
    ...
    public void toModelType_nullCallFrequency_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NRIC, VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS,
                VALID_TAGS, VALID_CONTACT_RECORDS, null);
