...
import static seedu.address.storage.buyer.JsonAdaptedPerson.JsonAdaptedBuyer;
...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_PERSON_TYPE = BENSON.getPersonType().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedBuyer person =
                new JsonAdaptedBuyer(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_PERSON_TYPE,
                        VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedBuyer person =
                new JsonAdaptedBuyer(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_PERSON_TYPE,
                        VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedBuyer person =
                new JsonAdaptedBuyer(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS, VALID_PERSON_TYPE,
                        VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedBuyer person =
                new JsonAdaptedBuyer(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS, VALID_PERSON_TYPE,
                        VALID_TAGS);
