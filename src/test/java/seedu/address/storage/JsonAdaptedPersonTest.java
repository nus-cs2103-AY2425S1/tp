...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_TELEGRAM, VALID_EMAIL, VALID_STUDENT_STATUS,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_TELEGRAM, VALID_EMAIL, VALID_STUDENT_STATUS,
                VALID_ROLES, VALID_NICKNAME);
    ...
    public void toModelType_invalidTelegram_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_TELEGRAM, VALID_EMAIL, VALID_STUDENT_STATUS,
                        VALID_ROLES, VALID_NICKNAME);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_TELEGRAM, INVALID_EMAIL, VALID_STUDENT_STATUS,
                        VALID_ROLES, VALID_NICKNAME);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_TELEGRAM, null, VALID_STUDENT_STATUS,
                VALID_ROLES, VALID_NICKNAME);
    ...
    public void toModelType_invalidStudentStatus_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_TELEGRAM, VALID_EMAIL, INVALID_STUDENT_STATUS,
                        VALID_ROLES, VALID_NICKNAME);
    ...
    public void toModelType_nullStudentStatus_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_TELEGRAM, VALID_EMAIL, null,
                VALID_ROLES, VALID_NICKNAME);
    ...
    public void toModelType_invalidRoles_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_TELEGRAM, VALID_EMAIL, VALID_STUDENT_STATUS,
