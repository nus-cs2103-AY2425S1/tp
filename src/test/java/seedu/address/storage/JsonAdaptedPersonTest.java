...
public class JsonAdaptedPersonTest {
    ...
    private static final JsonAdaptedRole VALID_ROLE = new JsonAdaptedRole(CARL.getRole());
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_ROLE);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        JsonAdaptedRole invalidRole = new JsonAdaptedRole(INVALID_ROLE);
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, invalidRole);
