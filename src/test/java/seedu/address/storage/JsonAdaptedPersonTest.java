...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_PAYMENT = "what?";
    private static final String INVALID_PARTICIPATION = "null";
    ...
    private static final String VALID_PAYMENT = BENSON.getPayment().overdueAmount;
    private static final List<Participation> VALID_PARTICIPATION = new ArrayList<Participation>();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_PAYMENT, VALID_PARTICIPATION, VALID_TAGS);
    ...
    public void toModelType_invalidPayment_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_PAYMENT, VALID_PARTICIPATION, VALID_TAGS);
    ...
    public void toModelType_nullPayment_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_PARTICIPATION, VALID_TAGS);
    ...
    public void toModelType_invalidAttendance_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_PAYMENT, INVALID_PARTICIPATION, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_PAYMENT, VALID_ATTENDANCE, invalidTags);
