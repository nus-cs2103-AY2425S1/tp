...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_SCHEDULE, VALID_SUBJECT,
                        VALID_RATE, VALID_OWED_AMOUNT
                );
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_SCHEDULE, VALID_SUBJECT,
                        VALID_RATE, VALID_OWED_AMOUNT
                );
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS, VALID_SCHEDULE, VALID_SUBJECT,
                        VALID_RATE, VALID_OWED_AMOUNT
                );
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS, VALID_SCHEDULE, VALID_SUBJECT,
                        VALID_RATE, VALID_OWED_AMOUNT
                );
    ...
    public void toModelType_invalidSchedule_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, INVALID_SCHEDULE, VALID_SUBJECT,
                        VALID_RATE, VALID_OWED_AMOUNT
                );
    ...
    public void toModelType_nullSchedule_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, null, VALID_SUBJECT,
                VALID_RATE, VALID_OWED_AMOUNT
        );
    ...
    public void toModelType_invalidSubject_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_SCHEDULE, INVALID_SUBJECT,
                        VALID_RATE, VALID_OWED_AMOUNT
                );
    ...
    public void toModelType_nullSubject_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_SCHEDULE, null,
                VALID_RATE, VALID_OWED_AMOUNT
        );
    ...
    public void toModelType_invalidRate_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_SCHEDULE, VALID_SUBJECT, INVALID_RATE, VALID_OWED_AMOUNT);
    ...
    public void toModelType_nullRate_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_SCHEDULE, VALID_SUBJECT, null, VALID_OWED_AMOUNT);
    ...
    public void toModelType_invalidOwedAmount_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_SCHEDULE, VALID_SUBJECT, VALID_RATE, INVALID_OWED_AMOUNT);
