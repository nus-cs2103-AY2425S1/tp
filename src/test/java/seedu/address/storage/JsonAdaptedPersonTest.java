...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        ...
                        VALID_REMARK, VALID_DATE_OF_BIRTH, VALID_INCOME, VALID_APPOINTMENT, VALID_FAMILY_SIZE,
                        VALID_TAGS, VALID_UPDATED_AT);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        ...
                        VALID_DATE_OF_BIRTH, VALID_INCOME, VALID_APPOINTMENT, VALID_FAMILY_SIZE,
                        VALID_TAGS, VALID_UPDATED_AT);
    ...
    public void toModelType_invalidDateOfBirth_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        ...
                        VALID_REMARK, INVALID_DATE_OF_BIRTH, VALID_INCOME, VALID_APPOINTMENT, VALID_FAMILY_SIZE,
                        VALID_TAGS, VALID_UPDATED_AT);
    ...
    public void toModelType_invalidIncome_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_PRIORITY,
                        VALID_REMARK, VALID_DATE_OF_BIRTH, INVALID_INCOME, VALID_APPOINTMENT, VALID_FAMILY_SIZE,
                        VALID_TAGS, VALID_UPDATED_AT);
    ...
    public void toModelType_nullDateOfBirth_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_PRIORITY,
                        VALID_REMARK, null, VALID_INCOME, VALID_APPOINTMENT, VALID_FAMILY_SIZE,
                        VALID_TAGS, VALID_UPDATED_AT);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, DateOfBirth.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }

    @Test void toModelType_invalidFamilySize_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(
                        VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_PRIORITY,
                        VALID_REMARK, VALID_DATE_OF_BIRTH, VALID_INCOME, VALID_APPOINTMENT, INVALID_FAMILY_SIZE,
                        VALID_TAGS, VALID_UPDATED_AT);
    ...
    public void toModelType_invalidUpdatedAt_shouldNotThrow() {
        assertDoesNotThrow(() -> new JsonAdaptedPerson(
                ...
                VALID_DATE_OF_BIRTH, VALID_INCOME, VALID_APPOINTMENT, VALID_FAMILY_SIZE, VALID_TAGS,
                INVALID_UPDATED_AT));
    }
}
