...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_DATE_OF_BIRTH,
                        VALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS);
    ...
    public void toModelType_nullDateOfBirth_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS);
    ...
    public void toModelType_invalidGender_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_DATE_OF_BIRTH,
                        INVALID_GENDER, VALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS);
    ...
    public void toModelType_invalidNric_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_DATE_OF_BIRTH,
                        VALID_GENDER, INVALID_NRIC, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS);
    ...
    public void toModelType_nullNric_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_DATE_OF_BIRTH, VALID_GENDER, null, VALID_TAGS, VALID_PRIORITY, VALID_APPOINTMENTS);
