...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidPriorityLevel_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_EMERGENCY_CONTACT_NAME,
                        VALID_EMERGENCY_CONTACT_NUMBER, VALID_TAGS, INVALID_PRIORITY_LEVEL);
        String expectedMessage = PriorityLevel.MESSAGE_CONSTRAINTS;
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_EMERGENCY_CONTACT_NAME,
                        VALID_EMERGENCY_CONTACT_NUMBER, VALID_TAGS, VALID_PRIORITY_LEVEL);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_EMERGENCY_CONTACT_NAME,
                        VALID_EMERGENCY_CONTACT_NUMBER, invalidTags, VALID_PRIORITY_LEVEL);
