...
public class JsonAdaptedPersonTest {
    public static final List<JsonAdaptedTag> VALID_TAGS = BENSON.getTags().stream()
    ...
    private static final String VALID_ROLE = BENSON.getRole().getValue();
    private static final JsonAdaptedWorker VALID_WORKER = new JsonAdaptedWorker(BENSON.getWorker());
    private static final String VALID_ARCHIVE = BENSON.getArchive().value;
    private static final String VALID_ADDRESS = BENSON.getAddress().toString();
    private static final List<JsonAdaptedDelivery> VALID_DELIVERIES = BENSON.getUnmodifiableDeliveryList().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ROLE, VALID_WORKER,
                    VALID_ADDRESS, VALID_TAGS,
                    VALID_DELIVERIES, VALID_ARCHIVE);
    ...
    public void toModelType_invalidArchive_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ROLE, VALID_WORKER,
                        VALID_ADDRESS, VALID_TAGS,
                        VALID_DELIVERIES, INVALID_ARCHIVE);
