...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_ATTENDANCE_COUNT = "-1";
    ...
    private static final String VALID_ATTENDANCE_COUNT = BENSON.getAttendanceCount().toString();
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_ROLE, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_ATTENDANCE_COUNT);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_ROLE, VALID_PHONE, VALID_EMAIL,
                null, VALID_TAGS, VALID_ATTENDANCE_COUNT);
    ...
    @Test
    public void toModelType_invalidAttendanceCount_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_ROLE, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        INVALID_ATTENDANCE_COUNT);
        String expectedMessage = AttendanceCount.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }

    @Test
    public void toModelType_nullAttendanceCount_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_ROLE, VALID_PHONE, VALID_EMAIL,
