...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_ROLE = "NOT_A_PATIENT"; // Add this
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE,
                null, VALID_ADDRESS, VALID_TAGS, VALID_ROLE, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                INVALID_ADDRESS, VALID_TAGS, VALID_ROLE, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE,
                VALID_EMAIL, null, VALID_TAGS, VALID_ROLE, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, invalidTags, VALID_ROLE, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT);
    ...
    public void toModelType_invalidRoles_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, invalidRoles, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
}
