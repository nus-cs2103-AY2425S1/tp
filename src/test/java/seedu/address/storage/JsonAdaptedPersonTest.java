...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_TELEGRAM, VALID_TAGS, VALID_GITHUB, VALID_ASSIGNMENT_ONE,
                        VALID_SCORE, validAttendance);
    ...
    public void toModelType_nullGithub_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TELEGRAM, VALID_TAGS, null, VALID_ASSIGNMENT_ONE,
                VALID_SCORE, validAttendance);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        INVALID_ADDRESS, VALID_TELEGRAM, VALID_TAGS, VALID_GITHUB, VALID_ASSIGNMENT_ONE,
                        VALID_SCORE, validAttendance);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_TELEGRAM, VALID_TAGS, VALID_GITHUB, VALID_ASSIGNMENT_ONE,
                VALID_SCORE, validAttendance);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TELEGRAM,
                        invalidTags, VALID_GITHUB, VALID_ASSIGNMENT_ONE,
                        VALID_SCORE, validAttendance);
    ...
    public void toModelType_invalidTelegram_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, INVALID_TELEGRAM, VALID_TAGS, VALID_GITHUB, VALID_ASSIGNMENT_ONE,
                        VALID_SCORE, validAttendance);
    ...
    public void toModelType_invalidGithubUsername_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TELEGRAM, VALID_TAGS,
                        INVALID_GITHUB, VALID_ASSIGNMENT_ONE,
                        VALID_SCORE, validAttendance);
