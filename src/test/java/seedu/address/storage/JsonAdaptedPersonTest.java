...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidEmployeeId_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_EMPLOYEE_ID, VALID_NAME,
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_EMPLOYEE_ID, INVALID_NAME,
                VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_SKILLS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_EMPLOYEE_ID, null,
                VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_SKILLS);
