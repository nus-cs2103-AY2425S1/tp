...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_validDoctorDetails_returnsDoctor() throws Exception {
        JsonAdaptedPerson doctor = new JsonAdaptedPerson(ALICE);
        assertEquals(ALICE, doctor.toModelType());
    }

    @Test
    public void toModelType_validPatientDetails_returnsPatient() throws Exception {
        JsonAdaptedPerson patient = new JsonAdaptedPerson(CARL);
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE,
                        VALID_EMAIL, VALID_ADDRESS, null, null, null, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_SPECIALITY, VALID_DATEOFBIRTH, VALID_GENDER, VALID_TAGS);
