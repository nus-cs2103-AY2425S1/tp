...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_ROLE, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT, VALID_NOTES);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                INVALID_ADDRESS, VALID_TAGS, VALID_ROLE, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT, VALID_NOTES);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE,
                VALID_EMAIL, null, VALID_TAGS, VALID_ROLE, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT, VALID_NOTES);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, invalidTags, VALID_ROLE, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT, VALID_NOTES);
    ...
    public void toModelType_invalidRoles_throwsIllegalValueException() {
        ...
        invalidRoles.add(new JsonAdaptedRole(INVALID_ROLE)); // Invalid role
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, invalidRoles, VALID_CAREGIVERS, VALID_PATIENTS, VALID_APPOINTMENT, VALID_NOTES);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
