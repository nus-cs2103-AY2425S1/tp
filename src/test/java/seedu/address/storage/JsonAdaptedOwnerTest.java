...
public class JsonAdaptedOwnerTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedOwner owner =
                new JsonAdaptedOwner(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedOwner owner = new JsonAdaptedOwner(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedOwner owner =
                new JsonAdaptedOwner(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedOwner owner =
                new JsonAdaptedOwner(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedOwner owner = new JsonAdaptedOwner(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedOwner owner =
                new JsonAdaptedOwner(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedOwner owner = new JsonAdaptedOwner(VALID_NAME, VALID_PHONE, VALID_EMAIL, null);
