...
public class JsonAdaptedEventTest {
    ...
    private static final String VALID_ID = "valid-id-123";

    @Test
    public void toModelType_validEventDetails_returnsEvent() throws Exception {
        JsonAdaptedEvent jsonAdaptedEvent = new JsonAdaptedEvent(VALID_ID, VALID_DESCRIPTION, IS_DONE, VALID_FROM, VALID_TO);
        Event expectedEvent = new Event(VALID_ID, VALID_DESCRIPTION, VALID_FROM, VALID_TO, IS_DONE);
        assertEquals(expectedEvent, jsonAdaptedEvent.toModelType());
    }

    @Test
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedEvent jsonAdaptedEvent = new JsonAdaptedEvent(VALID_ID, INVALID_DESCRIPTION, IS_DONE, VALID_FROM, VALID_TO);
    ...
    public void toModelType_invalidFromDate_throwsIllegalValueException() {
        JsonAdaptedEvent jsonAdaptedEvent = new JsonAdaptedEvent(VALID_ID, VALID_DESCRIPTION, IS_DONE, INVALID_FROM, VALID_TO);
    ...
    public void toModelType_invalidToDate_throwsIllegalValueException() {
        JsonAdaptedEvent jsonAdaptedEvent = new JsonAdaptedEvent(VALID_ID, VALID_DESCRIPTION, IS_DONE, VALID_FROM, INVALID_TO);
        String expectedMessage = seedu.address.model.task.Date.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, jsonAdaptedEvent::toModelType);
    }
    ...
    public void toModelType_nullFromDate_throwsIllegalValueException() {
        JsonAdaptedEvent jsonAdaptedEvent = new JsonAdaptedEvent(VALID_ID, VALID_DESCRIPTION, IS_DONE, null, VALID_TO);
    ...
    public void toModelType_nullToDate_throwsIllegalValueException() {
        JsonAdaptedEvent jsonAdaptedEvent = new JsonAdaptedEvent(VALID_ID, VALID_DESCRIPTION, IS_DONE, VALID_FROM, null);
        String expectedMessage = String.format(JsonAdaptedTask.MISSING_FIELD_MESSAGE_FORMAT, "Event dates");
        assertThrows(IllegalValueException.class, expectedMessage, jsonAdaptedEvent::toModelType);
    }
    ...
    public void toModelType_validEventWithDone_returnsCorrectly() throws Exception {
        JsonAdaptedEvent jsonAdaptedEvent = new JsonAdaptedEvent(VALID_ID, VALID_DESCRIPTION, true, VALID_FROM, VALID_TO);
