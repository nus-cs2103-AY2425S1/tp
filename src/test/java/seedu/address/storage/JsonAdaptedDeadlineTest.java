...
public class JsonAdaptedDeadlineTest {
    ...
    public void toModelType_validDeadlineDetails_returnsDeadline() throws Exception {
        JsonAdaptedDeadline jsonAdaptedDeadline = new JsonAdaptedDeadline(VALID_ID, VALID_DESCRIPTION, IS_DONE, VALID_BY);
        Deadline expectedDeadline = new Deadline(VALID_ID, VALID_DESCRIPTION, VALID_BY, IS_DONE);
        assertEquals(expectedDeadline, jsonAdaptedDeadline.toModelType());
    }

    @Test
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedDeadline jsonAdaptedDeadline = new JsonAdaptedDeadline(VALID_ID, INVALID_DESCRIPTION, IS_DONE, VALID_BY);
    ...
    public void toModelType_invalidByDate_throwsIllegalValueException() {
        JsonAdaptedDeadline jsonAdaptedDeadline = new JsonAdaptedDeadline(VALID_ID, VALID_DESCRIPTION, IS_DONE, INVALID_BY);
    ...
    public void toModelType_nullByDate_throwsIllegalValueException() {
        JsonAdaptedDeadline jsonAdaptedDeadline = new JsonAdaptedDeadline(VALID_ID, VALID_DESCRIPTION, IS_DONE, null);
    ...
    public void toModelType_validDeadlineWithDone_returnsCorrectly() throws Exception {
        JsonAdaptedDeadline jsonAdaptedDeadline = new JsonAdaptedDeadline(VALID_ID, VALID_DESCRIPTION, true, VALID_BY);
