...
public class JsonAdaptedTodoTest {
    ...
    public void toModelType_validTodoDetails_returnsTodo() throws Exception {
        JsonAdaptedTodo jsonAdaptedTodo = new JsonAdaptedTodo(VALID_ID, VALID_DESCRIPTION, IS_DONE);
    ...
    public void toModelType_invalidTodoDescription_throwsIllegalValueException() {
        JsonAdaptedTodo jsonAdaptedTodo = new JsonAdaptedTodo(VALID_ID, INVALID_DESCRIPTION, IS_DONE);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedTodo jsonAdaptedTodo = new JsonAdaptedTodo(VALID_ID, null, IS_DONE);
    ...
    public void toModelType_validTodoWithDone_returnsCorrectly() throws Exception {
        JsonAdaptedTodo jsonAdaptedTodo = new JsonAdaptedTodo(VALID_ID, VALID_DESCRIPTION, true);
