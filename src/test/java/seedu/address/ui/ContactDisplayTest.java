...
public class ContactDisplayTest extends ApplicationTest {
    ...
    public void start(Stage stage) {
        ...
        stage.setScene(new Scene(contactDisplay.getRoot()));
        stage.show();
    }

    @BeforeEach
    public void setUp() {
        // Ensure setup occurs on the JavaFX Application Thread
        Platform.runLater(() -> {
    ...
    public void updateContactDetails_validPerson_contactDetailsDisplayed() {
        ...
        // Verify that the displayed details match the test person’s details
        ...
        // Verify that tags are displayed correctly
