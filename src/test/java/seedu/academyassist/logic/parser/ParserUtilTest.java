...
import static seedu.academyassist.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    private static final String INVALID_PHONE2 = "123p0981";
    ...
    private static final String VALID_SUBJECT_1 = "SCIENCE";
    ...
    @Test
    public void parsePhone_invalidValueWithSymbol_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parsePhone(INVALID_PHONE1));
    }
    @Test
    public void parsePhone_invalidValueWithAlphabets_throwsParseException() {
    ...
    @Test
    public void parseSubjects_emptyCollection_throwsParseException() throws Exception {
        assertThrows(ParseException.class, () -> ParserUtil.parseSubjects(Collections.emptyList()).isEmpty());
    }

    @Test
    public void parseSubjects_collectionWithValidTags_returnsSubjectSet() throws Exception {
