...
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INTERVIEW_SCORE_DESC_AMY;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INTERVIEW_SCORE_DESC_BOB;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INVALID_INTERVIEW_SCORE_DESC;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INVALID_JOB_DESC;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INVALID_SKILL_DESC;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.JOB_DESC_AMY;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.JOB_DESC_BOB;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.NAME_DESC_BOB;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.PREAMBLE_NON_EMPTY;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.SKILL_DESC_JAVA;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.SKILL_DESC_PYTHON;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.VALID_TAG_FRIEND;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.VALID_TAG_HUSBAND;
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.VALID_TAG_PENDING;
...
import static seedu.hiredfiredpro.logic.parser.CommandParserTestUtil.assertParseFailure;
import static seedu.hiredfiredpro.logic.parser.CommandParserTestUtil.assertParseSuccess;
