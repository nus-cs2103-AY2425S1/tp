...
import static seedu.hiredfiredpro.logic.commands.CommandTestUtil.VALID_INTERVIEW_SCORE_AMY;
...
public class TypicalPersons {
    ...
    /**
     * Returns a {@code HiredFiredPro} with all the typical persons.
     */
    public static HiredFiredPro getTypicalHiredFiredPro() {
        HiredFiredPro ab = new HiredFiredPro();
