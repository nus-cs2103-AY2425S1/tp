...
public class JsonAdaptedOrderTest {
    ...
    public void toModelType_invalidItem_throwsIllegalValueException() {
        JsonAdaptedOrder order = new JsonAdaptedOrder(INVALID_ITEM, VALID_COUNT, VALID_DATE);
    ...
    public void toModelType_nullItem_throwsIllegalValueException() {
        JsonAdaptedOrder order = new JsonAdaptedOrder(null, VALID_COUNT, VALID_DATE);
    ...
    public void toModelType_invalidCount_throwsIllegalValueException() {
        JsonAdaptedOrder order = new JsonAdaptedOrder(VALID_ITEM, INVALID_COUNT, VALID_DATE);
    ...
    public void toModelType_nullCount_throwsIllegalValueException() {
        JsonAdaptedOrder order = new JsonAdaptedOrder(VALID_ITEM, null, VALID_DATE);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedOrder order = new JsonAdaptedOrder(VALID_ITEM, VALID_COUNT, INVALID_DATE);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        JsonAdaptedOrder order = new JsonAdaptedOrder(VALID_ITEM, VALID_COUNT, null);
