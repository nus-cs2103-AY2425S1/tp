...
public class JsonAdaptedClientTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_ID, EMPTY_EVENT_IDS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                INVALID_ADDRESS, VALID_TAGS, VALID_ID, EMPTY_EVENT_IDS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_TAGS, VALID_ID, EMPTY_EVENT_IDS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, invalidTags, VALID_ID, EMPTY_EVENT_IDS);
    ...
    public void toModelType_invalidId_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, INVALID_ID, EMPTY_EVENT_IDS);
