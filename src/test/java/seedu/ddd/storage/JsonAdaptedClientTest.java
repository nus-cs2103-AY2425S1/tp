...
public class JsonAdaptedClientTest {
    ...
    private static final int VALID_ID = ALICE.getId().id;
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_DATE, VALID_TAGS, VALID_ID);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                INVALID_ADDRESS, VALID_DATE, VALID_TAGS, VALID_ID);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_DATE, VALID_TAGS, VALID_ID);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, INVALID_DATE, VALID_TAGS, VALID_ID);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, null, VALID_TAGS, VALID_ID);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_DATE, invalidTags, VALID_ID);
    ...
    public void toModelType_invalidId_throwsIllegalValueException() {
        JsonAdaptedContact client = new JsonAdaptedClient(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_DATE, VALID_TAGS, INVALID_ID);
