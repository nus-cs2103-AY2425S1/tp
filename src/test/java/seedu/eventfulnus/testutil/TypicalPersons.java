...
public class TypicalPersons {
    ...
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withPhone("98765432")
            .withRoles("Volunteer - Emcee", "Athlete - DEN - Swimming Men").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz")
            .withPhone("95352563")
            .withEmail("heinz@example.com")
            .withRoles("Referee - MED - Tchoukball, Squash")
            .build();
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer")
            ...
            .withRoles("Committee - Marketing - Project Director")
            .build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz")
            .withPhone("9482427")
            .withEmail("lydia@example.com")
            .withRoles("Committee - Publicity - Project Director")
            .build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best")
            .withPhone("9482442")
            .withEmail("anna@example.com")
            .withRoles("Committee - Sports - Vice Sports Director - BIZ")
            .build();
