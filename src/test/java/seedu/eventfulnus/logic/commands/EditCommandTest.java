...
import static seedu.eventfulnus.logic.commands.CommandTestUtil.DESC_AMY;
import static seedu.eventfulnus.logic.commands.CommandTestUtil.DESC_BOB;
...
public class EditCommandTest {
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withRoles(VALID_ROLE_ATHLETE).build();
