...
public class AddLessonCommandParser implements Parser<AddLessonCommand> {
    ...
    public AddLessonCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args, PREFIX_STUDENT_ID, PREFIX_START_DATE,
                PREFIX_DURATION);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_STUDENT_ID, PREFIX_START_DATE, PREFIX_DURATION);
        ...
        return new AddLessonCommand(studentId, startDateTime, endDateTime);
    }
