    ...
    public static Student[] getSampleStudents() {
        return new Student[] {
            new Student(new Name("Alex Yeoh"), new Phone("87438807"), new Address("Blk 30 Geylang Street 29, #06-40"),
                    new GradeLevel("ABRSM 1"), PianoPiece.getPianoPieceSet("Canon in D"), null, new HashSet<>()),
            new Student(new Name("Bernice Yu"), new Phone("99272758"),
                    ...
                    PianoPiece.getPianoPieceSet("Moonlight Sonata"), null, new HashSet<>()),
            new Student(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                    ...
                    PianoPiece.getPianoPieceSet("Etude", "Moonlight Sonata"), null, new HashSet<>()),
            new Student(new Name("David Li"), new Phone("91031282"),
                    ...
                    PianoPiece.getPianoPieceSet("Howl's moving castle"), null, new HashSet<>()),
            ...
            new Student(new Name("Roy Balakrishnan"), new Phone("92624417"),
                    ...
                    PianoPiece.getPianoPieceSet("Styx Helix"), null, new HashSet<>()),
        };
    }
