    ...
    public static Student[] getSampleStudents() {
        ...
        return new Student[] {
            ...
            new Student(new Name("Bernice Yu"), new Phone("99272758"),
                    ...
                    PianoPiece.getPianoPieceSet("Moonlight Sonata"), null, cancelledLessons),
            new Student(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                    ...
                    PianoPiece.getPianoPieceSet("Etude", "Moonlight Sonata"), null, cancelledLessons),
            new Student(new Name("David Li"), new Phone("91031282"),
                    ...
                    PianoPiece.getPianoPieceSet("Howl's moving castle"), null, cancelledLessons),
            ...
            new Student(new Name("Roy Balakrishnan"), new Phone("92624417"),
                    ...
                    PianoPiece.getPianoPieceSet("Styx Helix"), null, cancelledLessons),
        };
    }
