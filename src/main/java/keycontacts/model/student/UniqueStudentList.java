...
import keycontacts.model.student.exceptions.StudentNotFoundException;
 ...
 * to ensure that the student being added or updated is
 * unique in terms of identity in the UniqueStudentList. However, the removal of a student uses
 * {@code Student#equals(Object)} to ensure that the student with exactly the same fields will be removed.
 *
