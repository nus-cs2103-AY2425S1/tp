...
/**
 * Parses input arguments and crates a new {@link AttendRemoveCommand} object.
 */
public class AttendRemoveCommandParser implements Parser<AttendRemoveCommand> {
    /**
     * Parses the given {@code String} of arguments in the context of the {@link AttendRemoveCommand}
     * and returns an {@link AttendRemoveCommand} object for execution.
     * @throws ParseException if the user input does not conform the expected format
     */
    public AttendRemoveCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_MATRICULATION_NUMBER, PREFIX_COURSE_CODE, PREFIX_TUTORIAL)
            ...
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_MISSING_FIELDS, AttendRemoveCommand.MESSAGE_USAGE));
        }
        ...
        return new AttendRemoveCommand(targetSca);
    }
