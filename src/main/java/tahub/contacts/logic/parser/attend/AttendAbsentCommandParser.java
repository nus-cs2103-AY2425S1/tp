...
/**
 * Parses input arguments and crates a new {@link AttendAbsentCommand} object.
 */
public class AttendAbsentCommandParser implements Parser<AttendAbsentCommand> {
    /**
     * Parses the given {@code String} of arguments in the context of the {@link AttendAbsentCommand}
     * and returns an {@link AttendAbsentCommand} object for execution.
     * @throws ParseException if the user input does not conform the expected format
     */
    public AttendAbsentCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_MATRICULATION_NUMBER, PREFIX_COURSE_CODE, PREFIX_TUTORIAL)
            ...
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_MISSING_FIELDS, AttendAbsentCommand.MESSAGE_USAGE));
        }
        ...
        return new AttendAbsentCommand(targetSca);
    }
