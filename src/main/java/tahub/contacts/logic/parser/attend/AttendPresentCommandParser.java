...
/**
 * Parses input arguments and crates a new {@link AttendPresentCommand} object.
 */
public class AttendPresentCommandParser implements Parser<AttendPresentCommand> {
    /**
     * Parses the given {@code String} of arguments in the context of the {@link AttendPresentCommand}
     * and returns an {@link AttendPresentCommand} object for execution.
    ...
    public AttendPresentCommand parse(String args) throws ParseException {
        ...
        return new AttendPresentCommand(targetSca);
    }
