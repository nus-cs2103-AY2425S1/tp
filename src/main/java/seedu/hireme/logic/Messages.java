...
public class Messages {
    ...
    public static final String MESSAGE_INDEX_CONSTRAINT = "It must be a positive integer that is less than or equal to "
            + "the total number of internship applications in the list";
