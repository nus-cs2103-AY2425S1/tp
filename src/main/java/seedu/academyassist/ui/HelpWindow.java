...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String HELP_MESSAGE = "Welcome to the AcademyAssist Help Window!\n\n"
            ...
            + "   Format: n/NAME p/PHONE e/EMAIL a/ADDRESS i/IC yg/YEARGROUP s/SUBJECT\n\n"
            ...
            + "   Format: sort s/FIELD\n\n"
            + "8. detail: Shows the details of a specified student\n"
            ...
            + "   Format: exit\n\n"
            + "13. help: Displays a help window with all the commands and their formats\n"
            + "   Format: help\n\n"
