...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String HELP_MESSAGE = "Welcome to the AcademyAssist Help Window!\n\n"
            ...
            + "   Format: sort s/FIELD\n\n"
            + "8. tracksubject: Displays how many students are taking each subject\n"
            + "   Format: tracksubject\n\n"
            + "9. filter: Filters contacts based on specified field\n"
            + "   Format: filter f/FIELD [field]\n\n"
            + "10. clear: Clears all entries from the management system\n"
            + "   Format: clear\n\n"
