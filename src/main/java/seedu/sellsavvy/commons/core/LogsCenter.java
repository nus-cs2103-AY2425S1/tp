package seedu.sellsavvy.commons.core;
...
public class LogsCenter {
    ...
    /**
     * Creates a logger named 'sellsavvy', containing a {@code ConsoleHandler} and a {@code FileHandler}.
     * Sets it as the {@code baseLogger}, to be used as the parent logger of all other loggers.
     */
    private static void setBaseLogger() {
        baseLogger = Logger.getLogger("sellsavvy");
