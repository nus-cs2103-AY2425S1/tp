...
public class ArgumentMultimap {
    ...
    /**
     * Returns false if none of the prefixes are present or more than one prefix is
     * present
     */
    public boolean exactlyOnePrefixPresent(Prefix... prefixes) {
        return Stream.of(prefixes).filter(prefix -> !getAllValues(prefix).isEmpty()).count() == 1;
    }
}
