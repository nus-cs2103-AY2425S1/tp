...
import seedu.researchroster.logic.parser.ResearchRosterParser;
...
public class LogicManager implements Logic {
    ...
    private final ResearchRosterParser researchRosterParser;
    ...
    public LogicManager(Model model, Storage storage) {
        ...
        researchRosterParser = new ResearchRosterParser();
    }
    ...
    public CommandResult execute(String commandText) throws CommandException, ParseException {
        ...
        Command command = researchRosterParser.parseCommand(commandText);
