...
public class MainWindow extends UiPart<Stage> {
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getHiredFiredProFilePath());
     ...
     *
     * @see seedu.hiredfiredpro.logic.Logic#execute(String)
     */
