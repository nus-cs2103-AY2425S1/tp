...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a person to the hiredfiredpro. "
            + "Parameters: "
            + PREFIX_NAME + "NAME "
            + PREFIX_JOB + "JOB "
            + PREFIX_PHONE + "PHONE "
    ...
    public static final String MESSAGE_DUPLICATE_PERSON = "This person already exists in the hiredfiredpro";
