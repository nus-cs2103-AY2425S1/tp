 ...
 * As such, adding and updating of properties uses Property#isSameProperty(Property) for equality so as to ensure that
 * the property being added or updated is unique in terms of identity in the UniquePropertyList.
 * However, the removal of a property uses Property#equals(Object) so as to ensure that the property with exactly the
