 ...
 * an Assignment uses Assignment#equals(Object) so as to ensure that the Assignment with exactly the same fields will
 * be removed.
 *
...
public class UniqueAssignmentList implements Iterable<Assignment> {
     ...
     * The assignment identity of {@code editedAssignment} must not be the same as another existing assignment in
     * the list.
     */
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof UniqueAssignmentList otherUniqueAssignmentList)) {
            return false;
        }
