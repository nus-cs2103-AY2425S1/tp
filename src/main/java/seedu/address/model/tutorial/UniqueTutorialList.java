 ...
 * updating of tutorials uses Tutorial#isSameTutorial(Tutorial) for equality so as to ensure that the tutorial being
 * added or updated is unique in terms of identity in the UniqueTutorialList. However, the removal of a tutorial uses
 * Tutorial#equals(Object) so as to ensure that the tutorial with exactly the same fields will be removed.
 *
