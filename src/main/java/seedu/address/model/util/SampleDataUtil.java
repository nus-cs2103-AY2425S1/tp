    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Customer(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    ...
                    new Information("I love cakes"), new Remark(), getTagSet("Customer")),
            sampleCustomer(),
            sampleSupplier(),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                    new Address("Blk 45 Aljunied Street 85, #11-31"),
                    new Remark("I want to invest in your bakery business"), getTagSet("Investor")),
            new Person(new Name("Joel Tio"), new Phone("98102923"), new Email("joel.tio@gmail.com"),
                    new Address("548 Bukit Timah Road"),
                    new Remark("I am lactose intolerant"), getTagSet("GrabDelivery"))
        };
    }
