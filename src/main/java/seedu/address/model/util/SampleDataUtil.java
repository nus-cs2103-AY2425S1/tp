    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Id("P23456"), new Ward("B1"),
                    ...
                    new Medication("Corticosteroids"), EMPTY_NOTES),
            ...
            new Person(new Name("David Li"), new Id("P45678"), new Ward("A1"),
                    ...
                    new Medication("Angiotensin-Converting Enzyme (ACE) Inhibitors"), EMPTY_NOTES),
            new Person(new Name("Irfan Ibrahim"), new Id("P56789"), new Ward("D1"),
                    ...
                    new Medication("Oxygen Therapy"), EMPTY_NOTES),
