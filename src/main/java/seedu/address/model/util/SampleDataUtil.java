    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Phone("87438807"),
                ...
                getTagSet("friends")),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Phone("99272758"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new Note(""),
                getTagSet("colleagues", "friends")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Phone("93210283"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new Note(""),
                getTagSet("neighbours")),
            new Person(new Name("David Li"), new Phone("91031282"), new Phone("93210283"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new Note(""),
                getTagSet("family")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Phone("92624417"),
                new Address("Blk 47 Tampines Street 20, #17-35"), new Note(""),
                getTagSet("classmates")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Phone("92624417"),
