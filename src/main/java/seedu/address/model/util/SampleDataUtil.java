    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                new DateOfBirth("1 Jan 1999"), new Income(3000), new FamilySize(1), getTagSet("friends"),
                new UpdatedAt(UPDATED_AT)),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), Priority.MEDIUM, EMPTY_REMARK,
                new DateOfBirth("10 Jul 2002"), new Income(1000), new FamilySize(1),
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                ...
                new DateOfBirth("20 Jun 1989"), new Income(300), new FamilySize(1), getTagSet("neighbours"),
                new UpdatedAt(UPDATED_AT)),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), Priority.HIGH, EMPTY_REMARK,
                new DateOfBirth("27 Sep 1992"), new Income(1400.00), new FamilySize(1), getTagSet("family"),
                new UpdatedAt(UPDATED_AT)),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), Priority.MEDIUM, EMPTY_REMARK,
                new DateOfBirth("30 Jan 2010"), new Income(2000.50), new FamilySize(1), getTagSet("classmates"),
                new UpdatedAt(UPDATED_AT)),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), Priority.LOW, EMPTY_REMARK,
                new DateOfBirth("12 Mar 1993"), new Income(1534.69), new FamilySize(1), getTagSet("colleagues"),
                new UpdatedAt(UPDATED_AT))
        };
    }
