...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[]{
                new Person(new Name("Alex Yeoh"),
                           ...
                           getTagSet("friends")), new Person(new Name("Bernice Yu"),
                                                             new Phone("99272758"),
                ...
                new Person(new Name("Charlotte Oliveiro"),
                           ...
                           getTagSet("neighbours")), new Person(new Name("David Li"),
                                                                new Phone("91031282"),
                ...
                new Person(new Name("Irfan Ibrahim"),
                           ...
                           getTagSet("classmates")), new Person(new Name("Roy Balakrishnan"),
                                                                new Phone("92624417"),
    ...
    public static Job[] getSampleJobs() {
        return new Job[]{
                new Job("Software Engineer, Google Pay, Core",
                        "Google",
                        "$100/m",
                ...
                new Job("Software Engineering Manager II, YouTube",
                        "YouTube",
                        "$200/m",
                        "8 years of experience with software development in one or more programming languages (e.g., "
