    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                new StudentClass("2A"), new EmergencyContactName("John Do"), EMPTY_EMERGENCY_PHONE,
                    getTagSet("colleagues", "friends")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new RegisterNumber("3"), new Sex("F"),
                new StudentClass("1A"), new EmergencyContactName("Rose Jackson"), EMPTY_EMERGENCY_PHONE,
                    getTagSet("neighbours")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new RegisterNumber("4"), new Sex("M"),
                new StudentClass("4C"), new EmergencyContactName("Jack Fincher"), EMPTY_EMERGENCY_PHONE,
                    getTagSet("family")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), new RegisterNumber("5"), new Sex("M"),
                new StudentClass("2B"), new EmergencyContactName("Peter Ibrahim"), EMPTY_EMERGENCY_PHONE,
                    getTagSet("classmates")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), new RegisterNumber("6"), new Sex("M"),
                new StudentClass("2B"), new EmergencyContactName("Marjorie Roy"), EMPTY_EMERGENCY_PHONE,
