    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                new EmergencyContact(new Name("Aiken"), new Phone("+20 81234567")),
                getTagSet("Floor1", "volleyball")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new RoomNumber("02-0123"), new Address("Mango Dorm Block C"),
                new EmergencyContact(new Name("Dueet"), new Phone("+123 23 12345678")),
                getTagSet("Floor10")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new RoomNumber("08-8888"), new Address("Pear Dorm Block A"),
                new EmergencyContact(new Name("Benny Yao"), null),
                getTagSet("Floor3")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new RoomNumber("04-4444"), new Address("Grape Dorm Block A"),
                new EmergencyContact(null, new Phone("+20 81234567")),
                getTagSet("Floor5")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                null, new Address("Grape Dorm Block A"), null,
                getTagSet("Floor3"))
        };
    }
