...
public class Vin {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            "Vehicle Identification Numbers should only contain alphanumeric characters (length 17)."
                    + "Characters should be capitalised and should not contain spaces or be blank.";
