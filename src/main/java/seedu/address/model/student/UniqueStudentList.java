...
public class UniqueStudentList implements Iterable<Student> {
    ...
    /**
     * Replaces the student {@code target} in the list with {@code updatedStudent}.
     * {@code target} must exist in the list.
     * The student identity of {@code updatedStudent} must not be the same as another existing student in the list.
     */
    public void setStudent(Student target, Student updatedStudent) {
        requireAllNonNull(target, updatedStudent);
        ...
        if (!target.isSameStudent(updatedStudent) && contains(updatedStudent)) {
            throw new DuplicateStudentException();
        }

        internalList.set(index, updatedStudent);
    }
