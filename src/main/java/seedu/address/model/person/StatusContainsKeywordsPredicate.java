...
/**
 * Tests that a {@code Person}'s {@code Application Status} matches any of the keywords given.
 */
public class StatusContainsKeywordsPredicate implements Predicate<Person> {
    ...
    public boolean equals(Object other) {
        ...
        StatusContainsKeywordsPredicate otherNameContainsKeywordsPredicate = (StatusContainsKeywordsPredicate) other;
