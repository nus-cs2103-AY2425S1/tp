 ...
 * A wedding is considered unique by comparing using {@code Wedding#isSameWedding(Wedding)}. As such,
 * adding and updating of weddings uses Wedding#isSameWedding(Wedding) for equality so as to ensure that the
 * wedding being added or updated is unique in terms of identity in the UniqueWeddingList. However, the
 * removal of a wedding uses Wedding#equals(Object) so as to ensure that the wedding with exactly the same
