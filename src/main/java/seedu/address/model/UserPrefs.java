...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path eventManagerFilePath = Paths.get("data", "eventmanager.json");
    /**
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setEventManagerFilePath(newUserPrefs.getEventManagerFilePath());
    }
    ...
    public void setEventManagerFilePath(Path eventManagerFilePath) {
        requireNonNull(eventManagerFilePath);
