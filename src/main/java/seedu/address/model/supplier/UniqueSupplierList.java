 ...
 * As such, adding and updating of suppliers uses Supplier#isSameSupplier(Supplier) for equality
 * so as to ensure that the person being added or updated is unique in terms of identity in the
 * UniqueSupplierList. However, the removal of a person uses Supplier#equals(Object) so
