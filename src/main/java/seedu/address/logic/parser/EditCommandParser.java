...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_CAREER_PAGE_URL).isPresent()) {
            editCompanyDescriptor.setCareerPageUrl(
                    ParserUtil.parseCareerPageUrl(argMultimap.getValue(PREFIX_CAREER_PAGE_URL).get()));
        }
