...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_CONTRACT_END_DATE).isPresent()) {
            editPersonDescriptor.setContractEndDate(
                    ParserUtil.parseContractEndDate(argMultimap.getValue(PREFIX_CONTRACT_END_DATE).get())
            );
        }
