    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(
                        args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_DATE_OF_BIRTH,
                        PREFIX_PRIORITY, PREFIX_INCOME, PREFIX_FAMILY_SIZE, PREFIX_TAG);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
                PREFIX_DATE_OF_BIRTH, PREFIX_PRIORITY, PREFIX_INCOME, PREFIX_FAMILY_SIZE);
        ...
        if (argMultimap.getValue(PREFIX_INCOME).isPresent()) {
            editPersonDescriptor.setIncome(
