    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
                        PREFIX_REGISTER_NUMBER, PREFIX_SEX, PREFIX_STUDENT_CLASS, PREFIX_ECNUMBER, PREFIX_TAG);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_SEX,
                PREFIX_STUDENT_CLASS, PREFIX_ECNUMBER);
        ...
        if (argMultimap.getValue(PREFIX_REGISTER_NUMBER).isPresent()) {
            editPersonDescriptor.setRegisterNumber(ParserUtil.parseRegisterNumber(argMultimap
                    .getValue(PREFIX_REGISTER_NUMBER).get()));
        }
        ...
        if (argMultimap.getValue(PREFIX_STUDENT_CLASS).isPresent()) {
            editPersonDescriptor
                    .setStudentClass(ParserUtil.parseStudentClass(argMultimap.getValue(PREFIX_STUDENT_CLASS).get()));
        }
