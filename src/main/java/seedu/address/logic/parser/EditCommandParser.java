...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_STUDENTID, PREFIX_TUTORIALID);
        ...
        if (argMultimap.getValue(PREFIX_TUTORIALID).isPresent()) {
            editStudentDescriptor.setTutorialId(ParserUtil
                    .parseTutorialId(argMultimap.getValue(PREFIX_TUTORIALID).get()));
        }
