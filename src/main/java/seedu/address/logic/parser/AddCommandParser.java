...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_TELEHANDLE, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_TAG);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME, PREFIX_TELEHANDLE, PREFIX_PHONE, PREFIX_EMAIL);
        ...
        Person person = new Person(name, phone, email, telegramHandle, tagList);
