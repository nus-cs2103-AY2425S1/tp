    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(
                        ...
                        PREFIX_PRIORITY, PREFIX_REMARK, PREFIX_AGE, PREFIX_TAG);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(
                PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_PRIORITY, PREFIX_REMARK, PREFIX_AGE);
        ...
        Person person = new Person(name, phone, email, address, priority, remark, age, tagList);
