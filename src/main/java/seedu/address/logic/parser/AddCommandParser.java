...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_WORKEXP)
        ...
        WorkExp workExp = ParserUtil.parseWorkExp(argMultimap.getValue(PREFIX_WORKEXP).get()); // Parse WorkExp here
        Set<Tag> tagList = ParserUtil.parseTags(argMultimap.getAllValues(PREFIX_TAG));

        Person person = new Person(name, phone, email, address, workExp, tagList); // Updated constructor
