...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.arePrefixesMissing(PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_EMAIL)
        ...
        Person person = new Person(name, phone, email, address, priority, remark, tagList);
