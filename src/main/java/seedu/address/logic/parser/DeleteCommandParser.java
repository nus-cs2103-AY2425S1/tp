 ...
 */
public class DeleteCommandParser implements Parser<DeleteConfirmCommand> {
     ...
     */
    public DeleteConfirmCommand parse(String args) throws ParseException {
        ...
        if (!argMultimap.getValue(PREFIX_IDENTITY_NUMBER).isPresent()) {
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteConfirmCommand.MESSAGE_USAGE));
        }
        ...
        return new DeleteConfirmCommand(identityNumber);
    }
}
