...
public class AddCompanyCommandParser implements Parser<AddCompanyCommand> {
    ...
    public AddCompanyCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_INDUSTRY,
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME, PREFIX_INDUSTRY,
        ...
        Company company = new Company(name, industry, phone, email, address, tagList);
