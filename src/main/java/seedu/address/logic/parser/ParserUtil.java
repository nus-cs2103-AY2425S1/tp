...
public class ParserUtil {
    ...
    /**
     * Parses a {@code String contractEndDate} into an {@code contractEndDate}.
     * Leading and trailing whitespaces will be trimmed.
     *
     * @throws ParseException if the given {@code contractEndDate} is invalid.
     */
    public static ContractEndDate parseContractEndDate(String contractEndDate) throws ParseException {
