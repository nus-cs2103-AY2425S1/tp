 ...
 */
public class EditPublicAddressCommandParser implements Parser<EditPublicAddressCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the EditPublicAddressCommand
     * and returns an EditPublicAddressCommand object for execution.
     *
    ...
    public EditPublicAddressCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditPublicAddressCommand.MESSAGE_USAGE), pe);
        }

        if (!arePrefixesPresent(argMultimap, PREFIX_PUBLIC_ADDRESS_NETWORK, PREFIX_PUBLIC_ADDRESS_LABEL,
