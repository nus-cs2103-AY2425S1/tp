...
public class EditVendorCommandParser implements Parser<EditVendorCommand> {
    ...
    public EditVendorCommandParser(Model model) {
        this.model = model;
    }
    /**
    ...
    public EditVendorCommand parse(String args) throws ParseException {
        ...
        if (index.getOneBased() > this.model.getFilteredVendorList().size()) {
            throw new ParseException(Messages.MESSAGE_INVALID_VENDOR_DISPLAYED_INDEX);
        }
