...
/**
 * Parser for commands of type RemoveFromGroupCommand. Parses the argument by trimming whitespaces and returning a new
 * {@code RemoveFromGroupCommand} with the trimmed argument.
 */
public class RemoveFromGroupCommandParser implements Parser<RemoveFromGroupCommand> {
    ...
    public RemoveFromGroupCommand parse(String args) throws ParseException {
        ...
        return new RemoveFromGroupCommand(groupName, members);
    }
}
