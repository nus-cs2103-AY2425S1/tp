...
public class ArgumentTokenizer {
     ...
     * prefixes to their respective argument values. Only the given prefixes will be
     ...
     * object that maps the extracted prefixes to their respective arguments. Prefixes are
     * extracted based on their zero-based positions in
     * {@code argsString}.
     *
     * @param argsString      Arguments string of the form: {@code preamble <prefix>value <prefix>value ...}
    ...
    /**
     * Returns the trimmed value of the argument in the arguments string specified by
     * {@code currentPrefixPosition}.
