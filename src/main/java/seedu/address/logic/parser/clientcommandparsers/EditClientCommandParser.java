...
public class EditClientCommandParser implements Parser<EditClientCommand> {
    ...
    public EditClientCommand parse(String args) throws ParseException {
        ...
        EditPersonDescriptor editPersonDescriptor = setEditPersonDescriptor(argMultimap, new EditPersonDescriptor());

        return new EditClientCommand(index, editPersonDescriptor);
    }

    private EditPersonDescriptor setEditPersonDescriptor(ArgumentMultimap argMultimap,
