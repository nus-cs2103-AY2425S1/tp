...
public class VolunteerAddDateCommandParser implements Parser<VolunteerAddDateCommand> {
     ...
     */
    public VolunteerAddDateCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT, VolunteerAddDateCommand.MESSAGE_USAGE), pe);
        }
    }
