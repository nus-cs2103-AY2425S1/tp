...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_ADDRESS, PREFIX_ASKING_PRICE,
                        PREFIX_TYPE);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME, PREFIX_PHONE, PREFIX_ADDRESS, PREFIX_ASKING_PRICE,
                PREFIX_TYPE);
        ...
        if (argMultimap.getValue(PREFIX_TYPE).isPresent()) {
            editPropertyDescriptor.setPropertyType(
