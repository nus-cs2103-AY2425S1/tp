...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSONS_DISPLAYED_INDEX = "The following indexes are invalid: %s.";
    ...
    public static final String MESSAGE_INVALID_PHONE_NUMBER = "The phone number given is invalid!";
    public static final String MESSAGE_PERSONS_LISTED_OVERVIEW = "%1$d persons listed!";
    public static final String MESSAGE_SELECT_PERSON_SUCCESS = "Selected Person(s): %1$s";
