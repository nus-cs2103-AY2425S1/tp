...
public class Messages {
    ...
    // find suggestion
    public static final String MESSAGE_FIND_NAME_SUGGESTION = "Command to" + WHITESPACE
            + FindCommand.COMMAND_WORD + ":" + WHITESPACE
            + styleCommand(FindCommand.COMMAND_WORD + WHITESPACE + PREFIX_NAME + WHITESPACE + "%1$s");
    ...
    // to replace formatted words of: find or add
    public static final String MESSAGE_MISSING_DESCRIPTION_INPUT =
            "Please enter something for me to %s.";
    ...
    // to replace formatted words of: find or edit
