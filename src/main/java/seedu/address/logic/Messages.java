...
public class Messages {
    ...
    public static final String MESSAGE_CLIENTS_FOUND_OVERVIEW =
    ...
    public static final String MESSAGE_MUST_BE_CLIENT_LIST = "%1$s must only be used in client list view!\n"
    ...
    public static final String MESSAGE_EMPTY_CLIENT_LIST =
