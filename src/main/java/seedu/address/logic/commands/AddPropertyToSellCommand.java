...
public class AddPropertyToSellCommand extends Command {
    ...
    public static final String MESSAGE_PROPERTY_TAG_LIMIT = "The number of tags for a property cannot exceed 3";
    public static final String MESSAGE_PROPERTY_TAG_LENGTH_LIMIT = "The number of characters for each tag cannot "
            + "exceed 10";
