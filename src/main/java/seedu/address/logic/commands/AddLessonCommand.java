...
public class AddLessonCommand extends LessonCommand {
    ...
    public static final String MESSAGE_USAGE = LessonCommand.COMMAND_WORD + " " + COMMAND_WORD + ": Adds a lesson to the lesson list. "
            + "Parameters: "
            + PREFIX_STUDENT_ID + "1 "
            + PREFIX_START_DATE + dateTimeNowString() + " "
            + PREFIX_LOCATION_INDEX + "0 "
            + PREFIX_DURATION + "1\n";
    ...
    public AddLessonCommand(StudentId studentId, StartDateTime startDateTime, LocationIndex locationIndex, EndDateTime endDateTime) {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_SUCCESS, Messages.formatLesson(lesson)));
    }
}
