...
public class WelcomeCommand extends Command {
    ...
    public static final String WELCOME_MESSAGE = "Welcome to Grub! Here are some of the commands to help you get started:"
            + "\n\t" 
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Shows welcome message; runs once on app startup.\n"
