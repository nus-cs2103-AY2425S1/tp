...
public class EditAssignmentCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the detail of an existing assignment "
            ...
            + "[" + PREFIX_ASSIGNMENT_NAME + "NEW_ASSIGNMENT_NAME] "
            + "[" + PREFIX_ASSIGNMENT_MAX_SCORE + "NEW_MAX_SCORE] "
    ...
    public static final String MESSAGE_DUPLICATE_ASSIGNMENT = "This assignment already exists in the app.";
