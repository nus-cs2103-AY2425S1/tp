...
public class AddwCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a wedding to the address book. \n"
            ...
            + "[" + PREFIX_DATE + "DATE" + "] "
            + "[" + PREFIX_VENUE + "VENUE" + "], "
            + "where client can be INDEX (must be positive integer) or KEYWORD (the name of contact, case-insensitive)\n"
            + "Example: \n"
            + COMMAND_WORD + " " + PREFIX_NAME + "Alice Wedding " + PREFIX_CLIENT + "1 " + PREFIX_VENUE + "Hotel\n"
            + COMMAND_WORD + " " + PREFIX_NAME + "Alice Wedding " + PREFIX_CLIENT + "Alice " + PREFIX_DATE + "2024-12-12";
