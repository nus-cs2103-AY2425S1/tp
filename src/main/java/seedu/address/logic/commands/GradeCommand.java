...
public class GradeCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Student editedPerson = new Student(studentToEdit.getName(), studentToEdit.getPhone(), studentToEdit.getEmail(),
                studentToEdit.getAddress(), studentToEdit.getLessonTime(), studentToEdit.getEducation(),
                grade, studentToEdit.getParentName(), studentToEdit.getParentPhone(), studentToEdit.getParentEmail(),
