...
public class EditCommand extends Command {
    ...
    private static Client createEditedClient(Client clientToEdit, EditClientDescriptor editClientDescriptor) {
        ...
        Company updatedCompany = editClientDescriptor.getCompany().orElse(clientToEdit.getCompany());
        Phone updatedPhone = editClientDescriptor.getPhone().orElse(clientToEdit.getPhone());
        Email updatedEmail = editClientDescriptor.getEmail().orElse(clientToEdit.getEmail());
        Address updatedAddress = editClientDescriptor.getAddress().orElse(clientToEdit.getAddress());
        Set<Tag> updatedTags = editClientDescriptor.getTags().orElse(clientToEdit.getTags());
        List<Transaction> transactions = clientToEdit.getTransactions();

        return new Client(updatedName, updatedCompany, updatedPhone, updatedEmail, updatedAddress, updatedTags,
                transactions);
    }
    ...
    public static class EditClientDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, company, phone, email, address, tags);
        }
        ...
        public boolean equals(Object other) {
            ...
            return Objects.equals(name, otherEditClientDescriptor.name)
                    && Objects.equals(company, otherEditClientDescriptor.company)
