...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_DUPLICATE_PERSON = "This name already exists in the address book. If the "
            + "newly added person has the same name, Please add (ADDITIONAL INFORMATION) to differentiate the names.";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        List<Person> lastShownList = model.getDisplayPersons();
    ...
    public static class EditPersonDescriptor {
         ...
         * A defensive copy of {@code clientTypes} is used internally.
         */
        public void setClientTypes(Set<ClientType> clientTypes) {
