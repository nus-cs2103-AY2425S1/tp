...
public class ShowCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Displays detailed information about the person identified by the index number used in the displayed person list.\n"
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_SHOW_PERSON_SUCCESS, personToShow.getName().fullName), personToShow);
    }
    //@@author
}
