...
import seedu.address.storage.AgentAssistStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing AgentAssist ]===========================");
        super.init();
        ...
        AgentAssistStorage agentAssistStorage = new JsonAgentAssistStorage(userPrefs.getAgentAssistFilePath());
        storage = new StorageManager(agentAssistStorage, userPrefsStorage);
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting AgentAssist " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping AgentAssist ] =============================");
        try {
