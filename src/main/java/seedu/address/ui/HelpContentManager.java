...
public class HelpContentManager {
    ...
    public void initializeContents() {
        ...
        contentMap.put("Upload a client's profile picture", """
                Upload a client’s profile picture
                 ...
                 whole number (1, 2, 3, …​).
                 Tip:
                 * This feature is for Windows users only. Mac and Linux users may
                 encounter errors if they use this feature. Support for other OSes
                 will be released in future versions!
                 * The profile picture may look odd if the image chosen is very small,
                 ...
                 * Only PNG images are supported. Please ensure your chosen image
                 is in PNG format.
                """);
        ...
        contentMap.put("Saving and Editing Data", """
                Saving and Editing Data
                 ...
                 before editing it.
                 Additionally, certain edits may cause F.A.R.T to behave unexpectedly (e.g., if a value entered
                 is outside of the acceptable range). Therefore, edit the data file only if you are confident
    ...
    public void initializeCommandSummaryData(TableView<String[]> table, TableColumn<String[],
        ...
        commandSummaryData.addAll(
                ...
                new String[]{"Edit", "edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL]\n"
