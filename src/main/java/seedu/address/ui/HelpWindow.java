...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String USAGE_OVERVIEW_MESSAGE = "List of commands:\n"
            ...
            + ListCommand.COMMAND_WORD + " " + SearchNameCommand.COMMAND_WORD + " " + SearchTagCommand.COMMAND_WORD
            + " " + HelpCommand.COMMAND_WORD + " " + ExitCommand.COMMAND_WORD;
    public static final String MORE_INFO_MESSAGE = "For more information, refer to the user guide: " + USERGUIDE_URL;
    public static final String HELP_MESSAGE = USAGE_OVERVIEW_MESSAGE + "\n" + MORE_INFO_MESSAGE;
