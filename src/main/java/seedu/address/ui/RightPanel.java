 ...
 * This class extends {@code UiPart<VBox>} and is responsible for managing and displaying the detail panel, result
 * display,
 * and command box in the right section of the main window.
 *
 * <p>The layout for this panel is defined in 'RightPanel.fxml', which includes placeholders for each of the
 * subcomponents.
...
public class RightPanel extends UiPart<VBox> {
     ...
     * This method adds each component to its designated placeholder, allowing for dynamic updates and display within
     * the interface.
     */
