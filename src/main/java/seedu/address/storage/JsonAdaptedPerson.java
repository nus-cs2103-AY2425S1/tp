...
class JsonAdaptedPerson {
    ...
    public JsonAdaptedPerson(@JsonProperty("name") String name, @JsonProperty("studentClass") String studentClass,
                             @JsonProperty("phone") String phone, @JsonProperty("tags") List<JsonAdaptedTag> tags) {
        this.name = name;
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        if (studentClass == null) {
            throw new IllegalValueException(String.format(MISSING_FIELD_MESSAGE_FORMAT, StudentClass.class.getSimpleName()));
        }
