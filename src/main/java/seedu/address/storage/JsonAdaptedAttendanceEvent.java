...
//    private final List<JsonAttendanceRecord> attendanceRecords;
//
//    /**
...
//                                      @JsonProperty("attendanceRecords") List<JsonAttendanceRecord>
//                                      attendanceRecords) {
...
//                .map(entry -> new JsonAttendanceRecord(entry.getKey().value, entry.getValue()))
...
//        for (JsonAttendanceRecord record : attendanceRecords) {
