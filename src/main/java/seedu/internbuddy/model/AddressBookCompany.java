 ...
 */
public class AddressBookCompany implements ReadOnlyAddressBookCompany {
    ...
    public AddressBookCompany() {}

    /**
     * Creates an AddressBook using the Companies in the {@code toBeCopied}
     */
    public AddressBookCompany(ReadOnlyAddressBookCompany toBeCopied) {
        this();
     ...
     */
    public void resetData(ReadOnlyAddressBookCompany newData) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AddressBookCompany)) {
            return false;
        }

        AddressBookCompany otherAddressBook = (AddressBookCompany) other;
