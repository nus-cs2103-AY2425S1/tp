...
public class LogsCenter {
    ...
    private static final String LOG_FILE = "spleetwaise.log";
    ...
    /**
     * Creates a logger with the given name prefixed by the {@code baseLogger}'s name so that the created logger becomes
     * a descendant of the {@code baseLogger}. Furthermore, the returned logger will have the same log handlers as the
     * {@code baseLogger}.
     */
    ...
    /**
     * Creates a logger named 'spleetwaise', containing a {@code ConsoleHandler} and a {@code FileHandler}. Sets it as
     * the {@code baseLogger}, to be used as the parent logger of all other loggers.
     */
    private static void setBaseLogger() {
        baseLogger = Logger.getLogger("spleetwaise");
