 ...
 * {@code some preamble text t/ 11.00 t/12.00 k/ m/ July}  where prefixes are {@code t/ k/ m/}.<br> 1. An argument's
 * value can be an empty string e.g. the value of {@code k/} in the above example.<br> 2. Leading and trailing
 * whitespaces of an argument value will be discarded.<br> 3. An argument may be repeated and all its values will be
 * accumulated e.g. the value of {@code t/} in the above example.<br>
 */
public class ArgumentTokenizer {
     ...
     * {@code fromIndex}. An occurrence is valid if there is a whitespace before {@code prefix}. Returns -1 if no such
